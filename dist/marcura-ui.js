...
(function ($, undefined) {
        ...
        return function (query) {
            ...
            process = function (datum, collection) {
                ...
                if (datum.items) {
                    ...
                    group.items = [];
                    $(datum.items).each2(function (i, childDatum) {
                        process(childDatum, group.items);
                    });
    ...
    AbstractSelect2 = clazz(Object, {
                ...
                populateResults: function (container, results, query) {
                    ...
                    populate = function (results, container, depth) {
                        ...
                        for (i = 0, l = results.length; i < l; i = i + 1) {
                            ...
                            if (compound) {
                                node.addClass("select2-result-has-items");
                            }
        ...
        open: function () {
            ...
            // When switching from one component to another, we need to close previously opened dropdown.
            $(".select2-container").each(function (index, selectElement) {
        ...
        ensureHighlightVisible: function () {
            var results = this.results,
                items, index, child, hb, rb, y, more, topOffset;
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                this.opts.canAddItem ? "<div class='select2-drop-add-item-button'><i class='fas fa-plus'></i></div>" : "",
                "   </div>",
        ...
        initContainer: function () {
            ...
            this.addItemButton = container.find(".select2-drop-add-item-button");
            ...
            this.focusser.on("focus", this.bind(function (event) {
                if (!this.container.hasClass("select2-container-active")) {
                    ...
                    if (!this.preventFocus && !this.isContainerHovered) {
                        this.opts.instance.focus();
                    }
    ...
    $.fn.select2.defaults = {
        ...
        shouldFocusInput: function (instance) {
            ...
            var supportsTouchEvents = (('ontouchstart' in window) || (window.navigator.msMaxTouchPoints > 0));
    ...
    $.fn.select2.locales.en = {
        ...
        formatInputTooShort: function (input, min) {
            ...
            return "Enter " + n + " or more characters.";
        },
    ...
    .directive('maSelectBox', ['$document', '$timeout', 'MaHelper', function ($document, $timeout, MaHelper) {
        return {
            ...
            controller: ['$scope', function (scope) {
                ...
                scope._minSearchCharacters = scope.minSearchCharacters ? Number(scope.minSearchCharacters) : 1;
