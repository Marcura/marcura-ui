...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","MaHelper","MaValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",validate:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",min:"=",max:"=",changeTimeout:"=",placeholder:"@"},replace:!0,template:function(e){var a='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled(),                        \'ma-date-box-has-value\': hasValue()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            placeholder="{{placeholder}}"                            ng-disabled="isDisabled"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"/><input class="ma-date-box-hour"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minute" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return a},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,u,l,r,d,c,m,f=null,v=i.configuration.displayFormat,y=i.configuration.format,p=i.configuration.timeZone,b=angular.element(o[0].querySelector(".ma-date-box-date")),h=angular.element(o[0].querySelector(".ma-date-box-hour")),g=angular.element(o[0].querySelector(".ma-date-box-minute")),x=a.createEmpty(),E=a.parseTimeZone(p),k=0,D=[],w=i.isRequired,T=new a(i.min),V=new a(i.max),C=null,F=Number(i.changeTimeout),q=0,M=0,R=0,S=function(e){return!x.isEqual(e)&&(i.isTouched=!0,!0)},K=function(){var e=b.val().trim(),t=""===e,n=Number(h.val()),i=Number(g.val()),o=a.createEmpty();return n<0||n>23||i<0||i>59?null:t?o:(o=new a(e),o.isEmpty()?null:(o.add(n,"hour"),o.add(i,"minute"),o.offset(k),o))},N=function(a){var t=null;a&&!a.isEmpty()?(t=a.copy().toUtc().add(E,"minute"),b.val(t.format(v)),h.val(t.format("HH")),g.val(t.format("mm")),s||(s=b.val())):(b.val(""),h.val("00"),g.val("00")),i.isFocused&&(ae(),ne(),d&&b.prop({selectionStart:q,selectionEnd:q}),c&&h.prop({selectionStart:M,selectionEnd:M}),m&&g.prop({selectionStart:R,selectionEnd:R}),e(function(){ee(),te()})),f&&f.setDate(t?t.toDate():null,!0)},Z=function(){f&&(V=new a(i.max),V.isEmpty()&&(V=(new a).add(100,"year")),f.setMaxDate(V.toDate()))},B=function(){f&&(T=new a(i.min),T.isEmpty()&&(T=(new a).subtract(100,"year")),f.setMinDate(T.toDate()))},I=function(e){var t=a.createEmpty();return e?t=i.parser?i.parser(e):a.parse(e,i.culture):t},O=function(e){e.hour(Number(h.val())).minute(Number(g.val())).second(0)},H=function(){k=E},G=function(){f=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",onSelect:function(){var t=new a(f.getDate());return t.offset(E),i.hasTime&&(O(t),H()),e(function(){L(t)}),S(t)?void U(t):void N(t)}}),N(x),Z(),B()},A=function(){f&&f.destroy()},L=function(e,a){i.isValid=!0,C=null;var t=e?e.format(y):null;if(D&&D.length)for(var n=0;n<D.length;n++)if(!D[n].validate(t)){i.isValid=!1,C=D[n];break}a!==!1&&Y(e)},z=function(){var e=!1;D=i.validators?angular.copy(i.validators):[];for(var a=0;a<D.length;a++)if("IsNotEmpty"===D[a].name){e=!0;break}!e&&w&&D.unshift(n.isNotEmpty()),e&&(w=!0),T.isEmpty()||D.push(n.isGreaterOrEqual(T,!0)),V.isEmpty()||D.push(n.isLessOrEqual(V,!0))},U=function(t){x=t||a.createEmpty(),i.value=t?t.format(y):null,e(function(){i.change({maValue:i.value})})},Y=function(a){e(function(){i.validate({maValue:a?a.format(y):null})})},P=function(){i.isTouched=!0;var e=b.val().trim(),t=""===e,n=Number(h.val()),o=Number(g.val()),u=a.createEmpty();return n>=0&&n<=23&&o>=0&&o<=59?(u=I(e),u.offset(k),t&&x.isEmpty()?void L(null):t?(L(u),void(i.isValid&&(N(null),U()))):u.isEmpty()?void(i.isValid=!1):(u.isEmpty()||!i.hasTime&&s!==e||(O(u),u.subtract(E-k,"minute")),L(u),S(u)?(u.isEmpty()||N(u),void(i.isValid&&U(u))):void N(u))):void(i.isValid=!1)},j=function(){d=!0,c=!1,m=!1,i.onFocus()},J=function(){c=!0,d=!1,m=!1,i.onFocus()},Q=function(){m=!0,d=!1,c=!1,i.onFocus()},W=function(){d=!1,i.onBlur()},X=function(){c=!1,i.onBlur()},_=function(){m=!1,i.onBlur()},ee=function(){ae(),$(".ma-date-box-date",o).on("focus",j),$(".ma-date-box-hour",o).on("focus",J),$(".ma-date-box-minute",o).on("focus",Q)},ae=function(){$(".ma-date-box-date",o).off("focus",j),$(".ma-date-box-hour",o).off("focus",J),$(".ma-date-box-minute",o).off("focus",Q)},te=function(){ne(),$(".ma-date-box-date",o).on("blur",W),$(".ma-date-box-hour",o).on("blur",X),$(".ma-date-box-minute",o).on("blur",_)},ne=function(){$(".ma-date-box-date",o).off("blur",W),$(".ma-date-box-hour",o).off("blur",X),$(".ma-date-box-minute",o).off("blur",_)};if(z(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.hasValue=function(){return b.val()||"00"!==h.val()||"00"!==g.val()},i.isResetEnabled=function(){return!i.isDisabled&&(b.val()||"00"!==h.val()||"00"!==g.val())},i.onFocus=function(){t.safeApply(function(){i.isFocused=!0})},i.onBlur=function(){r&&e.cancel(r),i.$apply(function(){i.isFocused=!1,P()})},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(u=angular.element(e.target).val())},i.onKeyup=function(a){if(a.keyCode!==t.keyCode.tab&&a.keyCode!==t.keyCode.shift){var n=!1;l=angular.element(a.target).val(),u!==l&&(n=!0,i.isTouched=!0,H()),n&&F>0&&(q=b.prop("selectionStart"),M=h.prop("selectionStart"),R=g.prop("selectionStart"),r&&e.cancel(r),r=e(function(){P()},F))}},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(x=a.createEmpty(),i.isTouched=!0,L(null),U(),N(null),b.focus())},i.value){var ie=I(i.value);if(ie.isEmpty())return;N(ie),x=ie,k=ie.offset()}ee(),te(),e(function(){i.isDisabled||G(),o.removeAttr("id"),b.attr("id",i.id)}),i.$watch("value",function(e,t){if(null!==e||null!==t){var n=I(e);if(n.isEmpty()&&(x=a.createEmpty(),N(null)),!S(n))return void N(n);L(n,!1),N(n),x=n,k=n.offset()}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?A():G())});var oe=function(e,a,t){if(e!==a){var n=I(b.val().trim());n.offset(E),"max"===t?Z():B(),z();for(var o=[],s=0;s<D.length;s++)"IsGreaterOrEqual"!==D[s].name&&"IsLessOrEqual"!==D[s].name||o.push(D[s]);if(o.length){var u=n.format(y);for(!C||"IsGreaterOrEqual"!==C.name&&"IsLessOrEqual"!==C.name||(C=null,i.isValid=!0),s=0;s<o.length;s++)if(!o[s].validate(u)){i.isValid=!1,C=o[s];break}i.isValid||(i.isTouched=!0),Y(n)}i.isValid&&S(n)&&U(n)}};i.$watch("max",function(e,a){oe(e,a,"max")}),i.$watch("min",function(e,a){oe(e,a,"min")}),i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){i.isTouched=!0;var e=K();return!e||w&&e.isEmpty()?void(i.isValid=!1):void L(e)},i.instance.isValid=function(){return i.isValid},i.instance.failedValidator=function(){return C},i.instance.refresh=function(){var e=I(i.value);N(e),L(e,!1)})}}}])}();
