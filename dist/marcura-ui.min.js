...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,l){return l?e(t,l):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,l,i){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",multiple:"=",storeItemValueOnly:"="},replace:!0,template:function(e,t){var i=!l.isNullOrWhiteSpace(t.ajax),a="true"===t.multiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': hasValue()                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=i?'<input class="ma-select-box-input" ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ui-select2="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">'+(a?"":"<option></option>")+'                            <option ng-repeat="item in _items | maSelectBoxOrderBy:orderBy" value="{{getOptionValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-show="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.getItemValue=function(t){if(l.isNullOrWhiteSpace(t)||!e.itemValueField)return null;if(e.storeItemValueOnly)return(angular.isObject(t)?t[e.itemValueField]:t).toString();for(var i=e.itemValueField.split("."),a=t[i[0]],n=1;n<i.length;n++)a=a[i[n]];return l.isNullOrUndefined(a)?null:a.toString()},e.formatItem=function(t){return e.itemTemplate?e.itemTemplate(t):t?e.itemTextField?t[e.itemTextField]:t.toString():""},e.options={},e.runInitSelection=!0,e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,l){if(e.runInitSelection&&e.getItemValue(e.value)){var i=angular.copy(e.value);i.text=e.formatItem(i),i.id=e.getItemValue(i),e.previousSelectedItem=i,l(i)}else l();e.runInitSelection=!1})}],link:function(i,a){var n,s,o,u,c,d,r=angular.element(a[0].querySelector(".ma-select-box-text")),m=null,f=!0,p=!1,g=!1,v=i.showAddItemTooltip!==!1,h=i.validators?angular.copy(i.validators):[],x=i.itemTextField||i.itemValueField;i._items=angular.isArray(i.items)?angular.copy(i.items):[],i.previousSelectedItem=i.previousSelectedItem||null,i.isAddMode=!1,i.isTextFocused=!1,i.isValid=!0,i.isTouched=!1,i.hasAjax=angular.isObject(i.ajax);var I={name:"IsNotEmpty",validate:function(e){return i.multiple&&angular.isArray(e)?e.length>0:!l.isNullOrWhiteSpace(e)&&!!(i.hasAjax||i.isAddMode||V(e))}},b=function(){for(var e=null,t=0;t<h.length;t++)if("IsNotEmpty"===h[t].name){e=t,h[t]=I;break}null===e&&i.isRequired?h.unshift(I):null===e||i.isRequired||h.splice(e,1)},V=function(e){if(!angular.isArray(i._items))return!1;for(var t=null!==i.getItemValue(e),l=0;l<i._items.length;l++)if(t){if(i.getItemValue(i._items[l])===i.getItemValue(e))return!0}else if(i._items[l]===e)return!0;return!1},A=function(e){if(l.isNullOrWhiteSpace(e))return null;if(!x)return e;if(angular.isArray(i._items))for(var t=0;t<i._items.length;t++)if(i.getItemValue(i._items[t])===e.toString())return i._items[t];return null},S=function(e){if(!x)return e;if(e){var t={};return t[i.itemTextField]=e,t}return null},y=function(e){if(i.multiple){var t=[];if(e&&e.length)for(var a=0;a<e.length;a++)t.push(i.getItemValue(e[a]));i.selectedItem=t,M(e)}else i.canAddItem&&e&&(i.isAddMode=!V(e)),M(e),i.isAddMode?(e?i.itemTextField&&e[i.itemTextField]?i.text=e[i.itemTextField].toString():i.text=e:i.text=null,m=e,i.toggleMode("add")):(l.isNullOrWhiteSpace(e)?i.selectedItem=null:i.hasAjax||(null!==i.getItemValue(e)?i.selectedItem=i.getItemValue(e):"string"==typeof e&&(i.selectedItem=e)),i.previousSelectedItem=e,i.toggleMode("select"))},T=function(e,l){var o=angular.element(e.relatedTarget);i.isTextFocused=!1,"text"===l?(p=!1,i.$apply(function(){i.isTouched=!0;var e;if(i.itemTextField){if(i.value&&i.value[i.itemTextField]===i.text)return;e=S(i.text)}else{if(i.value===i.text)return;e=i.text}M(e),i.isValid&&(d=i.value||null,i.value=e,m=i.value,i.isValid&&t(function(){i.change({maValue:i.value,maOldValue:d})}))})):"select"===l&&i.$apply(function(){i.isTouched=!0}),f=!p&&o[0]!==n[0]&&o[0]!==s[0]&&o[0]!==r[0]&&o[0]!==u.search[0],i.multiple?g&&(f=!1):p||o[0]!==u.focusser[0]||(f=!1),f&&(a.removeClass("ma-select-box-is-select-focused"),i.blur({maValue:i.storeItemValueOnly?A(i.value):i.value})),p=!1},M=function(e){if(i.isValid=!0,h&&h.length)for(var t=0;t<h.length;t++)if(!h[t].validate(e)){i.isValid=!1;break}},F=function(){i.isAddMode?(r.focus(),i.isTextFocused=!0):o.select2("focus")};i.hasValue=function(){return i.multiple?!l.isNullOrUndefined(i.value)&&i.value.length:i.isAddMode?!l.isNullOrWhiteSpace(i.text):!l.isNullOrUndefined(i.value)},i.isResetEnabled=function(){return!i.isDisabled&&(i.multiple?!l.isNullOrUndefined(i.value)&&i.value.length:i.isAddMode?!l.isNullOrWhiteSpace(i.text):!l.isNullOrUndefined(i.value))},i.reset=function(){d=i.value,i.value=i.multiple?[]:null},i.onReset=function(){i.isTouched=!0,i.reset(),F(),t(function(){i.change({maValue:i.value,maOldValue:d})})},i.onFocus=function(e){"text"===e&&(i.isTextFocused=!0),"reset"===e&&a.removeClass("ma-select-box-is-select-focused"),f&&i.focus({maValue:i.storeItemValueOnly?A(i.value):i.value}),f=!1},r.focusout(function(e){T(e,"text")}),i.getAddItemTooltip=function(){return v?i.isAddMode?"Back to the list":i.addItemTooltip?i.addItemTooltip:"Add new item":""},i.getOptionValue=function(e){return i.itemValueField?i.getItemValue(e):e},i.toggleMode=function(e){if(i.canAddItem&&!(i.isAddMode&&"add"===e||!i.isAddMode&&"select"===e)){var l=!1;d=i.value||null,"select"===e?(i.isAddMode=!1,l=!0):"add"===e?(i.isAddMode=!0,l=!0):i.isAddMode=!i.isAddMode,i.isAddMode?(o&&o.select2("close"),i.previousSelectedItem=A(i.selectedItem),i.value=m,i.value&&(i.text="string"==typeof i.value?i.value:i.value[i.itemTextField])):(m=S(i.text),i.value=i.previousSelectedItem),l||t(function(){i.change({maValue:i.value,maOldValue:d}),F()})}},i.onChange=function(){var e;if(i.multiple){for(var a=i.selectedItem,n=[],s=0;s<a.length;s++)e=A(a[s]),e&&n.push(e);i.isTouched=!0,i.value=n,t(function(){i.change({maValue:n})}),u.dropdown.mouseleave()}else{if(e=l.isJson(i.selectedItem)?JSON.parse(i.selectedItem):i.selectedItem,"number"==typeof e&&(e=i.selectedItem),i.hasAjax){if(e===i.previousSelectedItem)return;if(!angular.isObject(e))return}if(!i.hasAjax&&i.itemValueField&&!l.isNullOrWhiteSpace(e))for(var o=0;o<i._items.length;o++)if(i.getItemValue(i._items[o])===e.toString()){e=i._items[o];break}if(!e&&!i.value)return;if(i.itemValueField){var c=i.getItemValue(i.value);if(c&&c===i.getItemValue(e))return}else if(e===i.value)return;d=i.value,i.storeItemValueOnly?(i.value=i.getItemValue(e),i.previousSelectedItem=i.value,d=A(d)):(i.value=e,i.previousSelectedItem=e),t(function(){i.change({maValue:e,maOldValue:d})})}};var O=function(){i.hasAjax&&u&&(u.opts.placeholder=i.value?"":i.placeholder,u.setPlaceholder(),i.runInitSelection=!0,u.initSelection())};i.$watch("items",function(e,l){angular.equals(e,l)||(i._items.splice(0,i._items.length),Array.prototype.push.apply(i._items,e),y(i.value),t(function(){var e,t;if(angular.isObject(i.value))if(i.multiple&&angular.isArray(i.value)){for(var l=[],a=0;a<i.value.length;a++)e=i.getItemValue(i.value[a]),t=angular.copy(A(e)||i.value[a]),t.text=i.formatItem(t),t.id=e,t&&l.push(t);u.data(l)}else e=i.getItemValue(i.value),t=angular.copy(A(e)||i.value),t.text=i.formatItem(t),t.id=e,u.data(t);else i.value?u.val(i.value):u.data(null)}))},!0),i.$watch("value",function(e,t){e!==t&&(O(),y(e))}),i.$watch("text",function(e,t){e!==t&&(i.isTouched=!0,M(e))}),i.$watch("isRequired",function(e,t){e!==t&&(b(),M(i.isAddMode?i.text:i.value))}),i.instance&&(i.instance.isInitialized=!0,i.instance.switchToSelectMode=function(){i.isAddMode&&i.toggleMode("select")},i.instance.switchToAddMode=function(){i.isAddMode||i.toggleMode("add")},i.instance.isValid=function(){return i.isValid},i.instance.validate=function(){i.isTouched=!0,M(i.isAddMode?i.text:i.value)},i.instance.clear=function(){i.reset(),t(function(){i.isTouched=!1})}),b(),t(function(){angular.element(a[0].querySelector(".select2-search")).append('<div class="pace"><div class="pace-activity"></div></div>').append('<i class="ma-select-box-input-search-icon fa fa-search"></i>'),y(i.value),o=angular.element(a[0].querySelector(".select2-container")),u=o.data().select2,c=$('label[for="'+i.id+'"]'),n=angular.element(a[0].querySelector(".ma-button-switch")),s=angular.element(a[0].querySelector(".ma-button-reset")),O(),c.length>0&&$(e).on("click",'label[for="'+i.id+'"]',function(){F()}),i.multiple?(u.search.on("focus",function(){a.addClass("ma-select-box-is-select-focused"),i.onFocus()}),u.search.on("focusout",function(e){T(e,"select")}),u.selection.on("mouseenter",function(){g=!0}),u.selection.on("mouseleave",function(){g=!1}),u.dropdown.on("mouseenter",function(){g=!0}),u.dropdown.on("mouseleave",function(){g=!1}),u.dropdown.on("click",function(){u.search.focus()})):(u.focusser.on("focus",function(){i.onFocus("select")}),u.focusser.on("focusout",function(e){T(e,"select")})),u.dropdown.on("focus",".select2-input",function(){p=!0,i.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),n.focusout(function(e){T(e)}),s.focusout(function(e){T(e)}),u.dropdown.on("mouseenter",".select2-result",function(){p=!0}),u.dropdown.on("mouseleave",".select2-result",function(){p=!1}),$(e).on("mouseenter",".select2-drop-mask",function(){i.multiple||(p=!0)}),i.init({maInstance:i.instance})})}}}])}();
