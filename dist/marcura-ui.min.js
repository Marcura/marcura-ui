...
!function(){angular.module("marcuraUI.services").factory("MaDate",[function(){function e(e){if(this._date=null,this._offset=0,this._isMaDate=!0,n(e)&&(this._date=new Date(e.valueOf())),a(e)&&(e.isEmpty()||(this._date=new Date(e.toDate().valueOf())),this._offset=e.offset()),angular.isString(e)){var t=o(e);this._date=t.toDate(),this._offset=t.offset()}0===arguments.length&&(this._date=new Date)}var t=[{language:"en",months:["January","February","March","April","May","June","July","August","September","October","November","December"]}],r=[31,28,31,30,31,30,31,31,30,31,30,31],n=function(e){return!!e&&("[object Date]"===Object.prototype.toString.call(e)&&e.getTime&&!isNaN(e.getTime()))},a=function(t){return t instanceof e||!!t&&t._isMaDate},s=function(e,t){return e.match(new RegExp(t,"i"))},i=function(n,a,i,u,o,c,f){var h,l=e.createEmpty();i=i.toString(),a=a.toString(),u=u||0,o=o||0,c=c||0,f=f||0,n<=99&&(n=n>=0&&n<30?"20"+n:"19"+n);var d=1===new Date(n,1,29).getMonth();if(d?r[1]=29:r[1]=28,null!==a.match(/([^\u0000-\u0080]|[a-zA-Z])$/)){for(var m=0;m<t.length;m++)for(var y=0;y<t[m].months.length;y++)if(s(a,t[m].months[y].slice(0,3))){h=y+1;break}if(!h)return l;a=h}return a>12?l:i>r[a-1]?l:(l=new e(new Date(n,a-1,i,u,o,c)),l.offset(f),l)},u=function(e,t,r){var n={day:e,month:t,isValid:!0};return"en-GB"===r&&t>12&&(n.isValid=!1),"en-US"===r&&(n.day=t,n.month=e,e>12&&(n.isValid=!1)),!r&&t>12&&(n.day=t,n.month=e),n},o=function(t,r){var s,o,c,f=e.createEmpty();if(n(t)||a(t))return t;if(!angular.isString(t))return f;if(s=/^\d{1,2}$/,null!==t.match(s)){var h=new Date;return i(h.getFullYear(),h.getMonth()+1,t)}if(s=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(s))return o=s.exec(t),c=u(o[1],o[3],r),c.isValid?i((new Date).getFullYear(),c.month,c.day):f;if(s=/^(\d{1,2})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(s))return o=s.exec(t),i(o[5],o[3],o[1]);if(s=/([^\u0000-\u0080]|[a-zA-Z]{3})(\s|)(\d{1,2})(,)(\s|)(\d{2,4})$/,null!==t.match(s))return o=s.exec(t),i(o[6],o[1],o[3]);if(s=/^([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(s))return o=s.exec(t),i(o[5],o[1],o[3]);if(s=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})$/,null!==t.match(s))return o=s.exec(t),i(o[1],o[3],o[5]);if(s=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4})$/,null!==t.match(s))return o=s.exec(t),c=u(o[1],o[3],r),c.isValid?i(o[5],c.month,c.day):f;if(s=/^(\d{4})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(s))return o=s.exec(t),i(o[1],o[3],o[5]);if(s=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})T(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)(?:Z|([+-])(2[0-3]|[01][0-9]):([0-5][0-9]))$/,null!==t.match(s)){o=s.exec(t);var l=0;return 12===o.length&&(l=60*(Number(o[10])||0)+(Number(o[11])||0),"-"===o[9]&&0!==l&&(l=-l)),i(o[1],o[3],o[5],o[6],o[7],o[8],l)}return f},c=function(e,t){for(var r="",n=0;n<t;n++)r+="0";return(r+e).slice(-t)},f=function(e){return e>=-720&&e<=840},h=function(e){if(0===e)return"Z";if("number"!=typeof e)return null;if(e<-720||e>840)return null;var t="+";e<0&&(e*=-1,t="-");var r=e%60,n=(e-r)/60;return t+c(n,2)+":"+c(r,2)},l=function(e){if(!n(e)&&!a(e))return null;var r,s=arguments,i=0;if(2===s.length){if("string"==typeof s[1])r=s[1];else if(i=s[1],!f(i))return null}else if(3===s.length&&(r=s[1],i=s[2],!f(i)))return null;r=r||"yyyy-MM-ddTHH:mm:ssZ";var u=0,o=h(i),l=a(e)?e.toDate():e,d={s:["ss"],m:["mm"],H:["HH"],d:["d","dd"],M:["M","MM","MMM","MMMM"],y:["yy","yyyy"],Z:["Z"]},m=l.getDate(),y=l.getMonth(),p=l.getFullYear(),g=l.getHours(),b=l.getMinutes(),M=l.getSeconds(),_=function(e){var t="";try{t=r.match(new RegExp(e+"+",""))[0]}catch(n){}return d[e].indexOf(t)},v=function(e){var r="";switch(e){case d.d[0]:r=m;break;case d.d[1]:r=c(m,2);break;case d.M[0]:r=y+1;break;case d.M[1]:r=c(y+1,2);break;case d.M[2]:r=t[u].months[y].substr(0,3);break;case d.M[3]:r=t[u].months[y];break;case d.y[0]:r=c(p,2);break;case d.y[1]:r=p;break;case d.H[0]:r=c(g,2);break;case d.m[0]:r=c(b,2);break;case d.s[0]:r=c(M,2);break;case d.Z[0]:r=o||"Z";break;default:return""}return r},D={days:v(d.d[_("d")]),months:v(d.M[_("M")]),years:v(d.y[_("y")]),hours:v(d.H[_("H")]),minutes:v(d.m[_("m")]),seconds:v(d.s[_("s")]),timeZone:v(d.Z[0]),separator:/^\w+([^\w])/.exec(r)};return r.replace(/d+/,D.days).replace(/y+/,D.years).replace(/M+/,D.months).replace(/H+/,D.hours).replace(/m+/,D.minutes).replace(/s+/,D.seconds).replace(/Z+/,D.timeZone)},d=function(t,r){return new e(t).valueOf()-new e(r).valueOf()},m=function(e){if(!e)return 0;e=e.replace(/GMT/gi,"");var t=/^(?:Z|([+-]?)(2[0-3]|[01][0-9]):([0-5][0-9]))$/.exec(e);if(!t||4!==t.length)return 0;if("Z"===t[0])return 0;var r=60*Number(t[2])+Number(t[3]);return 0!==r&&"-"===t[1]&&(r*=-1),r};return e.createEmpty=function(){return new e(null)},e.prototype.copy=function(){return new e(this)},e.prototype.toDate=function(){return this._date},e.prototype.offset=function(e){return 0===arguments.length?this._offset:(this._offset=e,this)},e.prototype.toUtc=function(){return this.isEmpty()||0===this._offset?this:(this.subtract(this._offset,"minute"),this._offset=0,this)},e.prototype.isEmpty=function(){return!this._date},e.prototype.difference=function(e){return d(this,e)},e.prototype.valueOf=function(){if(this.isEmpty())return 0;var e=this._date.valueOf();return 0!==this._offset&&(e-=6e4*this._offset),e},e.prototype.format=function(e){return this.isEmpty()?null:l(this._date,e,this._offset)},e.prototype.add=function(e,t){if(this.isEmpty()||!e)return this;var r=new Date(this._date);switch(t){case"year":r.setFullYear(r.getFullYear()+e);break;case"quarter":r.setMonth(r.getMonth()+3*e);break;case"month":r.setMonth(r.getMonth()+e);break;case"week":r.setDate(r.getDate()+7*e);break;case"day":r.setDate(r.getDate()+e);break;case"hour":r.setTime(r.getTime()+36e5*e);break;case"minute":r.setTime(r.getTime()+6e4*e);break;case"second":r.setTime(r.getTime()+1e3*e)}return this._date=r,this},e.prototype.subtract=function(e,t){return this.add(e*-1,t)},e.prototype.second=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getSeconds():(this._date.setSeconds(e),this)},e.prototype.minute=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getMinutes():(this._date.setMinutes(e),this)},e.prototype.hour=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getHours():(this._date.setHours(e),this)},e.parse=o,e.parseTimeZone=m,e.offsetToTimeZone=h,e.format=l,e.isDate=n,e.difference=d,e.isMaDate=a,e}])}();
