...
!function(){angular.module("marcuraUI.components").directive("maPager",["$timeout",function(e){return{restrict:"E",scope:{page:"=",totalPages:"=",visiblePages:"=",showItemsPerPage:"=",itemsPerPageNumbers:"=",itemsPerPageText:"@",itemsPerPage:"=",change:"&"},replace:!0,template:function(){var e='<div class="ma-pager" ng-class="{                \'ma-pager-has-pager\': _hasPager            }">                <div class="ma-pager-items-per-page" ng-if="_showItemsPerPage">                    <div class="ma-pager-items-per-page-text" ng-show="itemsPerPageText">{{itemsPerPageText}}</div><ma-select-box                        items="_itemsPerPageNumbers"                        value="_itemsPerPage"                        change="itemsPerPageChange(maValue)">                    </ma-select-box>                </div><div class="ma-pager-pager">                    <div class="ma-pager-start">                        <ma-button                            class="ma-button-first"                            text="First"                            size="xs"                            modifier="default"                            click="firstClick()"                            is-disabled="_page <= 1"                        ></ma-button><ma-button                            class="ma-button-previous"                            text="Previous"                            size="xs"                            modifier="default"                            click="previousClick()"                            is-disabled="_page <= 1">                        </ma-button>                    </div                    ><div class="ma-pager-middle">                        <ma-button                            class="ma-button-previous-range"                            text="..."                            size="xs"                            modifier="default"                            click="previousRangeClick()"                            is-disabled="isFirstRange"                        ></ma-button><div class="ma-pager-pages"><ma-button                            ng-repeat="rangePage in rangePages"                            class="ma-button-page"                            text="{{rangePage}}"                            size="xs"                            modifier="{{_page === rangePage ? \'selected\' : \'default\'}}"                            click="pageClick(rangePage)"></div></ma-button                        ><ma-button                            class="ma-button-next-range"                            text="..."                            size="xs"                            modifier="default"                            click="nextRangeClick()"                            is-disabled="isLastRange"                        ></ma-button>                    </div                    ><div class="ma-pager-end">                        <ma-button                            class="ma-button-next"                            text="Next"                            size="xs"                            modifier="default"                            click="nextClick()"                            is-disabled="_page >= totalPages"                        ></ma-button><ma-button                            class="ma-button-last"                            text="Last"                            size="xs"                            modifier="default"                            click="lastClick()"                            is-disabled="_page >= totalPages">                        </ma-button>                    </div>                </div>            </div>';return e},link:function(a){a._page=a.page,a._showItemsPerPage=a.showItemsPerPage!==!1,a._itemsPerPageNumbers=["25","50","75","100"],a._itemsPerPage="25",a.hasItemsPerPageChanged=!1;var s=function(){a._showItemsPerPage&&a.itemsPerPage&&(a._itemsPerPage=a.itemsPerPage.toString())},t=function(){a._showItemsPerPage&&angular.isArray(a.itemsPerPageNumbers)&&(a._itemsPerPageNumbers=a.itemsPerPageNumbers)},i=function(){a._visiblePages=a.visiblePages>1?a.visiblePages:5,a.totalPages<a._visiblePages&&(a._visiblePages=a.totalPages),a.rangePages=[],a.range=Math.ceil(a._page/a._visiblePages)-1,a.isFirstRange=0===a.range,a.isLastRange=a.totalPages-a._page<a._visiblePages;for(var e=a.range*a._visiblePages,s=1;s<=a._visiblePages;s++)a.rangePages.push(e+s)},g=function(){a._hasPager=!a._showItemsPerPage||a.totalPages>Number(a._itemsPerPage)},r=function(){if(a.page!==a._page||a.hasItemsPerPageChanged){a.page=a._page,i();var s={maPage:a.page};a._showItemsPerPage&&(s.maItemsPerPage=Number(a._itemsPerPage),a.hasItemsPerPageChanged=!1),e(function(){a.change(s)})}};a.itemsPerPageChange=function(e){a._itemsPerPage=e,a.hasItemsPerPageChanged=!0,g(),r()},a.firstClick=function(){a._page=1,r()},a.previousClick=function(){a._page=a._page<=1?1:a._page-1,r()},a.nextClick=function(){a._page=a._page>=a.totalPages?1:a._page+1,r()},a.lastClick=function(){a._page=a.totalPages,r()},a.pageClick=function(e){a._page=e,r()},a.previousRangeClick=function(){a._page=a.range*a._visiblePages,r()},a.nextRangeClick=function(){a._page=a.range*a._visiblePages+a._visiblePages+1,r()},a.$watch("visiblePages",function(e,a){e!==a&&i()}),a.$watch("page",function(e,s){if(e!==s){var t=a.page;t<1?t=1:t>a.totalPages&&(t=a.totalPages),a._page=t,i()}}),a.$watch("itemsPerPageNumbers",function(e,a){angular.equals(e,a)||t()}),a.$watch("itemsPerPage",function(e,a){e!==a&&(s(),g())}),i(),t(),s(),g()}}}])}();
