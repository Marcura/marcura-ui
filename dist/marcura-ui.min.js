...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",multiple:"=",storeItemValueOnly:"="},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),n="true"===t.multiple,a="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return a+=l?'<input class="ma-select-box-input" ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ui-select2="options"'+(n?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">'+(n?"":"<option></option>")+'                            <option ng-repeat="item in _items | maSelectBoxOrderBy:orderBy" value="{{getOptionValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',a+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-show="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.getItemValue=function(t){if(i.isNullOrWhiteSpace(t)||!e.itemValueField)return null;if(e.storeItemValueOnly)return(angular.isObject(t)?t[e.itemValueField]:t).toString();for(var l=e.itemValueField.split("."),n=t[l[0]],a=1;a<l.length;a++)n=n[l[a]];return i.isNullOrUndefined(n)?null:n.toString()},e.formatItem=function(t){return e.itemTemplate?e.itemTemplate(t):t?e.itemTextField?t[e.itemTextField]:t.toString():""},e.options={},e.runInitSelection=!0,e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.formatItem(l),l.id=e.getItemValue(l),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1})}],link:function(l,n){var a,o,s,u,c,d,r=angular.element(n[0].querySelector(".ma-select-box-text")),m=null,f=!0,p=!1,g=!1,v=l.showAddItemTooltip!==!1,h=l.validators?angular.copy(l.validators):[],x=l.itemTextField||l.itemValueField;l._items=angular.isArray(l.items)?angular.copy(l.items):[],l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.isAjax=angular.isObject(l.ajax);var I={name:"IsNotEmpty",validate:function(e){return l.multiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&!!(l.isAjax||l.isAddMode||V(e))}},b=function(){for(var e=null,t=0;t<h.length;t++)if("IsNotEmpty"===h[t].name){e=t,h[t]=I;break}null===e&&l.isRequired?h.unshift(I):null===e||l.isRequired||h.splice(e,1)},V=function(e){if(!angular.isArray(l._items))return!1;for(var t=null!==l.getItemValue(e),i=0;i<l._items.length;i++)if(t){if(l.getItemValue(l._items[i])===l.getItemValue(e))return!0}else if(l._items[i]===e)return!0;return!1},A=function(e){if(i.isNullOrWhiteSpace(e))return null;if(!x)return e;if(angular.isArray(l._items))for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},y=function(e){if(!x)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},S=function(e){if(l.multiple){var t=[];if(e&&e.length)for(var n=0;n<e.length;n++)t.push(l.getItemValue(e[n]));l.selectedItem=t,M(e)}else l.canAddItem&&e&&(l.isAddMode=!V(e)),M(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.isAjax||(null!==l.getItemValue(e)?l.selectedItem=l.getItemValue(e):"string"==typeof e&&(l.selectedItem=e)),l.previousSelectedItem=e,l.toggleMode("select"))},T=function(e,i){var s=angular.element(e.relatedTarget);l.isTextFocused=!1,"text"===i?(p=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=y(l.text)}else{if(l.value===l.text)return;e=l.text}M(e),l.isValid&&(d=l.value||null,l.value=e,m=l.value,l.isValid&&t(function(){l.change({maValue:l.value,maOldValue:d})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),f=!p&&s[0]!==a[0]&&s[0]!==o[0]&&s[0]!==r[0]&&s[0]!==u.search[0],l.multiple?g&&(f=!1):p||s[0]!==u.focusser[0]||(f=!1),f&&(n.removeClass("ma-select-box-is-select-focused"),l.blur({maValue:l.storeItemValueOnly?A(l.value):l.value})),p=!1},M=function(e){if(l.isValid=!0,h&&h.length)for(var t=0;t<h.length;t++)if(!h[t].validate(e)){l.isValid=!1;break}},F=function(){l.isAddMode?(r.focus(),l.isTextFocused=!0):s.select2("focus")};l.isResetEnabled=function(){return!l.isDisabled&&(l.multiple?!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?!i.isNullOrWhiteSpace(l.text):!i.isNullOrUndefined(l.value))},l.reset=function(){d=l.value,l.value=l.multiple?[]:null},l.onReset=function(){l.isTouched=!0,l.reset(),F(),t(function(){l.change({maValue:l.value,maOldValue:d})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),"reset"===e&&n.removeClass("ma-select-box-is-select-focused"),f&&l.focus({maValue:l.storeItemValueOnly?A(l.value):l.value}),f=!1},r.focusout(function(e){T(e,"text")}),l.getAddItemTooltip=function(){return v?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getOptionValue=function(e){return l.itemValueField?l.getItemValue(e):e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;d=l.value||null,"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(s&&s.select2("close"),l.previousSelectedItem=A(l.selectedItem),l.value=m,l.value&&(l.text="string"==typeof l.value?l.value:l.value[l.itemTextField])):(m=y(l.text),l.value=l.previousSelectedItem),i||t(function(){l.change({maValue:l.value,maOldValue:d}),F()})}},l.onChange=function(){var e;if(l.multiple){for(var n=l.selectedItem,a=[],o=0;o<n.length;o++)e=A(n[o]),e&&a.push(e);l.isTouched=!0,l.value=a,t(function(){l.change({maValue:a})}),u.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"==typeof e&&(e=l.selectedItem),l.isAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.isAjax&&l.itemValueField&&!i.isNullOrWhiteSpace(e))for(var s=0;s<l._items.length;s++)if(l.getItemValue(l._items[s])===e.toString()){e=l._items[s];break}if(!e&&!l.value)return;if(l.itemValueField){var c=l.getItemValue(l.value);if(c&&c===l.getItemValue(e))return}else if(e===l.value)return;d=l.value,l.storeItemValueOnly?(l.value=l.getItemValue(e),l.previousSelectedItem=l.value,d=A(d)):(l.value=e,l.previousSelectedItem=e),t(function(){l.change({maValue:e,maOldValue:d})})}};var O=function(){l.isAjax&&u&&(u.opts.placeholder=l.value?"":l.placeholder,u.setPlaceholder(),l.runInitSelection=!0,u.initSelection())};l.$watch("items",function(e,i){angular.equals(e,i)||(l._items.splice(0,l._items.length),Array.prototype.push.apply(l._items,e),S(l.value),t(function(){var e,t;if(angular.isObject(l.value))if(l.multiple&&angular.isArray(l.value)){for(var i=[],n=0;n<l.value.length;n++)e=l.getItemValue(l.value[n]),t=angular.copy(A(e)||l.value[n]),t.text=l.formatItem(t),t.id=e,t&&i.push(t);u.data(i)}else e=l.getItemValue(l.value),t=angular.copy(A(e)||l.value),t.text=l.formatItem(t),t.id=e,u.data(t);else l.value?u.val(l.value):u.data(null)}))},!0),l.$watch("value",function(e,t){e!==t&&(O(),S(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,M(e))}),l.$watch("isRequired",function(e,t){e!==t&&(b(),M(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,M(l.isAddMode?l.text:l.value)},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),b(),t(function(){angular.element(n[0].querySelector(".select2-search")).append('<div class="pace"><div class="pace-activity"></div></div>').append('<i class="ma-select-box-input-search-icon fa fa-search"></i>'),S(l.value),s=angular.element(n[0].querySelector(".select2-container")),u=s.data().select2,c=$('label[for="'+l.id+'"]'),a=angular.element(n[0].querySelector(".ma-button-switch")),o=angular.element(n[0].querySelector(".ma-button-reset")),O(),c.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){F()}),l.multiple?(u.search.on("focus",function(){n.addClass("ma-select-box-is-select-focused"),l.onFocus()}),u.search.on("focusout",function(e){T(e,"select")}),u.selection.on("mouseenter",function(){g=!0}),u.selection.on("mouseleave",function(){g=!1}),u.dropdown.on("mouseenter",function(){g=!0}),u.dropdown.on("mouseleave",function(){g=!1}),u.dropdown.on("click",function(){u.search.focus()})):(u.focusser.on("focus",function(){l.onFocus("select")}),u.focusser.on("focusout",function(e){T(e,"select")})),u.dropdown.on("focus",".select2-input",function(){p=!0,l.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),a.focusout(function(e){T(e)}),o.focusout(function(e){T(e)}),u.dropdown.on("mouseenter",".select2-result",function(){p=!0}),u.dropdown.on("mouseleave",".select2-result",function(){p=!1}),$(e).on("mouseenter",".select2-drop-mask",function(){l.multiple||(p=!0)}),l.init({maInstance:l.instance})})}}}])}();
...
!function(){angular.module("marcuraUI.components").provider("maTextBoxConfiguration",function(){this.$get=function(){return this}}).directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",changeWhenIsInvalid:"=",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"=",max:"=",min:"=",decimals:"=",reset:"&",defaultValue:"="},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text";"number"!==i&&"email"!==i||(i="text");var n="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return n},controller:["$scope","maTextBoxConfiguration",function(e,a){e.configuration={},e.decimals>=0?e.configuration.decimals=e.decimals:a.decimals>=0?e.configuration.decimals=a.decimals:e.configuration.decimals=2}],link:function(n,t,s){var o,l,u,r,d,c=angular.element(t[0].querySelector(".ma-text-box-value")),f=angular.element(t[0].querySelector(".ma-button-reset")),m=angular.element(t[0].querySelector(".ma-button-toggle-password")),v=[],g=n.isRequired,p=Number(n.changeTimeout),b=!0,h=n.trim!==!1,y=!1,x=null,V=n.configuration.decimals,w=void 0!==s.defaultValue,k=a.isNullOrUndefined(n.defaultValue)?"":n.defaultValue;"number"===n.type&&(k="number"==typeof n.defaultValue?n.defaultValue:null);var C=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==n.type&&h&&(e=e.trim()),u=e},T=function(){var e=c.val();return"number"===n.type?F(e):e},O=function(){n.isValid=!0,x=null;var e=c.val();if("number"===n.type&&(e=I(e)),v&&v.length)for(var a=0;a<v.length;a++)if(!v[a].validate(e)){n.isValid=!1,x=v[a];break}},N=function(i){if(E(i)){y=!0;var t=u;"number"!==n.type&&h&&(t=t.trim(),i=i.trim()),w&&(a.isNullOrUndefined(i)&&(i=k),a.isNullOrUndefined(t)&&(t=k)),n.value=i,C(i),e(function(){n.change({maValue:i,maOldValue:t})})}},E=function(e){e=a.isNullOrUndefined(e)?"":e;var i=a.isNullOrUndefined(u)?"":u,t=!1;return t="number"!==n.type&&h?i.trim()!==e.trim():i!==e},P=function(){return n.isTouched=!0,E(T())?(O(),void((n.isValid||n.changeWhenIsInvalid)&&N(T()))):void O()},F=function(e,i){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(I(e)),i||(e=parseFloat(e.toFixed(V))),isNaN(e)?null:e)},R=function(e){if(a.isNullOrWhiteSpace(e))return"";var i=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),n=e.replace(/(\.\d+)$/,""),t=n.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+t+i},I=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(",","")},q=function(e){if(a.isNullOrWhiteSpace(e))return e;var i=e;return"number"===n.type&&(i=R(e.toFixed(V))),i},S=function(){var e=!1;v=n.validators?angular.copy(n.validators):[];for(var a=0;a<v.length;a++)if("IsNotEmpty"===v[a].name){e=!0;break}!e&&g&&v.unshift(i.isNotEmpty()),e&&(g=!0),"number"===n.type&&(v.push(i.isNumber(!0)),"number"==typeof n.min&&v.push(i.isGreaterOrEqual(n.min,!0)),"number"==typeof n.max&&v.push(i.isLessOrEqual(n.max,!0))),"email"===n.type&&v.push(i.isEmail(!0))};S(),n.isValueFocused=!1,n.isTouched=!1,n.canTogglePassword=!1,n.isPasswordVisible=!1,"password"===n.type&&(n.canTogglePassword=n.hasShowPasswordButton!==!1),n.isResetEnabled=function(){if(n.isDisabled)return!1;if("number"===n.type){var e=c.val();return""!==e&&!a.isNumber(e)||F(e,!0)!==k&&""!==e}return c.val()!==k},n.doReset=function(){C(T()),c.val(k)},n.onReset=function(){n.isDisabled||(n.doReset(),n.isTouched=!0,N(k),O(),c.focus(),e(function(){n.reset()}))},n.onFocus=function(e){"value"===e&&(n.isValueFocused=!0,"number"===n.type&&!a.isNullOrUndefined(n.value)&&n.isValid&&c.val(n.value.toFixed(V))),b&&(d=n.value,n.focus({maValue:n.value})),b=!1},c.focusout(function(e){D(e,"value")}),f.focusout(function(e){D(e)}),m.focusout(function(e){D(e)}),n.togglePassword=function(){n.isPasswordVisible=!n.isPasswordVisible,c[0].type=n.isPasswordVisible?"text":"password"},n.isTogglePasswordEnabled=function(){return!n.isDisabled&&""!==c.val()};var D=function(i,t){var s=angular.element(i.relatedTarget);b=n.canTogglePassword?s[0]!==c[0]&&s[0]!==m[0]&&s[0]!==f[0]:s[0]!==c[0]&&s[0]!==f[0],r&&e.cancel(r),"value"===t&&(w&&""===c.val().trim()&&(y=!0,n.value=k,c.val(q(n.value))),n.isResetEnabled()||s[0]!==f[0]||(b=!0),n.isValid&&c.val(q(n.value))),a.safeApply(function(){n.isValueFocused=!1}),b&&(P(),a.safeApply(function(){n.blur({maValue:n.value,maOldValue:d,maHasValueChanged:d!==n.value})}))};n.onKeydown=function(e){if(e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val(),"number"===n.type)){if($.inArray(e.keyCode,[a.keyCode.backspace,a.keyCode["delete"],a.keyCode.home,a.keyCode.end,a.keyCode.period,a.keyCode.dash,a.keyCode.dash2])!==-1||37===e.keyCode||39===e.keyCode)return;(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()}},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var n=!1;l=angular.element(i.target).val(),o!==l&&(n=!0),n&&(r&&e.cancel(r),r=e(function(){P()},p))}}),e(function(){t.removeAttr("id"),c.attr("id",n.id)}),n.$watch("value",function(e,a){if(y)return void(y=!1);if(e!==a){E(e)&&(n.isTouched=!0);var i=c.prop("selectionStart");C(e),c.val(q(e)),O(),n.isValueFocused&&c.prop({selectionStart:i,selectionEnd:i})}});var U=function(e,a){if(e!==a){var i=T();S();for(var t=[],s=0;s<v.length;s++)"IsGreaterOrEqual"!==v[s].name&&"IsLessOrEqual"!==v[s].name||t.push(v[s]);if(t.length){for(!x||"IsGreaterOrEqual"!==x.name&&"IsLessOrEqual"!==x.name||(x=null,n.isValid=!0),s=0;s<t.length;s++)if(!t[s].validate(i)){n.isValid=!1,x=t[s];break}n.isValid||(n.isTouched=!0)}(n.isValid||n.changeWhenIsInvalid)&&N(i)}};n.$watch("max",function(e,a){U(e,a)}),n.$watch("min",function(e,a){U(e,a)}),w&&a.isNullOrUndefined(n.value)&&(n.value=k),c.val(q(n.value)),O(),C(n.value),n.instance&&(n.instance.isInitialized=!0,n.instance.validate=function(){n.isTouched=!0,O()},n.instance.isValid=function(){return n.isValid},n.instance.focus=function(){n.isValueFocused||c.focus()},n.instance.failedValidator=function(){return x},n.instance.clear=function(){n.doReset(),e(function(){n.isTouched=!1})})}}}])}();