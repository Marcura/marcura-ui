...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,n){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"="},replace:!0,template:function(e,t){var n=!i.isNullOrWhiteSpace(t.ajax),o="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-input-focused': isInputFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return o+=n?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="value"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="value"                            ng-change="onChange()">                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',o+='                    <input class="ma-select-box-input" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,n){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.selectedItem&&e.selectedItem[e.itemValueField]){var o=angular.copy(e.selectedItem);o.text=o[e.itemTextField],o.id=o[e.itemValueField],e.previousSelectedItem=o,n(o)}else n();t.runs++})}],link:function(o,s){var d,l,u,c,a=angular.element(s[0].querySelector(".ma-select-box-input")),r=null,m=!0,f=!1,g=o.showAddItemTooltip!==!1,p=o.validators?angular.copy(o.validators):[],I=o.isRequired,x=!1;o.previousSelectedItem=o.previousSelectedItem||null,o.isAddMode=!1,o.formatItem=o.itemTemplate||function(e){return e?o.itemTextField?e[o.itemTextField]:e.toString():""},o.isInputFocused=!1,o.isValid=!0,o.isTouched=!1,o.isAjax=angular.isObject(o.ajax);var v=function(e){if(!angular.isArray(o.items))return!1;for(var t=o.itemValueField&&e[o.itemValueField],i=0;i<o.items.length;i++)if(t){if(o.items[i][o.itemValueField]===e[o.itemValueField])return!0}else if(o.items[i]===e)return!0;return!1},F=function(e){if(!e)return null;if(!o.itemTextField)return e;if(angular.isArray(o.items))for(var t=0;t<o.items.length;t++)if(o.items[t][o.itemValueField].toString()===e.toString())return o.items[t];return null},h=function(e){if(!o.itemTextField)return e;if(e){var t={};return t[o.itemTextField]=e,t}return null},A=function(e){o.canAddItem&&e&&(o.isAddMode=!v(e)),S(e),o.isAddMode?(e?o.itemTextField&&e[o.itemTextField]?o.text=e[o.itemTextField].toString():o.text=e:o.text=null,r=e,o.toggleMode("add")):(e?o.isAjax||(o.itemValueField&&e[o.itemValueField]?o.value=e[o.itemValueField].toString():"string"==typeof e&&(o.value=e)):o.value=null,o.previousSelectedItem=e,o.toggleMode("select"))},b=function(e,i){var n=angular.element(e.relatedTarget),s=angular.element(u.dropdown[0].querySelector(".select2-input"));o.isInputFocused=!1,"input"===i?(f=!1,o.$apply(function(){if(o.isTouched=!0,o.itemTextField){if(o.selectedItem&&o.selectedItem[o.itemTextField]===o.text)return;o.selectedItem=h(o.text)}else{if(o.selectedItem===o.text)return;o.selectedItem=o.text}r=o.selectedItem,o.isValid&&t(function(){o.change({item:o.selectedItem})})})):"select"===i&&o.$apply(function(){o.isTouched=!0}),m=o.canAddItem?!f&&n[0]!==d[0]&&n[0]!==a[0]&&n[0]!==u.focusser[0]&&n[0]!==s[0]:!f&&n[0]!==a[0]&&n[0]!==u.focusser[0]&&n[0]!==s[0],m&&o.blur({item:o.selectedItem}),f=!1},S=function(e){if(o.isValid=!0,p&&p.length)for(var t=0;t<p.length;t++)if(!p[t].method(e)){o.isValid=!1;break}};o.onFocus=function(e){"input"===e&&(o.isInputFocused=!0),m&&o.focus({item:o.selectedItem}),m=!1},a.focusout(function(e){b(e,"input")}),o.getAddItemTooltip=function(){return g?o.isAddMode?"Back to the list":o.addItemTooltip?o.addItemTooltip:"Add new item":""},o.getItemValue=function(e){return o.itemValueField?e[o.itemValueField].toString():e},o.toggleMode=function(e){if(o.canAddItem&&!(o.isAddMode&&"add"===e||!o.isAddMode&&"select"===e)){var i=!1;"select"===e?(o.isAddMode=!1,i=!0):"add"===e?(o.isAddMode=!0,i=!0):o.isAddMode=!o.isAddMode,o.isAddMode?(l&&l.select2("close"),o.previousSelectedItem=F(o.value),o.selectedItem=r,o.selectedItem&&(o.text="string"==typeof o.selectedItem?o.selectedItem:o.selectedItem[o.itemTextField])):(r=h(o.text),o.selectedItem=o.previousSelectedItem),i||t(function(){o.change({item:o.selectedItem}),o.isAddMode?(a.focus(),o.isInputFocused=!0):l.select2("focus")})}},o.onChange=function(){var e=i.isJson(o.value)?JSON.parse(o.value):o.value;if(o.isAjax){if(e===o.previousSelectedItem)return;if(!angular.isObject(e))return}if(!o.isAjax&&o.itemValueField&&e)for(var n=0;n<o.items.length;n++)if(o.items[n][o.itemValueField].toString()===e.toString()){e=o.items[n];break}if(e||o.selectedItem){if(o.itemValueField){if(o.selectedItem&&o.selectedItem[o.itemValueField]&&o.selectedItem[o.itemValueField].toString()===e[o.itemValueField].toString())return}else if(e===o.selectedItem)return;o.selectedItem=e,o.previousSelectedItem=e,t(function(){o.change({item:e})})}},o.$watch("selectedItem",function(e,t){e!==t&&A(e)}),o.$watch("text",function(e,t){e!==t&&(o.isTouched=!0,S(e))}),o.instance&&(o.instance.switchToSelectMode=function(){o.isAddMode&&o.toggleMode("select")},o.instance.switchToAddMode=function(){o.isAddMode||o.toggleMode("add")},o.instance.isValid=function(){return o.isValid});for(var M=0;M<p.length;M++)if("IsNotEmpty"===p[M].name){x=!0;break}!x&&I&&p.unshift(n.isNotEmpty()),x&&(I=!0),t(function(){A(o.selectedItem),l=angular.element(s[0].querySelector(".select2-container")),u=l.data().select2,c=$('label[for="'+o.id+'"]'),d=angular.element(s[0].querySelector(".ma-button")),c.length>0&&$(e).on("click",'label[for="'+o.id+'"]',function(){o.isAddMode?a.focus():l.select2("focus")}),u.focusser.on("focus",function(){o.onFocus("select")}),u.focusser.on("focusout",function(e){b(e,"select")}),u.dropdown.on("focus",".select2-input",function(){f=!0,o.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){b(e,"select")}),d.focusout(function(e){b(e)}),u.dropdown.on("mouseenter",".select2-result",function(){f=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){f=!0})})}}}])}();
