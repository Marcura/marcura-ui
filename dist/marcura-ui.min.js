...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,o){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var o=!i.isNullOrWhiteSpace(t.ajax),n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=o?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="value"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="value"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,o){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.selectedItem&&e.selectedItem[e.itemValueField]){var n=angular.copy(e.selectedItem);n.text=n[e.itemTextField],n.id=n[e.itemValueField],e.previousSelectedItem=n,o(n)}else o();t.runs++})}],link:function(n,l){var s,d,c,a,u,r=angular.element(l[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=n.showAddItemTooltip!==!1,x=n.validators?angular.copy(n.validators):[],I=n.isRequired,h=!1;n.previousSelectedItem=n.previousSelectedItem||null,n.isAddMode=!1,n.formatItem=n.itemTemplate||function(e){return e?n.itemTextField?e[n.itemTextField]:e.toString():""},n.isTextFocused=!1,n.isValid=!0,n.isTouched=!1,n.isAjax=angular.isObject(n.ajax);var b=function(e){if(!angular.isArray(n.items))return!1;for(var t=n.itemValueField&&e[n.itemValueField],i=0;i<n.items.length;i++)if(t){if(n.items[i][n.itemValueField]===e[n.itemValueField])return!0}else if(n.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!n.itemTextField)return e;if(angular.isArray(n.items))for(var t=0;t<n.items.length;t++)if(n.items[t][n.itemValueField].toString()===e.toString())return n.items[t];return null},F=function(e){if(!n.itemTextField)return e;if(e){var t={};return t[n.itemTextField]=e,t}return null},A=function(e){n.canAddItem&&e&&(n.isAddMode=!b(e)),S(e),n.isAddMode?(e?n.itemTextField&&e[n.itemTextField]?n.text=e[n.itemTextField].toString():n.text=e:n.text=null,m=e,n.toggleMode("add")):(e?n.isAjax||(n.itemValueField&&e[n.itemValueField]?n.value=e[n.itemValueField].toString():"string"==typeof e&&(n.value=e)):n.value=null,n.previousSelectedItem=e,n.toggleMode("select"))},T=function(e,i){var o=angular.element(e.relatedTarget),l=angular.element(a.dropdown[0].querySelector(".select2-input"));n.isTextFocused=!1,"text"===i?(g=!1,n.$apply(function(){if(n.isTouched=!0,n.itemTextField){if(n.selectedItem&&n.selectedItem[n.itemTextField]===n.text)return;n.selectedItem=F(n.text)}else{if(n.selectedItem===n.text)return;n.selectedItem=n.text}m=n.selectedItem,n.isValid&&t(function(){n.change({item:n.selectedItem})})})):"select"===i&&n.$apply(function(){n.isTouched=!0}),f=n.canAddItem?!g&&o[0]!==s[0]&&o[0]!==d[0]&&o[0]!==r[0]&&o[0]!==a.focusser[0]&&o[0]!==l[0]:!g&&o[0]!==d[0]&&o[0]!==r[0]&&o[0]!==a.focusser[0]&&o[0]!==l[0],f&&n.blur({item:n.selectedItem}),g=!1},S=function(e){if(n.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].method(e)){n.isValid=!1;break}},M=function(){n.isAddMode?(r.focus(),n.isTextFocused=!0):c.select2("focus")};n.isResetEnabled=function(){return!n.isDisabled&&(n.isAddMode?!i.isNullOrWhiteSpace(n.text):null!==n.selectedItem)},n.onReset=function(){n.selectedItem=null,M(),t(function(){n.change({item:n.selectedItem})})},n.onFocus=function(e){"text"===e&&(n.isTextFocused=!0),f&&n.focus({item:n.selectedItem}),f=!1},r.focusout(function(e){T(e,"text")}),n.getAddItemTooltip=function(){return p?n.isAddMode?"Back to the list":n.addItemTooltip?n.addItemTooltip:"Add new item":""},n.getItemValue=function(e){return n.itemValueField?e[n.itemValueField].toString():e},n.toggleMode=function(e){if(n.canAddItem&&!(n.isAddMode&&"add"===e||!n.isAddMode&&"select"===e)){var i=!1;"select"===e?(n.isAddMode=!1,i=!0):"add"===e?(n.isAddMode=!0,i=!0):n.isAddMode=!n.isAddMode,n.isAddMode?(c&&c.select2("close"),n.previousSelectedItem=v(n.value),n.selectedItem=m,n.selectedItem&&(n.text="string"==typeof n.selectedItem?n.selectedItem:n.selectedItem[n.itemTextField])):(m=F(n.text),n.selectedItem=n.previousSelectedItem),i||t(function(){n.change({item:n.selectedItem}),M()})}},n.onChange=function(){var e=i.isJson(n.value)?JSON.parse(n.value):n.value;if(n.isAjax){if(e===n.previousSelectedItem)return;if(!angular.isObject(e))return}if(!n.isAjax&&n.itemValueField&&e)for(var o=0;o<n.items.length;o++)if(n.items[o][n.itemValueField].toString()===e.toString()){e=n.items[o];break}if(e||n.selectedItem){if(n.itemValueField){if(n.selectedItem&&n.selectedItem[n.itemValueField]&&n.selectedItem[n.itemValueField].toString()===e[n.itemValueField].toString())return}else if(e===n.selectedItem)return;n.selectedItem=e,n.previousSelectedItem=e,t(function(){n.change({item:e})})}},n.$watch("selectedItem",function(e,t){e!==t&&A(e)}),n.$watch("text",function(e,t){e!==t&&(n.isTouched=!0,S(e))}),n.instance&&(n.instance.switchToSelectMode=function(){n.isAddMode&&n.toggleMode("select")},n.instance.switchToAddMode=function(){n.isAddMode||n.toggleMode("add")},n.instance.isValid=function(){return n.isValid});for(var V=0;V<x.length;V++)if("IsNotEmpty"===x[V].name){h=!0;break}!h&&I&&x.unshift(o.isNotEmpty()),h&&(I=!0),t(function(){A(n.selectedItem),c=angular.element(l[0].querySelector(".select2-container")),a=c.data().select2,u=$('label[for="'+n.id+'"]'),s=angular.element(l[0].querySelector(".ma-button-switch")),d=angular.element(l[0].querySelector(".ma-button-reset")),u.length>0&&$(e).on("click",'label[for="'+n.id+'"]',function(){M()}),a.focusser.on("focus",function(){n.onFocus("select")}),a.focusser.on("focusout",function(e){T(e,"select")}),a.dropdown.on("focus",".select2-input",function(){g=!0,n.onFocus()}),a.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),s.focusout(function(e){T(e)}),d.focusout(function(e){T(e)}),a.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
