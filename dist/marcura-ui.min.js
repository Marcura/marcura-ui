...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,t){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@"},replace:!0,template:function(e,a){var t="password"===a.type?"password":"text",i="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+t+'" id="{{id}}"                    type="text"                    placeholder="{{placeholder}}"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return i},link:function(i,n){var s,o,l,u,c,d=angular.element(n[0].querySelector(".ma-text-box-value")),r=i.validators?angular.copy(i.validators):[],v=i.isRequired,m=!1,f=Number(i.changeTimeout),b=function(){i.isValid=!0;var e=d.val();if(r&&r.length)for(var a=0;a<r.length;a++)if(!r[a].validate(e)){i.isValid=!1;break}},p=function(a){if(l!==a){var t=l;i.value=a,l=a,e(function(){i.change({maValue:a,maOldValue:t})})}},h=function(){var e=d.val();return(!a.isNullOrUndefined(l)||""!==e)&&l!==e},x=function(){i.isTouched=!0,h()&&(b(),i.isValid&&p(d.val()))};i.isFocused=!1,i.isTouched=!1;for(var g=0;g<r.length;g++)if("IsNotEmpty"===r[g].name){m=!0;break}!m&&v&&r.unshift(t.isNotEmpty()),m&&(v=!0),i.isResetEnabled=function(){return!i.isDisabled&&""!==d.val()},i.onReset=function(){i.isDisabled||(l=d.val(),i.isTouched=!0,p(null),b(),d.focus())},i.onFocus=function(){i.isFocused=!0,c=i.value,i.focus({maValue:i.value})},i.onBlur=function(){u&&e.cancel(u),i.isFocused=!1,x(),i.blur({maValue:i.value,maOldValue:c,maHasValueChanged:c!==i.value})},i.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(s=angular.element(e.target).val())},d.on("input",function(t){if(t.keyCode!==a.keyCode.tab&&t.keyCode!==a.keyCode.shift){var i=!1;o=angular.element(t.target).val(),s!==o&&(i=!0),i&&(u&&e.cancel(u),u=e(function(){x()},f))}}),e(function(){n.removeAttr("id"),d.attr("id",i.id)}),i.$watch("value",function(e,a){if(e!==a){var t=d.prop("selectionStart");l=e,d.val(e),b(),i.isFocused&&d.prop({selectionStart:t,selectionEnd:t})}}),d.val(i.value),b(),l=i.value,i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){i.isTouched=!0,b()},i.instance.isValid=function(){return i.isValid})}}}])}();