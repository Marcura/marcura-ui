...
!function(){angular.module("marcuraUI.components").directive("maLabel",[function(){return{restrict:"E",transclude:!0,scope:{isCut:"=","for":"@",isRequired:"=",hasWarning:"="},replace:!0,template:function(){var a='                <div class="ma-label" ng-class="{                    \'ma-label-is-required\': isRequired,                    \'ma-label-has-content\': hasContent,                    \'ma-label-has-warning\': hasWarning,                    \'ma-label-is-cut\': isCut                }">                    <label class="ma-label-text" for="{{for}}"><ng-transclude></ng-transclude></label><!--                    --><div class="ma-label-star" ng-if="isRequired">&nbsp;<i class="fa fa-star"></i></div><!--                    --><div class="ma-label-warning" ng-if="hasWarning">&nbsp;                    <i class="fa fa-exclamation-triangle"></i></div>                </div>';return a},link:function(a,n){a.hasContent=n.find("span").contents().length>0}}}])}();
