...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,s){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var s=!i.isNullOrWhiteSpace(t.ajax),o="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return o+=s?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="value"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="value"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',o+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,s){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.selectedItem&&e.selectedItem[e.itemValueField]){var o=angular.copy(e.selectedItem);o.text=o[e.itemTextField],o.id=o[e.itemValueField],e.previousSelectedItem=o,s(o)}else s();t.runs++})}],link:function(o,l){var n,d,c,a,u,r=angular.element(l[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=o.showAddItemTooltip!==!1,x=o.validators?angular.copy(o.validators):[],I=o.isRequired,h=!1;o.previousSelectedItem=o.previousSelectedItem||null,o.isAddMode=!1,o.formatItem=o.itemTemplate||function(e){return e?o.itemTextField?e[o.itemTextField]:e.toString():""},o.isTextFocused=!1,o.isValid=!0,o.isTouched=!1,o.isAjax=angular.isObject(o.ajax);var b=function(e){if(!angular.isArray(o.items))return!1;for(var t=o.itemValueField&&e[o.itemValueField],i=0;i<o.items.length;i++)if(t){if(o.items[i][o.itemValueField]===e[o.itemValueField])return!0}else if(o.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!o.itemTextField)return e;if(angular.isArray(o.items))for(var t=0;t<o.items.length;t++)if(o.items[t][o.itemValueField].toString()===e.toString())return o.items[t];return null},F=function(e){if(!o.itemTextField)return e;if(e){var t={};return t[o.itemTextField]=e,t}return null},A=function(e){o.canAddItem&&e&&(o.isAddMode=!b(e)),S(e),o.isAddMode?(e?o.itemTextField&&e[o.itemTextField]?o.text=e[o.itemTextField].toString():o.text=e:o.text=null,m=e,o.toggleMode("add")):(e?o.isAjax||(o.itemValueField&&e[o.itemValueField]?o.value=e[o.itemValueField].toString():"string"==typeof e&&(o.value=e)):o.value=null,o.previousSelectedItem=e,o.toggleMode("select"))},T=function(e,i){var s=angular.element(e.relatedTarget),l=angular.element(a.dropdown[0].querySelector(".select2-input"));o.isTextFocused=!1,"text"===i?(g=!1,o.$apply(function(){if(o.isTouched=!0,o.itemTextField){if(o.selectedItem&&o.selectedItem[o.itemTextField]===o.text)return;o.selectedItem=F(o.text)}else{if(o.selectedItem===o.text)return;o.selectedItem=o.text}m=o.selectedItem,o.isValid&&t(function(){o.change({item:o.selectedItem})})})):"select"===i&&o.$apply(function(){o.isTouched=!0}),f=o.canAddItem?!g&&s[0]!==n[0]&&s[0]!==d[0]&&s[0]!==r[0]&&s[0]!==a.focusser[0]&&s[0]!==l[0]:!g&&s[0]!==d[0]&&s[0]!==r[0]&&s[0]!==a.focusser[0]&&s[0]!==l[0],f&&o.blur({item:o.selectedItem}),g=!1},S=function(e){if(o.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].method(e)){o.isValid=!1;break}},M=function(){o.isAddMode?(r.focus(),o.isTextFocused=!0):c.select2("focus")};o.isResetEnabled=function(){return!o.isDisabled&&(o.isAddMode?!i.isNullOrWhiteSpace(o.text):!i.isNullOrUndefined(o.selectedItem))},o.onReset=function(){o.selectedItem=null,M(),t(function(){o.change({item:o.selectedItem})})},o.onFocus=function(e){"text"===e&&(o.isTextFocused=!0),f&&o.focus({item:o.selectedItem}),f=!1},r.focusout(function(e){T(e,"text")}),o.getAddItemTooltip=function(){return p?o.isAddMode?"Back to the list":o.addItemTooltip?o.addItemTooltip:"Add new item":""},o.getItemValue=function(e){return o.itemValueField?e[o.itemValueField].toString():e},o.toggleMode=function(e){if(o.canAddItem&&!(o.isAddMode&&"add"===e||!o.isAddMode&&"select"===e)){var i=!1;"select"===e?(o.isAddMode=!1,i=!0):"add"===e?(o.isAddMode=!0,i=!0):o.isAddMode=!o.isAddMode,o.isAddMode?(c&&c.select2("close"),o.previousSelectedItem=v(o.value),o.selectedItem=m,o.selectedItem&&(o.text="string"==typeof o.selectedItem?o.selectedItem:o.selectedItem[o.itemTextField])):(m=F(o.text),o.selectedItem=o.previousSelectedItem),i||t(function(){o.change({item:o.selectedItem}),M()})}},o.onChange=function(){var e=i.isJson(o.value)?JSON.parse(o.value):o.value;if(o.isAjax){if(e===o.previousSelectedItem)return;if(!angular.isObject(e))return}if(!o.isAjax&&o.itemValueField&&e)for(var s=0;s<o.items.length;s++)if(o.items[s][o.itemValueField].toString()===e.toString()){e=o.items[s];break}if(e||o.selectedItem){if(o.itemValueField){if(o.selectedItem&&o.selectedItem[o.itemValueField]&&o.selectedItem[o.itemValueField].toString()===e[o.itemValueField].toString())return}else if(e===o.selectedItem)return;o.selectedItem=e,o.previousSelectedItem=e,t(function(){o.change({item:e})})}},o.$watch("selectedItem",function(e,t){e!==t&&A(e)}),o.$watch("text",function(e,t){e!==t&&(o.isTouched=!0,S(e))}),o.instance&&(o.instance.switchToSelectMode=function(){o.isAddMode&&o.toggleMode("select")},o.instance.switchToAddMode=function(){o.isAddMode||o.toggleMode("add")},o.instance.isValid=function(){return o.isValid});for(var V=0;V<x.length;V++)if("IsNotEmpty"===x[V].name){h=!0;break}!h&&I&&x.unshift(s.isNotEmpty()),h&&(I=!0),t(function(){A(o.selectedItem),c=angular.element(l[0].querySelector(".select2-container")),a=c.data().select2,u=$('label[for="'+o.id+'"]'),n=angular.element(l[0].querySelector(".ma-button-switch")),d=angular.element(l[0].querySelector(".ma-button-reset")),u.length>0&&$(e).on("click",'label[for="'+o.id+'"]',function(){M()}),a.focusser.on("focus",function(){o.onFocus("select")}),a.focusser.on("focusout",function(e){T(e,"select")}),a.dropdown.on("focus",".select2-input",function(){g=!0,o.onFocus()}),a.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),n.focusout(function(e){T(e)}),d.focusout(function(e){T(e)}),a.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
