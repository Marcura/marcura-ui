...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",itemTextField:"@",itemValueField:"@",placeholder:"@",textPlaceholder:"@",type:"@",noItemsFoundText:"@",isLoading:"@",isDisabled:"@",canAddItem:"@",isRequired:"@",canReset:"@",isMultiple:"@",change:"&",blur:"&",focus:"&",init:"&",validate:"&",items:"=",value:"=",itemTemplate:"=",validators:"=",instance:"=",ajax:"="},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="true"===t.canAddItem,u="true"===t.canReset,o="ma-select-box";n&&(o+=" ma-select-box-can-add-item"),u&&(o+=" ma-select-box-can-reset");var s='                    <div class="'+o+"\"                        ng-class=\"{                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled === 'true',                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-is-reset-disabled': canReset === 'true' && isDisabled !== 'true' && !_hasValue,                            'ma-select-box-is-loading': isLoading === 'true',                            'ma-select-box-has-value': _hasValue,                            'ma-select-box-is-rendered': isRendering                        }\">                        <div class=\"ma-select-box-spinner\">                            <div class=\"ma-pace\">                                <div class=\"ma-pace-activity\"></div>                            </div>                        </div>                        <div class=\"ma-select-box-rendering\" ng-if=\"isRendering\"></div>";return s+=l?'<input class="ma-select-box-input" ma-select-box-wrapper="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled === \'true\'"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select-box-wrapper="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled === \'true\'"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items" value="{{item[_itemValueField]}}">                                {{item.text}}                            </option>                        </select>',n&&(s+='                        <input class="ma-select-box-text" type="text"                            ng-class="{ \'ng-hide\': !isAddMode }"                            ng-model="text"                            ng-disabled="isDisabled === \'true\'"                            ng-focus="onFocus(\'text\')"                            placeholder="{{textPlaceholder}}"/>                        <ma-button class="ma-button-toggle"                            size="xs" simple                            right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                            click="changeMode()"                            ng-focus="onFocus(\'toggle\')"                            is-disabled="{{isDisabled === \'true\'}}">                        </ma-button>'),u&&(s+='<ma-button class="ma-button-reset"                        size="xs" simple                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="{{isDisabled === \'true\' || !_hasValue}}">                    </ma-button>'),s+="</div>"},controller:["$scope",function(e){var t="true"===e.isMultiple;e._type=e.type?e.type:"object",e._itemValueField=e.itemValueField?e.itemValueField:"id",e.getItemValue=function(t,l){if(l="boolean"!=typeof l||l,i.isNullOrWhiteSpace(t))return null;if("object"!=typeof t)return t.toString();for(var a=e._itemValueField.split("."),n=t[a[0]],u=1;u<a.length;u++)n=n[a[u]];return i.isNullOrUndefined(n)?null:l?n.toString():n},e.convertItemValue=function(t){return i.isNullOrUndefined(t)?null:"object"===e._type?t:"string"===e._type?t[e._itemValueField]:"boolean"===e._type?"true"===t[e._itemValueField]:"number"===e._type?Number(t[e._itemValueField]):t},e.getItemText=function(t){return e.itemTemplate?e.itemTemplate(e.convertItemValue(t)):t?"object"!==e._type?t[e._itemValueField]:e.itemTextField?t[e.itemTextField]:t.toString():""},e.runInitSelection=!0,e.options={},e.options.canAddItem="true"===e.canAddItem,e.options.instance={},e.noItemsFoundText&&(e.options.formatNoMatches=function(){return e.noItemsFoundText}),e.ajax&&(e.options.ajax=e.ajax,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.getItemText(l),l[e._itemValueField]=e.getItemValue(l,"object"!==e._type),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1},t&&(e.options.formatSelection=function(t){return e.getItemText(t)}))}],link:function(l,a,n){var u,o,s,c,r,d,m=angular.element(a[0].querySelector(".ma-select-box-text")),f=null,g=!0,p=!1,v=!1,h=!1,x=l.validators?angular.copy(l.validators):[],b=null,V="true"===l.isMultiple;l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.hasAjax=angular.isObject(l.ajax),l._hasValue=!1,l._items=[],l.isRendering=!0;var I=function(e){if(!l.hasAjax&&angular.isArray(e)){l._items.splice(0,l._items.length);var t,a=[];if("object"===l._type)a=angular.copy(e);else for(t=0;t<e.length;t++)if(!i.isNullOrUndefined(e[t])){var n={};n[l._itemValueField]=e[t].toString(),a.push(n)}for(t=0;t<a.length;t++)a[t].text=l.getItemText(a[t]);Array.prototype.push.apply(l._items,a)}};I(l.items);var _={name:"IsNotEmpty",validate:function(e){return V&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&("object"!==l._type&&!i.isNullOrWhiteSpace(e)||!!(l.hasAjax||l.isAddMode||A(e)))}},y=function(){for(var e=null,t=0;t<x.length;t++)if("IsNotEmpty"===x[t].name){e=t,x[t]=_;break}null===e&&"true"===l.isRequired?x.unshift(_):null!==e&&"true"!==l.isRequired&&x.splice(e,1)},S=function(e){t(function(){l.validate({maValue:e})})},A=function(e){if(l.hasAjax)return e&&!i.isNullOrWhiteSpace(e[l.itemValueField]);for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===l.getItemValue(e))return!0;return!1},M=function(e){if(i.isNullOrWhiteSpace(e))return null;if("object"!==l._type)return e;for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},F=function(e){if(i.isNullOrWhiteSpace(e))return null;var t={};return"object"===l._type?t[l.itemTextField]=e:e&&(t[l._itemValueField]=e),t},j=function(e){if(V){var t,a=[];if(l.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(l.getItemValue(e[t]));l.selectedItem=a,N(e)}else"true"===l.canAddItem&&e&&(l.isAddMode=!A(e)),N(e),l.isAddMode?(i.isNullOrWhiteSpace(e)?l.text=null:"object"===l._type?l.text=e[l.itemTextField].toString():l.text=e,f=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.hasAjax||(l.selectedItem=l.getItemValue(e)),l.previousSelectedItem=e,l.toggleMode("select"));w()},T=function(e){if(i.isNullOrWhiteSpace(e))return null;var t=angular.copy(e);if("object"===l._type)if(V)for(var a=0;a<t.length;a++)delete t[a].text;else delete t.text;return t},O=function(e,a){var n=angular.element(e.relatedTarget||e.toElement),s=n[0]===o[0],r=!V&&c.focusser[0]===n[0],x=e.target===u[0],b=e.target===o[0];if(l.isTextFocused=!1,"text"===a?l.$apply(function(){l.isTouched=!0;var e;if(!i.isNullOrWhiteSpace(l.text)||!i.isNullOrWhiteSpace(l.value)){if("object"===l._type){if(l.value&&l.value[l.itemTextField]===l.text)return;e=l.convertItemValue(F(l.text))}else{if(l.value===l.text)return;e=l.text}N(e),l.isValid&&(e=T(e),d=T(l.value)||null,l.value=e,f=l.value,w(),l.isValid&&!s&&t(function(){l.change({maValue:l.value,maOldValue:d})}))}}):"select"===a&&i.safeApply(function(){l.isTouched=!0}),g=(!x&&!b||!r)&&(!v&&!h&&n[0]!==u[0]&&!s&&n[0]!==m[0]&&n[0]!==c.search[0]),V){var I=angular.element(e.target);I.hasClass("select2-input")&&I.hasClass("select2-default")?g=!0:p&&(g=!1)}g&&l.blur({maValue:l.value})},N=function(e,t){if(l.isValid=!0,b=null,t=void 0===t||t,x&&x.length)for(var i=0;i<x.length;i++)if(!x[i].validate(e)){l.isValid=!1,b=x[i];break}t!==!1&&S(e)},W=function(){l.isAddMode?m.focus():s.select2("focus")},w=function(){V?l._hasValue=!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?l._hasValue=!i.isNullOrWhiteSpace(l.text):l._hasValue=!i.isNullOrUndefined(l.value)&&"true"!==l.isLoading},R=function(e,t){if(!e&&!t)return!0;if(e&&!t||!e&&t||e.length!==t.length)return!1;for(var i=!0,a=0;a<e.length;a++)if("object"===l._type){if(e[a][l._itemValueField]!==t[a][l._itemValueField]){i=!1;break}}else if(e[a]!==t[a]){i=!1;break}return i},k=function(e){return 1!==arguments.length?c?c.searchText:"":void(c&&(c.searchText=e))};l.changeMode=function(){l.toggleMode(null,null,!0)},l.reset=function(){d=l.value,l.value=V?[]:null,w()},l.onReset=function(){l.isTouched=!0,l.reset(),W(),t(function(){l.change({maValue:l.value,maOldValue:d})})},l.onFocus=function(e,t){"text"===e&&(l.isTextFocused=!0),g&&l.focus({maValue:l.value}),g=!1},l.options.instance.focus=function(){l.onFocus()},l.options.instance.blur=function(e){O(e,"select")},m.focusout(function(e){O(e,"text")}),l.toggleMode=function(e,a,n){if("true"===l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var u,o,c=!0;d=i.isNullOrWhiteSpace(l.value)?null:l.value,"select"===e?(l.isAddMode=!1,c=!1):"add"===e?(l.isAddMode=!0,c=!1):l.isAddMode=!l.isAddMode,"boolean"==typeof a&&(c=a),l.isAddMode?(s&&s.select2("close"),l.hasAjax?l.previousSelectedItem=l.selectedItem:l.previousSelectedItem=M(l.selectedItem),u=k()?"object"===l._type?F(k()):k():T(f),i.isNullOrWhiteSpace(u)||(l.text="object"===l._type?u[l.itemTextField]:u),k("")):(f=l.convertItemValue(F(l.text)),u=T(l.previousSelectedItem)),N(u),o=!angular.equals(l.getItemValue(u),l.getItemValue(d)),l.isValid&&(l.value=u),n&&(l.isTouched=!0),w(),c&&t(function(){W(),l.isValid&&o&&l.change({maValue:l.value,maOldValue:d})})}},l.onChange=function(){var e;if(V){var a=l.selectedItem,n=[];if(l.hasAjax){if(n=c.data(),angular.equals(n,l.value))return;d=T(l.value)}else{d=T(l.value);for(var u=0;u<a.length;u++)e=M(a[u]),e&&n.push(e)}l.isTouched=!0,l.value=T(l.convertItemValue(n)),w(),t(function(){l.change({maValue:l.value,maOldValue:d})}),c.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"==typeof e&&"string"===l._type&&(e=l.selectedItem),l.hasAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.hasAjax&&l._itemValueField&&!i.isNullOrWhiteSpace(e))for(var o=0;o<l._items.length;o++)if(l.getItemValue(l._items[o])===e.toString()){e=l._items[o];break}if(i.isNullOrWhiteSpace(e)&&i.isNullOrWhiteSpace(l.value))return;if(l._itemValueField){var s=l.getItemValue(l.value);if(s&&s===l.getItemValue(e))return}else if(e===l.value)return;l.isTouched=!0,d=T(l.value),l.value=T(l.convertItemValue(e)),l.previousSelectedItem=e,w(),t(function(){l.change({maValue:l.value,maOldValue:d})})}};var q=function(){l.hasAjax&&c&&(c.opts.placeholder=l.value?"":l.placeholder,l.runInitSelection=!0,c.initSelection())};l.hasAjax||l.$watch("items",function(e){R(l._items,e)||(I(e),j(l.value),l.isAddMode||t(function(){if(c){var e,t;if(i.isNullOrWhiteSpace(l.value))c.data(null);else if(angular.isObject(l.value))if(V&&angular.isArray(l.value)){for(var a=[],n=0;n<l.value.length;n++)e=l.getItemValue(l.value[n]),t=angular.copy(M(e)||l.value[n]),t.text=l.getItemText(t),t[l._itemValueField]=e,t&&a.push(t);c.data(a)}else e=l.getItemValue(l.value),t=angular.copy(M(e)||l.value),t.text=l.getItemText(t),t[l._itemValueField]=e,c.data(t);else c.val(l.getItemValue(l.value))}}))},!0),l.$watch("value",function(e,t){e!==t&&(q(),j(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,w(),N("object"===l._type?F(e):e))}),n.$observe("isRequired",function(e,t){e!==t&&(y(),N(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.isEditor=function(){return!0},l.instance.mode=function(e){return 1!==arguments.length?l.isAddMode?"add":"select":void("select"===e&&l.isAddMode?l.toggleMode("select"):"add"!==e||l.isAddMode||l.toggleMode("add"))},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,N(l.isAddMode?l.text:l.selectedItem,!1)},l.instance.failedValidator=function(){return b},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),y(),t(function(){l.isRendering=!1,j(l.value),s=angular.element(a[0].querySelector(".select2-container")),c=s.data()?s.data().select2:null,r=$('label[for="'+l.id+'"]'),u=angular.element(a[0].querySelector(".ma-button-toggle")),o=angular.element(a[0].querySelector(".ma-button-reset")),q(),r.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){W()}),c&&(V?(c.selection.on("mouseenter",function(){p=!0}),c.selection.on("mouseleave",function(){p=!1}),c.dropdown.on("mouseenter",function(){p=!0}),c.dropdown.on("mouseleave",function(){p=!1}),c.dropdown.on("click",function(){c.search.focus()})):c.addItemButton.on("click",function(){l.$apply(function(){l.toggleMode("add",!0,!0)})})),u.focusout(function(e){O(e)}),o.focusout(function(e){O(e)}),u.mousedown(function(e){v=!0}),u.mouseup(function(e){v=!1}),o.mousedown(function(e){h=!0}),o.mouseup(function(e){h=!1}),l.init({maInstance:l.instance})})}}}])}();
