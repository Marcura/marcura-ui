...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,s){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"="},replace:!0,template:function(e,a){var s="password"===a.type?"password":"text",t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+s+'" id="{{id}}"                    type="text"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return t},link:function(t,i){var o,n,l,u,r,d=angular.element(i[0].querySelector(".ma-text-box-value")),c=angular.element(i[0].querySelector(".ma-button-reset")),g=angular.element(i[0].querySelector(".ma-button-toggle-password")),m=t.validators?angular.copy(t.validators):[],f=t.isRequired,b=!1,v=Number(t.changeTimeout),p=!0,w=t.trim!==!1,h=!1,x=function(e){e=(a.isNullOrUndefined(e)?"":e).toString(),w&&(e=e.trim()),l=e},y=function(){t.isValid=!0;var e=d.val();if(m&&m.length)for(var a=0;a<m.length;a++)if(!m[a].validate(e)){t.isValid=!1;break}},V=function(a){if(P(a)){h=!0;var s=w?l.trim():l;a=w?a.trim():a,t.value=a,x(a),e(function(){t.change({maValue:a,maOldValue:s})})}},P=function(e){e=a.isNullOrUndefined(e)?"":e;var s=a.isNullOrUndefined(l)?"":l;return w?s.trim()!==e.trim():s!==e},T=function(){return t.isTouched=!0,P(d.val())?(y(),void(t.isValid&&V(d.val()))):void y()};t.isValueFocused=!1,t.isTouched=!1,t.canTogglePassword=!1,t.isPasswordVisible=!1,"password"===t.type&&(t.canTogglePassword=t.hasShowPasswordButton!==!1);for(var k=0;k<m.length;k++)if("IsNotEmpty"===m[k].name){b=!0;break}!b&&f&&m.unshift(s.isNotEmpty()),b&&(f=!0),t.isResetEnabled=function(){return!t.isDisabled&&""!==d.val()},t.onReset=function(){t.isDisabled||(x(d.val()),t.isTouched=!0,d.val(""),V(""),y(),d.focus())},t.onFocus=function(e){"value"===e&&(t.isValueFocused=!0),p&&(r=t.value,t.focus({maValue:t.value})),p=!1},d.focusout(function(e){R(e)}),c.focusout(function(e){R(e)}),g.focusout(function(e){R(e)}),t.togglePassword=function(){t.isPasswordVisible=!t.isPasswordVisible,d[0].type=t.isPasswordVisible?"text":"password"},t.isTogglePasswordEnabled=function(){return!t.isDisabled&&""!==d.val()};var R=function(s){var i=angular.element(s.relatedTarget);p=t.canTogglePassword?i[0]!==d[0]&&i[0]!==g[0]&&i[0]!==c[0]:i[0]!==d[0]&&i[0]!==c[0],u&&e.cancel(u),a.safeApply(function(){t.isValueFocused=!1}),p&&(T(),t.blur({maValue:t.value,maOldValue:r,maHasValueChanged:r!==t.value}))};t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},d.on("input",function(s){if(s.keyCode!==a.keyCode.tab&&s.keyCode!==a.keyCode.shift){var t=!1;n=angular.element(s.target).val(),o!==n&&(t=!0),t&&(u&&e.cancel(u),u=e(function(){T()},v))}}),e(function(){i.removeAttr("id"),d.attr("id",t.id)}),t.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){var s=d.prop("selectionStart");x(e),d.val(e),y(),t.isValueFocused&&d.prop({selectionStart:s,selectionEnd:s})}}),d.val(t.value),y(),x(t.value),t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,y()},t.instance.isValid=function(){return t.isValid})}}}])}();