...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","maHelper","maValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",minDate:"=",maxDate:"="},replace:!0,template:function(e,a){var t='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            ng-disabled="isDisabled"                            ng-focus="onFocus()"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"                            ng-blur="onBlur()"/><input class="ma-date-box-hours"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minutes" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return t},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var d,s,l,u=null,r=i.configuration.displayFormat,c=i.configuration.format,m=i.configuration.timeZone,f=angular.element(o[0].querySelector(".ma-date-box-date")),v=angular.element(o[0].querySelector(".ma-date-box-hours")),y=angular.element(o[0].querySelector(".ma-date-box-minutes")),g=null,b=a.parseTimeZone(m),h=0,p=[],D=i.isRequired,x=new a(i.minDate),k=new a(i.maxDate),w=function(t){var n=null;g=t,t&&(n=moment(new Date),n.year(t.year()).month(t.month()).date(t.date()).hours(t.hours()).minutes(t.minutes()).seconds(0)),i.value=n?a.format(n,c,m):null,e(function(){i.change({maValue:i.value})})},T=function(e){return!(null===g&&null===e||g&&e&&0===g.diff(e))&&(i.isTouched=!0,!0)},C=function(e){var t=null;e&&e.date?(t=a.offsetUtc(e.date,b-e.offset),f.val(a.format(t,r)),v.val(a.format(t,"HH")),y.val(a.format(t,"mm")),d||(d=f.val())):(f.val(""),v.val("00"),y.val("00")),F(t)},F=function(e){u&&u.setDate(e?e.toDate():null,!0)},V=function(){if(u){k=new a(i.maxDate);var e=k.date;e||(e=new Date,e=new Date(e.setFullYear(e.getFullYear()+100))),u.setMaxDate(e)}},E=function(){if(u){x=new a(i.minDate);var e=x.date;e||(e=new Date,e=new Date(e.setFullYear(e.getFullYear()-100))),u.setMinDate(e)}},K=function(e){var t=new a;return e?(t=i.parser?i.parser(e):a.parse(e,i.culture),t.isEmpty()||(t.date=moment(t.date)),t):t},R=function(e){var a=moment(e);return moment([a.year(),a.month(),a.date(),Number(v.val()),Number(y.val()),0])},M=function(){h=b},q=function(){u=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",onSelect:function(){var t=new a(u.getDate());return t.date=a.offsetUtc(t.date),i.hasTime&&(t.date=R(t.date),M()),e(function(){N(t.date)}),T(t.date)?void w(t.date):void C(t)}}),F(g),V(),E()},Z=function(){u&&u.destroy()},B=null,N=function(e){i.isValid=!0,B=null;var t=e?a.format(e,c):null;if(p&&p.length)for(var n=0;n<p.length;n++)if(!p[n].validate(t)){i.isValid=!1,B=p[n];break}},Y=function(){var e=!1;p=i.validators?angular.copy(i.validators):[];for(var a=0;a<p.length;a++)if("IsNotEmpty"===p[a].name){e=!0;break}!e&&D&&p.unshift(n.isNotEmpty()),e&&(D=!0),x.isEmpty()||p.push(n.isGreaterThanOrEqual(x)),k.isEmpty()||p.push(n.isLessThanOrEqual(k,!0))};if(Y(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.isResetEnabled=function(){return!i.isDisabled&&(f.val()||"00"!==v.val()||"00"!==y.val())},i.onFocus=function(){i.isFocused=!0},i.onBlur=function(){i.isFocused=!1,i.isTouched=!0;var e=f.val().trim(),t=""===e,n=Number(v.val()),o=Number(y.val()),s=new a;return n>=0&&n<=23&&o>=0&&o<=59?(s=K(e),s.offset=h,t?(N(s.date),void(i.isValid&&(C(),w()))):s.date?(s.date&&(i.hasTime||d===e)&&(s.date=R(s.date),s.date=a.offsetUtc(s.date,-(b-h))),N(s.date),T(s.date)?(s.date&&C(s),void(i.isValid&&w(s.date))):void C(s)):void(i.isValid=!1)):void(i.isValid=!1)},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(s=angular.element(e.target).val())},i.onKeyup=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(l=angular.element(e.target).val(),s!==l&&(i.isTouched=!0,M()))},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(g=null,i.isTouched=!0,N(null),w(),C(),f.focus())},i.value){var H=a.parse(i.value,i.culture);if(H.date=a.offsetUtc(H.date),H.isEmpty())return;C(H),g=H.date,h=H.offset}e(function(){i.isDisabled||q(),o.removeAttr("id"),f.attr("id",i.id)}),i.$watch("value",function(e,a){if(null!==e||null!==a){var t=K(e);if(null===t.date&&(g=null,C(null)),!T(t.date))return void C(t);C(t),g=t.date,h=t.offset}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?Z():q())});var S=function(e,a,t){if(e!==a){var n=K(f.val().trim());"maxDate"===t?V():E(),Y(),N(n.date),i.isValid&&w(n.date)}};i.$watch("maxDate",function(e,a){S(e,a,"maxDate")}),i.$watch("minDate",function(e,a){S(e,a,"minDate")}),i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){return i.isTouched=!0,D&&!i.value?void(i.isValid=!1):void N(K(i.value).date)},i.instance.isValid=function(){return i.isValid},i.instance.failedValidator=function(){return B})}}}])}();
