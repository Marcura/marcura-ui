...
!function(){angular.module("marcuraUI.components").directive("maCheckBox",["MaHelper","$timeout","$parse","MaValidators",function(e,i,a,n){return{restrict:"E",scope:{text:"@",value:"=",isDisabled:"=",change:"&",size:"@",rtl:"=",isRequired:"=",validators:"=",instance:"="},replace:!0,template:function(){var e='            <div class="ma-check-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-check-box-is-checked\': value === true,                    \'ma-check-box-is-disabled\': isDisabled,                    \'ma-check-box-rtl\': rtl,                    \'ma-check-box-is-focused\': isFocused,                    \'ma-check-box-is-invalid\': !isValid,                    \'ma-check-box-is-touched\': isTouched                }">                <span class="ma-check-box-text">{{text || \'&nbsp;\'}}</span>                <div class="ma-check-box-inner"></div>                <i class="ma-check-box-icon fa fa-check" ng-show="value === true"></i>            </div>';return e},link:function(s,t,c){var o=s.validators?angular.copy(s.validators):[],l=s.isRequired,u=!1,r=!1,d=function(){s.isDisabled?t.removeAttr("tabindex"):t.attr("tabindex","0")};s._size=s.size?s.size:"xs",s.isFocused=!1,s.isValid=!0,s.isTouched=!1;var v=function(){r=!!s.text},f=function(){var e=" ma-check-box-"+s._size;r&&(e+=" ma-check-box-has-text"),s.cssClass=e},h=function(){var e=null,i=null,a=s.$parent,n=c.value;for(n.indexOf(".")!==-1&&(e=n.split("."),n=e[0]);a&&!i;)a.hasOwnProperty(n)?i=a:a=a.$parent;return i||s.$parent},b=h(),m=function(){s.isValid=!0,s.isTouched=!0;var e=s.value===!1?null:s.value;if(o&&o.length)for(var i=0;i<o.length;i++){var a=o[i];if(!a.validate("IsNotEmpty"===a.name?e:s.value)){s.isValid=!1;break}}};s.onChange=function(){if(!s.isDisabled){var e=a(c.value),n=e.assign,t=!e(b);s.value=t,n(b,t),m(),i(function(){s.change({maValue:s.value})})}},s.onFocus=function(){s.isDisabled||(s.isFocused=!0)},s.onBlur=function(){s.isDisabled||(s.isFocused=!1,m())},s.onKeypress=function(i){i.keyCode===e.keyCode.space&&(i.preventDefault(),s.isDisabled||s.onChange())},s.$watch("isDisabled",function(e,i){e!==i&&(e&&(s.isFocused=!1),d())}),s.$watch("text",function(e,i){e!==i&&(v(),f())});for(var p=0;p<o.length;p++)if("IsNotEmpty"===o[p].name){u=!0;break}!u&&l&&o.unshift(n.isNotEmpty()),u&&(l=!0),s.instance&&(s.instance.isInitialized=!0,s.instance.isEditor=function(){return!0},s.instance.isValid=function(){return s.isValid},s.instance.validate=function(){m()}),d(),v(),f()}}}])}();
