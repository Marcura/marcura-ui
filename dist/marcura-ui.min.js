...
!function(){angular.module("marcuraUI.components").directive("maCheckBox",["MaHelper","$timeout","$parse","MaValidators",function(e,a,i,s){return{restrict:"E",scope:{text:"@",value:"=",isDisabled:"=",change:"&",size:"@",rtl:"=",isRequired:"=",validators:"=",instance:"="},replace:!0,template:function(){var e='            <div class="ma-check-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-check-box-is-checked\': value === true,                    \'ma-check-box-is-disabled\': isDisabled,                    \'ma-check-box-has-text\': hasText,                    \'ma-check-box-rtl\': rtl,                    \'ma-check-box-is-focused\': isFocused,                    \'ma-check-box-is-invalid\': !isValid,                    \'ma-check-box-is-touched\': isTouched                }">                <span class="ma-check-box-text">{{text || \'&nbsp;\'}}</span>                <div class="ma-check-box-inner"></div>                <i class="ma-check-box-icon fa fa-check" ng-show="value === true"></i>            </div>';return e},link:function(n,t,c){var o=n.validators?angular.copy(n.validators):[],l=n.isRequired,u=!1,r=function(){n.isDisabled?t.removeAttr("tabindex"):t.attr("tabindex","0")},d=function(){n.hasText=!!n.text};n._size=n.size?n.size:"xs",n.cssClass=" ma-check-box-"+n._size,n.isFocused=!1,n.isValid=!0,n.isTouched=!1;var h=function(){var e=null,a=null,i=n.$parent,s=c.value;for(s.indexOf(".")!==-1&&(e=s.split("."),s=e[0]);i&&!a;)i.hasOwnProperty(s)?a=i:i=i.$parent;return a||n.$parent},f=h(),v=function(){n.isValid=!0,n.isTouched=!0;var e=n.value===!1?null:n.value;if(o&&o.length)for(var a=0;a<o.length;a++){var i=o[a];if(!i.validate("IsNotEmpty"===i.name?e:n.value)){n.isValid=!1;break}}};n.onChange=function(){if(!n.isDisabled){var e=i(c.value),s=e.assign,t=!e(f);n.value=t,s(f,t),v(),a(function(){n.change({maValue:n.value})})}},n.onFocus=function(){n.isDisabled||(n.isFocused=!0)},n.onBlur=function(){n.isDisabled||(n.isFocused=!1,v())},n.onKeypress=function(a){a.keyCode===e.keyCode.space&&(a.preventDefault(),n.isDisabled||n.onChange())},n.$watch("isDisabled",function(e,a){e!==a&&(e&&(n.isFocused=!1),r())}),n.$watch("text",function(e,a){e!==n.text&&d()});for(var b=0;b<o.length;b++)if("IsNotEmpty"===o[b].name){u=!0;break}!u&&l&&o.unshift(s.isNotEmpty()),u&&(l=!0),n.instance&&(n.instance.isInitialized=!0,n.instance.isEditor=function(){return!0},n.instance.isValid=function(){return n.isValid},n.instance.validate=function(){v()}),r(),a(function(){d()})}}}])}();
