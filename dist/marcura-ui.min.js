...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",isMultiple:"=",type:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !_hasValue,                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': _hasValue                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input class="ma-select-box-input" ma-select2="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select2="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items" value="{{item[_itemValueField]}}">                                {{item.text}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-show="canAddItem" size="xs" modifier="simple"                        ma-tooltip="{{_addItemTooltip}}"                        ma-tooltip-is-disabled="!canAddItem"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="isDisabled || !_hasValue">                    </ma-button>                </div>'},controller:["$scope",function(e){e._type=e.type?e.type:"object",e._itemValueField=e.itemValueField?e.itemValueField:"id",e.getItemValue=function(t){if(i.isNullOrWhiteSpace(t))return null;if("object"!=typeof t)return t.toString();for(var l=e._itemValueField.split("."),a=t[l[0]],n=1;n<l.length;n++)a=a[l[n]];return i.isNullOrUndefined(a)?null:a.toString()},e.convertItemValue=function(t){return i.isNullOrUndefined(t)?null:"object"===e._type?t:"string"===e._type?t[e._itemValueField]:"boolean"===e._type?"true"===t[e._itemValueField]:"number"===e._type?Number(t[e._itemValueField]):t},e.getItemText=function(t){return e.itemTemplate?e.itemTemplate(e.convertItemValue(t)):t?"object"!==e._type?t[e._itemValueField]:e.itemTextField?t[e.itemTextField]:t.toString():""},e.options={},e.runInitSelection=!0,e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.getItemText(l),l[e._itemValueField]=e.getItemValue(l),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1},e.isMultiple&&(e.options.formatSelection=function(t){return e.getItemText(t)}))}],link:function(l,a,n){var s,o,u,c,d,r,m=angular.element(a[0].querySelector(".ma-select-box-text")),f=null,p=!0,g=!1,v=!1,h=l.showAddItemTooltip!==!1,x=l.validators?angular.copy(l.validators):[];l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.hasAjax=angular.isObject(l.ajax),l._hasValue=!1,l._items=[];var b=function(e){if(!l.hasAjax&&angular.isArray(e)){l._items.splice(0,l._items.length);var t,a=[];if("object"===l._type)a=angular.copy(e);else for(t=0;t<e.length;t++)if(!i.isNullOrUndefined(e[t])){var n={};n[l._itemValueField]=e[t].toString(),a.push(n)}for(t=0;t<a.length;t++)a[t].text=l.getItemText(a[t]);Array.prototype.push.apply(l._items,a)}};b(l.items);var I={name:"IsNotEmpty",validate:function(e){return l.isMultiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&("object"!==l._type&&!i.isNullOrWhiteSpace(e)||!!(l.hasAjax||l.isAddMode||_(e)))}},V=function(){for(var e=null,t=0;t<x.length;t++)if("IsNotEmpty"===x[t].name){e=t,x[t]=I;break}null===e&&l.isRequired?x.unshift(I):null===e||l.isRequired||x.splice(e,1)},_=function(e){for(var t=(null!==l.getItemValue(e),0);t<l._items.length;t++)if(l.getItemValue(l._items[t])===l.getItemValue(e))return!0;return!1},A=function(e){if(i.isNullOrWhiteSpace(e))return null;if("object"!==l._type)return e;for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},M=function(e){if(i.isNullOrUndefined(e))return null;var t={};return"object"===l._type?t[l.itemTextField]=e:e&&(t[l._itemValueField]=e),t},T=function(e){if(l.isMultiple){var t,a=[];if(l.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(l.getItemValue(e[t]));l.selectedItem=a,F(e)}else l.canAddItem&&e&&(l.isAddMode=!_(e),w()),F(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,f=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.hasAjax||(null!==l.getItemValue(e)?l.selectedItem=l.getItemValue(e):"object"!==l._type&&(l.selectedItem=e.toString())),l.previousSelectedItem=e,l.toggleMode("select")),w();O()},y=function(e){if(i.isNullOrWhiteSpace(e))return null;var t=angular.copy(e);if("object"===l._type)if(l.isMultiple)for(var a=0;a<t.length;a++)delete t[a].text;else delete t.text;return t},S=function(e,i){var n=angular.element(e.relatedTarget);l.isTextFocused=!1,"text"===i?(g=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=l.convertItemValue(M(l.text))}else{if(l.value===l.text)return;e=l.text}F(e),l.isValid&&(e=y(e),r=y(l.value)||null,l.value=e,f=l.value,O(),l.isValid&&t(function(){l.change({maValue:l.value,maOldValue:r})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),p=!g&&n[0]!==s[0]&&n[0]!==o[0]&&n[0]!==m[0]&&n[0]!==c.search[0],l.isMultiple?v&&(p=!1):g||n[0]!==c.focusser[0]||(p=!1),p&&(a.removeClass("ma-select-box-is-select-focused"),l.blur({maValue:l.value})),g=!1},F=function(e){if(l.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].validate(e)){l.isValid=!1;break}},j=function(){l.isAddMode?(m.focus(),l.isTextFocused=!0):u.select2("focus")},O=function(){l.isMultiple?l._hasValue=!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?l._hasValue=!i.isNullOrWhiteSpace(l.text):l._hasValue=!i.isNullOrUndefined(l.value)&&!l.isLoading},w=function(){h&&l.canAddItem?l.isAddMode?l._addItemTooltip="Back to the list":l._addItemTooltip=l.addItemTooltip?l.addItemTooltip:"Add new item":l._addItemTooltip=""},N=function(e,t){if(!e&&!t)return!0;if(e&&!t||!e&&t||e.length!==t.length)return!1;for(var i=!0,a=0;a<e.length;a++)if("object"===l._type){if(e[a][l._itemValueField]!==t[a][l._itemValueField]){i=!1;break}}else if(e[a]!==t[a]){i=!1;break}return i};l.reset=function(){r=l.value,l.value=l.isMultiple?[]:null,O()},l.onReset=function(){l.isTouched=!0,l.reset(),j(),t(function(){l.change({maValue:l.value,maOldValue:r})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),"reset"===e&&a.removeClass("ma-select-box-is-select-focused"),p&&l.focus({maValue:l.value}),p=!1},m.focusout(function(e){S(e,"text")}),l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;r=l.value||null,"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,w(),l.isAddMode?(u&&u.select2("close"),l.previousSelectedItem=A(l.selectedItem),l.value=y(f),l.value&&(l.text="string"===l._type?l.value:l.value[l.itemTextField])):(f=l.convertItemValue(M(l.text)),l.value=y(l.previousSelectedItem)),O(),i||t(function(){l.change({maValue:l.value,maOldValue:r}),j()})}},l.onChange=function(){var e;if(l.isMultiple){var a=l.selectedItem,n=[];if(l.hasAjax){if(n=c.data(),angular.equals(n,l.value))return;r=y(l.value)}else{r=y(l.value);for(var s=0;s<a.length;s++)e=A(a[s]),e&&n.push(e)}l.isTouched=!0,l.value=y(l.convertItemValue(n)),O(),t(function(){l.change({maValue:l.value,maOldValue:r})}),c.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"===l._type&&(e=l.selectedItem),l.hasAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.hasAjax&&l._itemValueField&&!i.isNullOrWhiteSpace(e))for(var o=0;o<l._items.length;o++)if(l.getItemValue(l._items[o])===e.toString()){e=l._items[o];break}if(i.isNullOrWhiteSpace(e)&&!l.value)return;if(l._itemValueField){var u=l.getItemValue(l.value);if(u&&u===l.getItemValue(e))return}else if(e===l.value)return;r=y(l.value),l.value=y(l.convertItemValue(e)),l.previousSelectedItem=e,O(),t(function(){l.change({maValue:l.value,maOldValue:r})})}};var k=function(){l.hasAjax&&c&&(c.opts.placeholder=l.value?"":l.placeholder,l.runInitSelection=!0,c.initSelection())};l.hasAjax||l.$watch("items",function(e){N(l._items,e)||(b(e),T(l.value),t(function(){var e,t;if(angular.isObject(l.value))if(l.isMultiple&&angular.isArray(l.value)){for(var i=[],a=0;a<l.value.length;a++)e=l.getItemValue(l.value[a]),t=angular.copy(A(e)||l.value[a]),t.text=l.getItemText(t),t[l._itemValueField]=e,t&&i.push(t);c.data(i)}else e=l.getItemValue(l.value),t=angular.copy(A(e)||l.value),t.text=l.getItemText(t),t[l._itemValueField]=e,c.data(t);else l.value?c.val(l.value):c.data(null)}))},!0),l.$watch("value",function(e,t){e!==t&&(k(),T(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,O(),F(e))}),l.$watch("isRequired",function(e,t){e!==t&&(V(),F(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.isEditor=function(){return!0},l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,F(l.isAddMode?l.text:l.value)},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),V(),t(function(){if(l.hasAjax){var t=angular.element(a[0].querySelector(l.isMultiple?".select2-search-field":".select2-search"));t.append('<div class="pace"><div class="pace-activity"></div></div>'),l.isMultiple||t.append('<i class="ma-select-box-input-search-icon fa fa-search"></i>')}T(l.value),u=angular.element(a[0].querySelector(".select2-container")),c=u.data().select2,d=$('label[for="'+l.id+'"]'),s=angular.element(a[0].querySelector(".ma-button-switch")),o=angular.element(a[0].querySelector(".ma-button-reset")),k(),d.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){j()}),l.isMultiple?(c.search.on("focus",function(){a.addClass("ma-select-box-is-select-focused"),l.onFocus()}),c.search.on("focusout",function(e){S(e,"select")}),c.selection.on("mouseenter",function(){v=!0}),c.selection.on("mouseleave",function(){v=!1}),c.dropdown.on("mouseenter",function(){v=!0}),c.dropdown.on("mouseleave",function(){v=!1}),c.dropdown.on("click",function(){c.search.focus()})):(c.focusser.on("focus",function(){l.onFocus("select")}),c.focusser.on("focusout",function(e){S(e,"select")})),c.dropdown.on("focus",".select2-input",function(){g=!0,l.onFocus()}),c.dropdown.on("focusout",".select2-input",function(e){S(e,"select")}),s.focusout(function(e){S(e)}),o.focusout(function(e){S(e)}),c.dropdown.on("mouseenter",".select2-result",function(){g=!0}),c.dropdown.on("mouseleave",".select2-result",function(){g=!1}),$(e).on("mouseenter",".select2-drop-mask",function(){l.isMultiple||(g=!0)}),l.init({maInstance:l.instance})})}}}])}();
