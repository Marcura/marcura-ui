...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,s){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"="},replace:!0,template:function(e,a){var s="password"===a.type?"password":"text",o="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+s+'" id="{{id}}"                    type="text"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return o},link:function(o,t){var i,n,l,u,d,r=angular.element(t[0].querySelector(".ma-text-box-value")),c=angular.element(t[0].querySelector(".ma-button-reset")),g=angular.element(t[0].querySelector(".ma-button-toggle-password")),f=o.validators?angular.copy(o.validators):[],m=o.isRequired,b=!1,v=Number(o.changeTimeout),p=!0,w=o.trim!==!1,h=!1,x=function(e){e=(a.isNullOrUndefined(e)?"":e).toString(),w&&(e=e.trim()),l=e},y=function(){o.isValid=!0;var e=r.val();if(f&&f.length)for(var a=0;a<f.length;a++)if(console.log(f[a].name),console.log(f[a].validate(e)),console.log("---"),!f[a].validate(e)){o.isValid=!1;break}},V=function(a){if(P(a)){h=!0;var s=w?l.trim():l;a=w?a.trim():a,o.value=a,x(a),e(function(){o.change({maValue:a,maOldValue:s})})}},P=function(e){e=a.isNullOrUndefined(e)?"":e;var s=a.isNullOrUndefined(l)?"":l;return w?s.trim()!==e.trim():s!==e},T=function(){return o.isTouched=!0,P(r.val())?(y(),void(o.isValid&&V(r.val()))):void y()};o.isValueFocused=!1,o.isTouched=!1,o.canTogglePassword=!1,o.isPasswordVisible=!1,"password"===o.type&&(o.canTogglePassword=o.hasShowPasswordButton!==!1);for(var k=0;k<f.length;k++)if("IsNotEmpty"===f[k].name){b=!0;break}!b&&m&&f.unshift(s.isNotEmpty()),b&&(m=!0),o.isResetEnabled=function(){return!o.isDisabled&&""!==r.val()},o.onReset=function(){o.isDisabled||(x(r.val()),o.isTouched=!0,r.val(""),V(""),y(),r.focus())},o.onFocus=function(e){"value"===e&&(o.isValueFocused=!0),p&&(d=o.value,o.focus({maValue:o.value})),p=!1},r.focusout(function(e){R(e)}),c.focusout(function(e){R(e)}),g.focusout(function(e){R(e)}),o.togglePassword=function(){o.isPasswordVisible=!o.isPasswordVisible,r[0].type=o.isPasswordVisible?"text":"password"},o.isTogglePasswordEnabled=function(){return!o.isDisabled&&""!==r.val()};var R=function(s){var t=angular.element(s.relatedTarget);p=o.canTogglePassword?t[0]!==r[0]&&t[0]!==g[0]&&t[0]!==c[0]:t[0]!==r[0]&&t[0]!==c[0],u&&e.cancel(u),a.safeApply(function(){o.isValueFocused=!1}),p&&(T(),a.safeApply(function(){o.blur({maValue:o.value,maOldValue:d,maHasValueChanged:d!==o.value})}))};o.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(i=angular.element(e.target).val())},r.on("input",function(s){if(s.keyCode!==a.keyCode.tab&&s.keyCode!==a.keyCode.shift){var o=!1;n=angular.element(s.target).val(),i!==n&&(o=!0),o&&(u&&e.cancel(u),u=e(function(){T()},v))}}),e(function(){t.removeAttr("id"),r.attr("id",o.id)}),o.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){var s=r.prop("selectionStart");x(e),r.val(e),y(),o.isValueFocused&&r.prop({selectionStart:s,selectionEnd:s})}}),r.val(o.value),y(),x(o.value),o.instance&&(o.instance.isInitialized=!0,o.instance.validate=function(){o.isTouched=!0,y()},o.instance.isValid=function(){return o.isValid},o.instance.focus=function(){o.isValueFocused||r.focus()})}}}])}();