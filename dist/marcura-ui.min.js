...
!function(){angular.module("marcuraUI.components").provider("maTextBoxConfiguration",function(){this.$get=function(){return this}}).directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"=",max:"=",min:"=",decimals:"="},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text";"number"===i&&(i="text");var t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return t},controller:["$scope","maTextBoxConfiguration",function(e,a){e.configuration={},e.decimals>=0?e.configuration.decimals=e.decimals:a.decimals>=0?e.configuration.decimals=a.decimals:e.configuration.decimals=2}],link:function(t,n){var s,o,l,u,r,c=angular.element(n[0].querySelector(".ma-text-box-value")),d=angular.element(n[0].querySelector(".ma-button-reset")),f=angular.element(n[0].querySelector(".ma-button-toggle-password")),m=[],g=t.isRequired,b=Number(t.changeTimeout),p=!0,v=t.trim!==!1,h=!1,x=null,y=t.configuration.decimals,w=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==t.type&&v&&(e=e.trim()),l=e},V=function(){var e=c.val();return"number"===t.type?k(e):e},T=function(){t.isValid=!0,x=null;var e=c.val();if("number"===t.type&&(e=N(e)),m&&m.length)for(var a=0;a<m.length;a++)if(!m[a].validate(e)){t.isValid=!1,x=m[a];break}},P=function(a){if(O(a)){h=!0;var i=l;"number"!==t.type&&v&&(i=i.trim(),a=a.trim()),t.value=a,w(a),e(function(){t.change({maValue:a,maOldValue:i})})}},O=function(e){e=a.isNullOrUndefined(e)?"":e;var i=a.isNullOrUndefined(l)?"":l,n=!1;return n="number"!==t.type&&v?i.trim()!==e.trim():i!==e},E=function(){return t.isTouched=!0,O(V())?(T(),void(t.isValid&&P(V()))):void T()},k=function(e){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(N(e)),e=parseFloat(e.toFixed(y)))},F=function(e){if(a.isNullOrWhiteSpace(e))return"";var i=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),t=e.replace(/(\.\d+)$/,""),n=t.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+n+i},N=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(",","")},q=function(e){if(a.isNullOrWhiteSpace(e))return e;var i=e;return"number"===t.type&&(i=F(e.toFixed(y))),i},C=function(){var e=!1;m=t.validators?angular.copy(t.validators):[];for(var a=0;a<m.length;a++)if("IsNotEmpty"===m[a].name){e=!0;break}!e&&g&&m.unshift(i.isNotEmpty()),e&&(g=!0),"number"===t.type&&(m.push(i.isNumber(!0)),"number"==typeof t.min&&m.push(i.isGreaterOrEqual(t.min,!0)),"number"==typeof t.max&&m.push(i.isLessOrEqual(t.max,!0)))};C(),t.isValueFocused=!1,t.isTouched=!1,t.canTogglePassword=!1,t.isPasswordVisible=!1,"password"===t.type&&(t.canTogglePassword=t.hasShowPasswordButton!==!1),t.isResetEnabled=function(){return!t.isDisabled&&""!==c.val()},t.reset=function(){w(V()),c.val("")},t.onReset=function(){t.isDisabled||(t.reset(),t.isTouched=!0,P("number"===t.type?null:""),T(),c.focus())},t.onFocus=function(e){"value"===e&&(t.isValueFocused=!0,"number"===t.type&&!a.isNullOrUndefined(t.value)&&t.isValid&&c.val(t.value.toFixed(y))),p&&(r=t.value,t.focus({maValue:t.value})),p=!1},c.focusout(function(e){R(e,"value")}),d.focusout(function(e){R(e)}),f.focusout(function(e){R(e)}),t.togglePassword=function(){t.isPasswordVisible=!t.isPasswordVisible,c[0].type=t.isPasswordVisible?"text":"password"},t.isTogglePasswordEnabled=function(){return!t.isDisabled&&""!==c.val()};var R=function(i,n){var s=angular.element(i.relatedTarget);p=t.canTogglePassword?s[0]!==c[0]&&s[0]!==f[0]&&s[0]!==d[0]:s[0]!==c[0]&&s[0]!==d[0],u&&e.cancel(u),"value"===n&&t.isValid&&c.val(q(t.value)),a.safeApply(function(){t.isValueFocused=!1}),p&&(E(),a.safeApply(function(){t.blur({maValue:t.value,maOldValue:r,maHasValueChanged:r!==t.value})}))};t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(s=angular.element(e.target).val())},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var t=!1;o=angular.element(i.target).val(),s!==o&&(t=!0),t&&(u&&e.cancel(u),u=e(function(){E()},b))}}),e(function(){n.removeAttr("id"),c.attr("id",t.id)}),t.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){O(e)&&(t.isTouched=!0);var i=c.prop("selectionStart");w(e),c.val(q(e)),T(),t.isValueFocused&&c.prop({selectionStart:i,selectionEnd:i})}});var S=function(e,a){if(e!==a){var i=V();C();for(var n=[],s=0;s<m.length;s++)"IsGreaterOrEqual"!==m[s].name&&"IsLessOrEqual"!==m[s].name||n.push(m[s]);if(n.length){for(!x||"IsGreaterOrEqual"!==x.name&&"IsLessOrEqual"!==x.name||(x=null,t.isValid=!0),s=0;s<n.length;s++)if(!n[s].validate(i)){t.isValid=!1,x=n[s];break}t.isValid||(t.isTouched=!0)}t.isValid&&P(i)}};t.$watch("max",function(e,a){S(e,a)}),t.$watch("min",function(e,a){S(e,a)}),c.val(q(t.value)),T(),w(t.value),t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,T()},t.instance.isValid=function(){return t.isValid},t.instance.focus=function(){t.isValueFocused||c.focus()},t.instance.failedValidator=function(){return x},t.instance.clear=function(){t.reset(),e(function(){t.isTouched=!1})})}}}])}();
