...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$timeout","maHelper",function(e,t){return{restrict:"E",scope:{items:"=",selectedItem:"=",isLoading:"=",change:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"="},replace:!0,template:function(){var e='            <div class="ma-select-box"                ng-class="{                    \'ma-select-box-can-add-item\': canAddItem,                    \'ma-select-box-is-focused\': isFocused                }">                <div class="ma-select-box-spinner" ng-if="isLoading">                    <div class="pace">                        <div class="pace-activity"></div>                    </div>                </div>                <select ui-select2="options"                    ng-show="!addingItem"                    ng-disabled="isDisabled"                    ng-model="value"                    ng-change="onChange()"                    ng-required="isRequired">                    <option ng-repeat="item in items" value="{{getItemValue(item)}}">                        {{formatItem(item)}}                    </option>                </select>                <input class="ma-select-box-input" type="text" ng-show="addingItem"                    ng-model="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"/>                <ma-button ng-if="canAddItem" size="xs" modifier="secondary"                    tooltip="{{getAddItemTooltip()}}"                    right-icon="{{addingItem ? \'bars\' : \'plus\'}}"                    click="addItem()">                </ma-button>            </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(i,n){var l=angular.element(n[0].querySelector(".ma-select-box-input"));i.addingItem=!1,i.formatItem=i.itemTemplate||function(e){return e?i.itemTextField?e[i.itemTextField]:e.toString():""},i.isFocused=!1,i.selectedItem&&(i.itemValueField?i.value=i.selectedItem[i.itemValueField].toString():"string"==typeof i.selectedItem?i.value=i.selectedItem:i.value=JSON.stringify(i.selectedItem)),i.onFocus=function(){i.isFocused=!0},i.onBlur=function(){if(i.isFocused=!1,i.itemTextField){if(i.selectedItem[i.itemTextField]===i.text)return;i.selectedItem={},i.selectedItem[i.itemTextField]=i.text}else{if(i.selectedItem===i.text)return;i.selectedItem=i.text}e(function(){i.change({item:i.selectedItem})})},i.getAddItemTooltip=function(){return i.addingItem?"Back to the list":i.addItemTooltip?i.addItemTooltip:"Add new item"},i.getItemValue=function(e){return i.itemValueField?e[i.itemValueField].toString():e},i.addItem=function(){i.previousItem=i.selectedItem,i.addingItem=!i.addingItem,i.addingItem,e(function(){if(i.addingItem)l.focus(),i.isFocused=!0;else{var e=angular.element(n[0].querySelector(".select2-container"));e.select2("focus")}})},i.onChange=function(){var n=t.isJson(i.value)?JSON.parse(i.value):i.value;if(i.itemValueField)for(var l=0;l<i.items.length;l++)if(i.items[l][i.itemValueField].toString()===n.toString()){n=i.items[l];break}if(n||i.selectedItem){if(i.itemValueField){if(i.selectedItem&&i.selectedItem[i.itemValueField].toString()===n[i.itemValueField].toString())return}else if(n===i.selectedItem)return;i.selectedItem=n,e(function(){i.change({item:n})})}}}}}])}();
