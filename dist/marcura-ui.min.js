...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-focused\': isFocused,                        \'ma-select-box-is-disabled\': isDisabled                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!addingItem"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()"                        ng-required="isRequired">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="addingItem"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"                        ng-blur="onBlur($event, \'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{addingItem ? \'bars\' : \'plus\'}}"                        click="toggleView()"                        ng-focus="onFocus()"                        ng-blur="onBlur($event, \'button\')"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(n,l){var d,o,s,c,a,u=angular.element(l[0].querySelector(".ma-select-box-input")),m=!1,r=!0;n.addingItem=!1,n.formatItem=n.itemTemplate||function(e){return e?n.itemTextField?e[n.itemTextField]:e.toString():""},n.isFocused=!1;var g=function(e){e?n.itemValueField&&e[n.itemValueField]?n.value=e[n.itemValueField].toString():"string"==typeof e?n.value=e:n.value=JSON.stringify(e):(n.value=null,n.text=null,o=null)};n.getAddItemTooltip=function(){return n.addingItem?"Back to the list":n.addItemTooltip?n.addItemTooltip:"Add new item"},n.getItemValue=function(e){return n.itemValueField?e[n.itemValueField].toString():e},n.toggleView=function(e){var i=!1;"select"===e?(n.addingItem=!1,i=!0):"add"===e?(n.addingItem=!0,i=!0):n.addingItem=!n.addingItem,n.addingItem?(s.select2("close"),d=n.selectedItem,n.selectedItem=o,n.selectedItem&&(n.text="string"==typeof n.selectedItem?n.selectedItem:n.selectedItem[n.itemTextField])):(o=n.selectedItem,n.selectedItem=d),i||t(function(){n.change({item:n.selectedItem}),n.addingItem?(u.focus(),n.isFocused=!0):s.select2("focus")})},n.onFocus=function(e){"input"===e&&(n.isFocused=!0),m=!0,r&&n.focus({item:n.selectedItem}),r=!1},n.onBlur=function(e,i){if(n.isFocused=!1,m=!1,t(function(){m||(n.blur({item:n.selectedItem}),r=!0)}),"input"===i){if(n.itemTextField){if(n.selectedItem&&n.selectedItem[n.itemTextField]===n.text)return;n.text?(n.selectedItem={},n.selectedItem[n.itemTextField]=n.text):n.selectedItem=null}else{if(n.selectedItem===n.text)return;n.selectedItem=n.text}o=n.selectedItem,t(function(){n.change({item:n.selectedItem})})}},n.onChange=function(){var e=i.isJson(n.value)?JSON.parse(n.value):n.value;if(n.itemValueField&&e)for(var l=0;l<n.items.length;l++)if(n.items[l][n.itemValueField].toString()===e.toString()){e=n.items[l];break}if(e||n.selectedItem){if(n.itemValueField){if(n.selectedItem&&n.selectedItem[n.itemValueField]&&n.selectedItem[n.itemValueField].toString()===e[n.itemValueField].toString())return}else if(e===n.selectedItem)return;n.selectedItem=e,d=e,t(function(){n.change({item:e})})}},n.$watch("selectedItem",function(e,t){e!==t&&g(e)}),g(n.selectedItem),n.instance&&(n.instance.showSelectView=function(){n.addingItem&&n.toggleView("select")},n.instance.showAddView=function(){n.addingItem||n.toggleView("add")}),t(function(){s=angular.element(l[0].querySelector(".select2-container")),c=s.data().select2,a=$('label[for="'+n.id+'"]'),a.length>0&&$(e).on("click",'label[for="'+n.id+'"]',function(){n.addingItem?u.focus():s.select2("focus")}),c.focusser.on("focus",function(){n.onFocus("select")}),c.focusser.on("blur",function(){n.onBlur()}),c.dropdown.on("focus",".select2-input",function(){n.onFocus()}),c.dropdown.on("blur",".select2-input",function(){n.onBlur()})})}}}])}();
