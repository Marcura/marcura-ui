...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-focused\': isFocused,                        \'ma-select-box-is-disabled\': isDisabled                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!addingItem"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()"                        ng-required="isRequired">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="addingItem"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{addingItem ? \'bars\' : \'plus\'}}"                        click="toggleView()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(n,l){var o,s,c,d,u=angular.element(l[0].querySelector(".ma-select-box-input")),a=null,m=null,r=!0,g=!1;n.addingItem=!1,n.formatItem=n.itemTemplate||function(e){return e?n.itemTextField?e[n.itemTextField]:e.toString():""},n.isFocused=!1;var f=function(e){e?n.itemValueField&&e[n.itemValueField]?n.value=e[n.itemValueField].toString():"string"==typeof e?n.value=e:n.value=JSON.stringify(e):(n.value=null,n.text=null,m=null)},I=function(e,i){var l=angular.element(e.relatedTarget),s=angular.element(c.dropdown[0].querySelector(".select2-input"));console.log("blur"),n.isFocused=!1,console.log("to:",l.attr("class")),"input"===i&&n.$apply(function(){if(n.itemTextField){if(n.selectedItem&&n.selectedItem[n.itemTextField]===n.text)return;n.text?(n.selectedItem={},n.selectedItem[n.itemTextField]=n.text):n.selectedItem=null}else{if(n.selectedItem===n.text)return;n.selectedItem=n.text}m=n.selectedItem,t(function(){n.change({item:n.selectedItem})})}),g||l[0]===o[0]||l[0]===u[0]||l[0]===c.focusser[0]||l[0]===s[0]||(n.blur({item:n.selectedItem}),r=!0),g=!1};n.getAddItemTooltip=function(){return n.addingItem?"Back to the list":n.addItemTooltip?n.addItemTooltip:"Add new item"},n.getItemValue=function(e){return n.itemValueField?e[n.itemValueField].toString():e},n.toggleView=function(e){var i=!1;"select"===e?(n.addingItem=!1,i=!0):"add"===e?(n.addingItem=!0,i=!0):n.addingItem=!n.addingItem,n.addingItem?(s.select2("close"),a=n.selectedItem,n.selectedItem=m,n.selectedItem&&(n.text="string"==typeof n.selectedItem?n.selectedItem:n.selectedItem[n.itemTextField])):(m=n.selectedItem,n.selectedItem=a),i||t(function(){n.change({item:n.selectedItem}),n.addingItem?(u.focus(),n.isFocused=!0):s.select2("focus")})},n.onFocus=function(e){"input"===e&&(n.isFocused=!0),r&&n.focus({item:n.selectedItem}),r=!1},u.focusout(function(e){I(e,"input")}),n.onChange=function(){var e=i.isJson(n.value)?JSON.parse(n.value):n.value;if(n.itemValueField&&e)for(var l=0;l<n.items.length;l++)if(n.items[l][n.itemValueField].toString()===e.toString()){e=n.items[l];break}if(e||n.selectedItem){if(n.itemValueField){if(n.selectedItem&&n.selectedItem[n.itemValueField]&&n.selectedItem[n.itemValueField].toString()===e[n.itemValueField].toString())return}else if(e===n.selectedItem)return;n.selectedItem=e,a=e,t(function(){n.change({item:e})})}},n.$watch("selectedItem",function(e,t){e!==t&&f(e)}),n.instance&&(n.instance.showSelectView=function(){n.addingItem&&n.toggleView("select")},n.instance.showAddView=function(){n.addingItem||n.toggleView("add")}),t(function(){f(n.selectedItem),s=angular.element(l[0].querySelector(".select2-container")),c=s.data().select2,d=$('label[for="'+n.id+'"]'),o=angular.element(l[0].querySelector(".ma-button")),d.length>0&&$(e).on("click",'label[for="'+n.id+'"]',function(){n.addingItem?u.focus():s.select2("focus")}),c.focusser.on("focus",function(){n.onFocus("select")}),c.focusser.on("focusout",function(e){I(e)}),c.dropdown.on("focus",".select2-input",function(){n.onFocus()}),c.dropdown.on("focusout",".select2-input",function(e){I(e)}),o.focusout(function(e){I(e)}),c.dropdown.on("mouseenter",".select2-result",function(){g=!0})})}}}])}();
