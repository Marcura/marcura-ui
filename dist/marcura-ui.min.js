...
!function(){angular.module("marcuraUI.components").directive("maCheckBox",["maHelper","$timeout","maValidators",function(e,a,i){return{restrict:"E",scope:{text:"@",value:"=",isDisabled:"=",change:"&",size:"@",rtl:"=",isRequired:"=",validators:"=",instance:"="},replace:!0,template:function(){var e='            <div class="ma-check-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-check-box-is-checked\': value === true,                    \'ma-check-box-is-disabled\': isDisabled,                    \'ma-check-box-has-text\': hasText,                    \'ma-check-box-rtl\': rtl,                    \'ma-check-box-is-focused\': isFocused,                    \'ma-check-box-is-invalid\': !isValid,                    \'ma-check-box-is-touched\': isTouched                }">                <span class="ma-check-box-text">{{text || \'&nbsp;\'}}</span>                <div class="ma-check-box-inner"></div>                <i class="ma-check-box-icon fa fa-check" ng-show="value === true"></i>            </div>';return e},link:function(s,n){var c=s.validators?angular.copy(s.validators):[],t=s.isRequired,o=!1,l=function(){s.isDisabled?n.removeAttr("tabindex"):n.attr("tabindex","0")},u=function(){s.hasText=!!s.text};s._size=s.size?s.size:"xs",s.cssClass=" ma-check-box-"+s._size,s.isFocused=!1,s.isValid=!0,s.isTouched=!1;var r=function(){s.isValid=!0,s.isTouched=!0;var e=s.value===!1?null:s.value;if(c&&c.length)for(var a=0;a<c.length;a++){var i=c[a];if(!i.validate("IsNotEmpty"===i.name?e:s.value)){s.isValid=!1;break}}};s.onChange=function(){s.isDisabled||(s.value=!s.value,r(),a(function(){s.change({maValue:s.value})}))},s.onFocus=function(){s.isDisabled||(s.isFocused=!0)},s.onBlur=function(){s.isDisabled||(s.isFocused=!1,r())},s.onKeypress=function(a){a.keyCode===e.keyCode.space&&(a.preventDefault(),s.isDisabled||s.onChange())},s.$watch("isDisabled",function(e,a){e!==a&&(e&&(s.isFocused=!1),l())}),s.$watch("text",function(e,a){e!==a&&u()});for(var d=0;d<c.length;d++)if("IsNotEmpty"===c[d].name){o=!0;break}!o&&t&&c.unshift(i.isNotEmpty()),o&&(t=!0),s.instance&&(s.instance.isInitialized=!0,s.instance.isValid=function(){return s.isValid},s.instance.validate=function(){r()}),l(),u()}}}])}();
