...
!function(){angular.module("marcuraUI.components").directive("maCheckBox",["MaHelper","$timeout","$parse","MaValidators",function(e,a,i,n){return{restrict:"E",scope:{text:"@",size:"@",rtl:"@",change:"&",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"="},replace:!0,template:function(e,a){var i="true"===a.rtl,n=a.size||"xs",s=!!a.text,t="ma-check-box ma-check-box-"+n;i&&(t+=" ma-check-box-rtl"),s&&(t+=" ma-check-box-has-text");var c='                <div class="'+t+'"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keypress="onKeypress($event)"                    ng-click="onChange()"                    ng-class="{                        \'ma-check-box-is-checked\': value === true,                        \'ma-check-box-is-disabled\': isDisabled,                        \'ma-check-box-is-focused\': isFocused,                        \'ma-check-box-is-invalid\': !isValid,                        \'ma-check-box-is-touched\': isTouched                    }">                    <span class="ma-check-box-text">{{text || \'&nbsp;\'}}</span>                    <div class="ma-check-box-inner"></div>                    <i class="ma-check-box-icon fa fa-check"></i>                </div>';return c},link:function(s,t,c){var o=s.validators?angular.copy(s.validators):[],l=s.isRequired,r=!1,u=function(){s.isDisabled?t.removeAttr("tabindex"):t.attr("tabindex","0")};s.isFocused=!1,s.isValid=!0,s.isTouched=!1;var d=function(){var e=null,a=null,i=s.$parent,n=c.value;for(n.indexOf(".")!==-1&&(e=n.split("."),n=e[0]);i&&!a;)i.hasOwnProperty(n)?a=i:i=i.$parent;return a||s.$parent},v=d(),h=function(){s.isValid=!0,s.isTouched=!0;var e=s.value===!1?null:s.value;if(o&&o.length)for(var a=0;a<o.length;a++){var i=o[a];if(!i.validate("IsNotEmpty"===i.name?e:s.value)){s.isValid=!1;break}}};s.onChange=function(){if(!s.isDisabled){var e=i(c.value),n=e.assign,t=!e(v);s.value=t,n(v,t),h(),a(function(){s.change({maValue:s.value})})}},s.onFocus=function(){s.isDisabled||(s.isFocused=!0)},s.onBlur=function(){s.isDisabled||(s.isFocused=!1,h())},s.onKeypress=function(a){a.keyCode===e.keyCode.space&&(a.preventDefault(),s.isDisabled||s.onChange())},s.$watch("isDisabled",function(e,a){e!==a&&(e&&(s.isFocused=!1),u())});for(var f=0;f<o.length;f++)if("IsNotEmpty"===o[f].name){r=!0;break}!r&&l&&o.unshift(n.isNotEmpty()),r&&(l=!0),s.instance&&(s.instance.isInitialized=!0,s.instance.isEditor=function(){return!0},s.instance.isValid=function(){return s.isValid},s.instance.validate=function(){h()}),u()}}}])}();
