...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,t){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@"},replace:!0,template:function(e,a){var t="password"===a.type?"password":"text",i="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+t+'" id="{{id}}"                    type="text"                    placeholder="{{placeholder}}"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return i},link:function(i,n){var s,o,l,u,c=angular.element(n[0].querySelector(".ma-text-box-value")),d=i.validators?angular.copy(i.validators):[],r=i.isRequired,f=!1,v=Number(i.changeTimeout),m=function(){i.isValid=!0;var e=c.val();if(d&&d.length)for(var a=0;a<d.length;a++)if(!d[a].validate(e)){i.isValid=!1;break}},b=function(a){l!==a&&(i.value=a,l=a,e(function(){i.change({maValue:a})}))},p=function(){var e=c.val();return(!a.isNullOrUndefined(l)||""!==e)&&l!==e},x=function(){i.isTouched=!0,p()&&(m(),i.isValid&&b(c.val()))};i.isFocused=!1,i.isTouched=!1;for(var h=0;h<d.length;h++)if("IsNotEmpty"===d[h].name){f=!0;break}!f&&r&&d.unshift(t.isNotEmpty()),f&&(r=!0),i.isResetEnabled=function(){return!i.isDisabled&&""!==c.val()},i.onReset=function(){i.isDisabled||(l=c.val(),i.isTouched=!0,b(null),m(),c.focus())},i.onFocus=function(){i.isFocused=!0,i.focus({maValue:i.value})},i.onBlur=function(){u&&e.cancel(u),i.isFocused=!1,x(),i.blur({maValue:i.value})},i.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(s=angular.element(e.target).val())},c.on("input",function(t){if(t.keyCode!==a.keyCode.tab&&t.keyCode!==a.keyCode.shift){var i=!1;o=angular.element(t.target).val(),s!==o&&(i=!0),i&&(u&&e.cancel(u),u=e(function(){x()},v))}}),e(function(){n.removeAttr("id"),c.attr("id",i.id)}),i.$watch("value",function(e,a){if(e!==a){var t=c.prop("selectionStart");c.val(e),m(),c.prop({selectionStart:t,selectionEnd:t})}}),c.val(i.value),m(),l=i.value,i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){i.isTouched=!0,m()},i.instance.isValid=function(){return i.isValid})}}}])}();