...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,o){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var o=!i.isNullOrWhiteSpace(t.ajax),l="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return l+=o?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="value"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="value"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',l+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,o){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.selectedItem&&e.selectedItem[e.itemValueField]){var l=angular.copy(e.selectedItem);l.text=l[e.itemTextField],l.id=l[e.itemValueField],e.previousSelectedItem=l,o(l)}else o();t.runs++})}],link:function(l,n){var s,d,c,a,u,r=angular.element(n[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=l.showAddItemTooltip!==!1,x=l.validators?angular.copy(l.validators):[],I=l.isRequired,h=!1;l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.formatItem=l.itemTemplate||function(e){return e?l.itemTextField?e[l.itemTextField]:e.toString():""},l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.isAjax=angular.isObject(l.ajax);var b=function(e){if(!angular.isArray(l.items))return!1;for(var t=l.itemValueField&&e[l.itemValueField],i=0;i<l.items.length;i++)if(t){if(l.items[i][l.itemValueField]===e[l.itemValueField])return!0}else if(l.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!l.itemTextField)return e;if(angular.isArray(l.items))for(var t=0;t<l.items.length;t++)if(l.items[t][l.itemValueField].toString()===e.toString())return l.items[t];return null},F=function(e){if(!l.itemTextField)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},A=function(e){l.canAddItem&&e&&(l.isAddMode=!b(e)),S(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(e?l.isAjax||(l.itemValueField&&e[l.itemValueField]?l.value=e[l.itemValueField].toString():"string"==typeof e&&(l.value=e)):l.value=null,l.previousSelectedItem=e,l.toggleMode("select"))},T=function(e,i){var o=angular.element(e.relatedTarget),n=angular.element(a.dropdown[0].querySelector(".select2-input"));l.isTextFocused=!1,"text"===i?(g=!1,l.$apply(function(){if(l.isTouched=!0,l.itemTextField){if(l.selectedItem&&l.selectedItem[l.itemTextField]===l.text)return;l.selectedItem=F(l.text)}else{if(l.selectedItem===l.text)return;l.selectedItem=l.text}m=l.selectedItem,l.isValid&&t(function(){l.change({item:l.selectedItem})})})):"select"===i&&l.$apply(function(){l.isTouched=!0}),f=l.canAddItem?!g&&o[0]!==s[0]&&o[0]!==d[0]&&o[0]!==r[0]&&o[0]!==a.focusser[0]&&o[0]!==n[0]:!g&&o[0]!==d[0]&&o[0]!==r[0]&&o[0]!==a.focusser[0]&&o[0]!==n[0],f&&l.blur({item:l.selectedItem}),g=!1},S=function(e){if(l.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].method(e)){l.isValid=!1;break}},M=function(){l.isAddMode?(r.focus(),l.isTextFocused=!0):c.select2("focus")};l.isResetEnabled=function(){return!l.isDisabled&&(l.isAddMode?!i.isNullOrWhiteSpace(l.text):null!==l.selectedItem)},l.onReset=function(){l.selectedItem=null,M(),t(function(){l.change({item:l.selectedItem})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),f&&l.focus({item:l.selectedItem}),f=!1},r.focusout(function(e){T(e,"text")}),l.getAddItemTooltip=function(){return p?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getItemValue=function(e){return l.itemValueField?e[l.itemValueField].toString():e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(c&&c.select2("close"),l.previousSelectedItem=v(l.value),l.selectedItem=m,l.selectedItem&&(l.text="string"==typeof l.selectedItem?l.selectedItem:l.selectedItem[l.itemTextField])):(m=F(l.text),l.selectedItem=l.previousSelectedItem),i||t(function(){l.change({item:l.selectedItem}),M()})}},l.onChange=function(){var e=i.isJson(l.value)?JSON.parse(l.value):l.value;if(l.isAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.isAjax&&l.itemValueField&&e)for(var o=0;o<l.items.length;o++)if(l.items[o][l.itemValueField].toString()===e.toString()){e=l.items[o];break}if(e||l.selectedItem){if(l.itemValueField){if(l.selectedItem&&l.selectedItem[l.itemValueField]&&l.selectedItem[l.itemValueField].toString()===e[l.itemValueField].toString())return}else if(e===l.selectedItem)return;l.selectedItem=e,l.previousSelectedItem=e,t(function(){l.change({item:e})})}},l.$watch("selectedItem",function(e,t){e!==t&&A(e)}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,S(e))}),l.instance&&(l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid});for(var V=0;V<x.length;V++)if("IsNotEmpty"===x[V].name){h=!0;break}!h&&I&&x.unshift(o.isNotEmpty()),h&&(I=!0),t(function(){A(l.selectedItem),c=angular.element(n[0].querySelector(".select2-container")),a=c.data().select2,u=$('label[for="'+l.id+'"]'),s=angular.element(n[0].querySelector(".ma-button-switch")),d=angular.element(n[0].querySelector(".ma-button-reset")),u.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){M()}),a.focusser.on("focus",function(){l.onFocus("select")}),a.focusser.on("focusout",function(e){T(e,"select")}),a.dropdown.on("focus",".select2-input",function(){g=!0,l.onFocus()}),a.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),s.focusout(function(e){T(e)}),d.focusout(function(e){T(e)}),a.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
