...
!function(){angular.module("marcuraUI.components").directive("maRadioBox",["maHelper","$timeout","$sce",function(e,i,t){return{restrict:"E",scope:{item:"=",itemTemplate:"=",itemTextField:"@",itemValueField:"@",value:"=",isDisabled:"=",hideText:"=",change:"&",size:"@",comparer:"="},replace:!0,template:function(){var e='            <div class="ma-radio-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-radio-box-is-checked\': isChecked(),                    \'ma-radio-box-is-disabled\': isDisabled,                    \'ma-radio-box-has-text\': hasText(),                    \'ma-radio-box-is-focused\': isFocused                }">                <span class="ma-radio-box-text" ng-bind-html="getItemText()"></span>                <div class="ma-radio-box-inner"></div>                <i class="ma-radio-box-icon" ng-show="isChecked()"></i>            </div>';return e},link:function(a,s,n){var o="&nbsp;",r=null,l=!a.itemTextField&&!a.itemValueField,u=function(){a.isDisabled?s.removeAttr("tabindex"):s.attr("tabindex","0")},c=function(){var e=null,i=a.$parent,t=n.value;for(t.indexOf(".")!==-1&&(r=t.split("."),t=r[0]);i&&!e;)i.hasOwnProperty(t)?e=i:i=i.$parent;return e},d=c();a._size=a.size?a.size:"xs",a.cssClass=" ma-radio-box-"+a._size,a.isFocused=!1,a.getItemText=function(){if(a.hideText)return o;var e;return a.itemTemplate?e=a.itemTemplate(a.item):l?e=a.item:a.itemTextField&&(e=a.item[a.itemTextField]),angular.isString(e)&&e||(e=o),t.trustAsHtml(e)},a.hasText=function(){return a.getItemText()!==o},a.isChecked=function(){return a.comparer?a.comparer(a.item,a.value):JSON.stringify(a.item)===JSON.stringify(a.value)},a.onChange=function(){if(!a.isDisabled){var e,t=a.value;if(a.value=a.item,d&&r){e=d;for(var s=0;s<r.length;s++)e=e[r[s]];e=a.item}else e=d[n.value],d[n.value]=a.item;i(function(){a.change({maValue:a.item,maOldValue:t})})}},a.onFocus=function(){a.isDisabled||(a.isFocused=!0)},a.onBlur=function(){a.isDisabled||(a.isFocused=!1)},a.onKeypress=function(i){i.keyCode===e.keyCode.space&&(i.preventDefault(),a.isDisabled||a.isChecked()||a.onChange())},a.$watch("isDisabled",function(e,i){e!==i&&(e&&(a.isFocused=!1),u())}),u()}}}])}();
