...
!function(){angular.module("marcuraUI.components").directive("maGridSort",["$timeout",function(r){return{require:"^^maGrid",restrict:"E",scope:{sortBy:"@"},replace:!0,template:function(){var r='            <div class="ma-grid-sort{{isVisible() ? \' ma-grid-sort-\' + direction : \'\'}}"                ng-click="sort()">                <i class="fa fa-sort-asc"></i>                <i class="fa fa-sort-desc"></i>            </div>';return r},link:function(s,t,i,o){var e,a=t.closest(".ma-grid-header-col"),c=function(){for(var r=null,t=s.$parent;t&&!r;)t.hasOwnProperty("componentName")&&"maGrid"===t.componentName?r=t:t=t.$parent;return r};s.sort=function(){e&&(e.sortBy.isAsc=!e.sortBy.isAsc,e.sortBy.field=s.sortBy,s.direction=e.sortBy.isAsc?"asc":"desc",r(function(){e.sort()}))},a.hasClass("ma-grid-header-col-sortable")||a.addClass("ma-grid-header-col-sortable"),s.isVisible=function(){return!!e&&e.sortBy.field===s.sortBy},r(function(){e=c(),s.direction=e.sortBy.isAsc?"asc":"desc"})}}}])}();
