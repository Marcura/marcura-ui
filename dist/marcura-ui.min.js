...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",multiple:"="},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),n="true"===t.multiple,a="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return a+=l?'<input class="ma-select-box-input" ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ui-select2="options"'+(n?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">'+(n?"":"<option></option>")+'                            <option ng-repeat="item in _items | maSelectBoxOrderBy:orderBy" value="{{getOptionValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',a+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-show="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.getItemValue=function(t){if(!t||!e.itemValueField)return null;for(var l=e.itemValueField.split("."),n=t[l[0]],a=1;a<l.length;a++)n=n[l[a]];return i.isNullOrUndefined(n)?null:n.toString()},e.formatItem=e.itemTemplate||function(t){return t?e.itemTextField?t[e.itemTextField]:t.toString():""},e.options={},e.runInitSelection=!0,e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.formatItem(l),l.id=e.getItemValue(l),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1})}],link:function(l,n){var a,o,s,u,d,c,r=angular.element(n[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=!1,v=l.showAddItemTooltip!==!1,x=l.validators?angular.copy(l.validators):[],h=l.itemTextField||l.itemValueField;l._items=angular.isArray(l.items)?angular.copy(l.items):[],l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.isAjax=angular.isObject(l.ajax);var I={name:"IsNotEmpty",validate:function(e){return l.multiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&!!(l.isAjax||l.isAddMode||A(e))}},b=function(){for(var e=null,t=0;t<x.length;t++)if("IsNotEmpty"===x[t].name){e=t,x[t]=I;break}null===e&&l.isRequired?x.unshift(I):null===e||l.isRequired||x.splice(e,1)},A=function(e){if(!angular.isArray(l._items))return!1;for(var t=null!==l.getItemValue(e),i=0;i<l._items.length;i++)if(t){if(l.getItemValue(l._items[i])===l.getItemValue(e))return!0}else if(l._items[i]===e)return!0;return!1},V=function(e){if(!e)return null;if(!h)return e;if(angular.isArray(l._items))for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},T=function(e){if(!h)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},M=function(e){if(l.multiple){var t=[];if(e&&e.length)for(var i=0;i<e.length;i++)t.push(l.getItemValue(e[i]));l.selectedItem=t,y(e)}else l.canAddItem&&e&&(l.isAddMode=!A(e)),y(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(e?l.isAjax||(null!==l.getItemValue(e)?l.selectedItem=l.getItemValue(e):"string"==typeof e&&(l.selectedItem=e)):l.selectedItem=null,l.previousSelectedItem=e,l.toggleMode("select"))},S=function(e,i){var s=angular.element(e.relatedTarget);l.isTextFocused=!1,"text"===i?(g=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=T(l.text)}else{if(l.value===l.text)return;e=l.text}y(e),l.isValid&&(c=l.value||null,l.value=e,m=l.value,l.isValid&&t(function(){l.change({maValue:l.value,maOldValue:c})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),f=!g&&s[0]!==a[0]&&s[0]!==o[0]&&s[0]!==r[0]&&s[0]!==u.search[0],l.multiple?p&&(f=!1):g||s[0]!==u.focusser[0]||(f=!1),f&&(n.removeClass("ma-select-box-is-select-focused"),l.blur({maValue:l.value})),g=!1},y=function(e){if(l.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].validate(e)){l.isValid=!1;break}},F=function(){l.isAddMode?(r.focus(),l.isTextFocused=!0):s.select2("focus")};l.isResetEnabled=function(){return!l.isDisabled&&(l.multiple?!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?!i.isNullOrWhiteSpace(l.text):!i.isNullOrUndefined(l.value))},l.reset=function(){c=l.value,l.value=l.multiple?[]:null},l.onReset=function(){l.isTouched=!0,l.reset(),F(),t(function(){l.change({maValue:l.value,maOldValue:c})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),"reset"===e&&n.removeClass("ma-select-box-is-select-focused"),f&&l.focus({maValue:l.value}),f=!1},r.focusout(function(e){S(e,"text")}),l.getAddItemTooltip=function(){return v?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getOptionValue=function(e){return l.itemValueField?l.getItemValue(e):e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;c=l.value||null,"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(s&&s.select2("close"),l.previousSelectedItem=V(l.selectedItem),l.value=m,l.value&&(l.text="string"==typeof l.value?l.value:l.value[l.itemTextField])):(m=T(l.text),l.value=l.previousSelectedItem),i||t(function(){l.change({maValue:l.value,maOldValue:c}),F()})}},l.onChange=function(){var e;if(l.multiple){for(var n=l.selectedItem,a=[],o=0;o<n.length;o++)e=V(n[o]),e&&a.push(e);l.isTouched=!0,l.value=a,t(function(){l.change({maValue:a})}),u.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"==typeof e&&(e=l.selectedItem),l.isAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.isAjax&&l.itemValueField&&!i.isNullOrWhiteSpace(e))for(var s=0;s<l._items.length;s++)if(l.getItemValue(l._items[s])===e.toString()){e=l._items[s];break}if(!e&&!l.value)return;if(l.itemValueField){var d=l.getItemValue(l.value);if(d&&d===l.getItemValue(e))return}else if(e===l.value)return;c=l.value,l.value=e,l.previousSelectedItem=e,t(function(){l.change({maValue:e,maOldValue:c})})}};var w=function(){l.isAjax&&u&&(u.opts.placeholder=l.value?"":l.placeholder,u.setPlaceholder(),l.runInitSelection=!0,u.initSelection())};l.$watch("items",function(e,i){angular.equals(e,i)||(l._items.splice(0,l._items.length),Array.prototype.push.apply(l._items,e),M(l.value),t(function(){var e,t;if(angular.isObject(l.value))if(l.multiple&&angular.isArray(l.value)){for(var i=[],n=0;n<l.value.length;n++)e=l.getItemValue(l.value[n]),t=angular.copy(V(e)||l.value[n]),t.text=l.formatItem(t),t.id=e,t&&i.push(t);u.data(i)}else e=l.getItemValue(l.value),t=angular.copy(V(e)||l.value),t.text=l.formatItem(t),t.id=e,u.data(t);else l.value?u.val(l.value):u.data(null)}))},!0),l.$watch("value",function(e,t){e!==t&&(w(),M(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,y(e))}),l.$watch("isRequired",function(e,t){e!==t&&(b(),y(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,y(l.isAddMode?l.text:l.value)},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),b(),t(function(){M(l.value),s=angular.element(n[0].querySelector(".select2-container")),u=s.data().select2,d=$('label[for="'+l.id+'"]'),a=angular.element(n[0].querySelector(".ma-button-switch")),o=angular.element(n[0].querySelector(".ma-button-reset")),w(),d.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){F()}),l.multiple?(u.search.on("focus",function(){n.addClass("ma-select-box-is-select-focused"),l.onFocus()}),u.search.on("focusout",function(e){S(e,"select")}),u.selection.on("mouseenter",function(){p=!0}),u.selection.on("mouseleave",function(){p=!1}),u.dropdown.on("mouseenter",function(){p=!0}),u.dropdown.on("mouseleave",function(){p=!1}),u.dropdown.on("click",function(){u.search.focus()})):(u.focusser.on("focus",function(){l.onFocus("select")}),u.focusser.on("focusout",function(e){S(e,"select")})),u.dropdown.on("focus",".select2-input",function(){g=!0,l.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){S(e,"select")}),a.focusout(function(e){S(e)}),o.focusout(function(e){S(e)}),u.dropdown.on("mouseenter",".select2-result",function(){g=!0}),u.dropdown.on("mouseleave",".select2-result",function(){g=!1}),$(e).on("mouseenter",".select2-drop-mask",function(){l.multiple||(g=!0)}),l.init({maInstance:l.instance})})}}}])}();
