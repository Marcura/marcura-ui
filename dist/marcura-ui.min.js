...
!function(){angular.module("marcuraUI.components").directive("maGridOrder",["maHelper",function(r){return{require:"^^maGrid",restrict:"E",scope:{orderBy:"@"},replace:!0,template:function(){var r='            <div class="ma-grid-order ma-grid-order-{{direction}}"                ng-show="isVisible()"                ng-click="order()">                <i class="fa fa-sort-{{direction}}"></i>            </div>';return r},link:function(e,o,i,n){var a=function(){for(var r=null,o=e.$parent;o&&!r;)o.hasOwnProperty("componentName")&&"maGrid"===o.componentName?r=o:o=o.$parent;return r},c=a(),d=o.closest(".ma-grid-header-col"),t=o.closest(".ma-grid-caption");d.hasClass("ma-grid-header-col-sortable")||d.addClass("ma-grid-header-col-sortable");var s=function(){return c.orderBy&&new RegExp("^-?"+e.orderBy+"$","i").test(c.orderBy)?"-"===c.orderBy.charAt(0)?"desc":"asc":""},l=function(){e.direction="desc"===s()?"asc":"desc",c.orderBy="asc"===e.direction?e.orderBy:"-"+e.orderBy};e.direction=s(),e.isVisible=function(){return c.orderBy===e.orderBy||c.orderBy==="-"+e.orderBy},t.on("click",function(){r.safeApply(function(){l()})})}}}])}();
!function(){angular.module("marcuraUI.components").directive("maGrid",["maHelper",function(e){return{restrict:"E",transclude:!0,scope:{orderBy:"=",modifier:"@",isResponsive:"=",responsiveSize:"@"},replace:!0,template:function(){var e='            <div class="ma-grid">                <div class="ma-grid-inner"><ng-transclude></ng-transclude></div>            </div>';return e},controller:["$scope",function(e){e.componentName="maGrid"}],link:function(i,s){var r=i.responsiveSize?i.responsiveSize:"md",n=function(r){if(!e.isNullOrWhiteSpace(r)){r=r.split(" ");for(var n=0;n<r.length;n++)s.removeClass("ma-grid-"+r[n])}var o="";e.isNullOrWhiteSpace(i.modifier)||(o=i.modifier.split(" "));for(var a=0;a<o.length;a++)s.addClass("ma-grid-"+o[a])},o=function(e,i){var r;"boolean"==typeof i?(r="ma-grid-"+e,i===!0?s.addClass(r):s.removeClass(r)):i&&(s.removeClass(function(i,s){return(s.match(RegExp("ma-grid-"+e+"-.+","ig"))||[]).join(" ")}),s.addClass("ma-grid-"+e+"-"+i))};i.$watch("modifier",function(e,i){e!==i&&n(i)}),i.$watch("isResponsive",function(e,s){e!==s&&o("is-responsive",i.isResponsive)}),i.$watch("responsiveSize",function(e,i){e!==i&&(r=e,o("responsive-size",r))}),n(),o("is-responsive",i.isResponsive),o("responsive-size",r)}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,s){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"="},replace:!0,template:function(e,a){var s="password"===a.type?"password":"text",t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+s+'" id="{{id}}"                    type="text"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return t},link:function(t,i){var o,n,l,u,d,r=angular.element(i[0].querySelector(".ma-text-box-value")),c=angular.element(i[0].querySelector(".ma-button-reset")),f=angular.element(i[0].querySelector(".ma-button-toggle-password")),g=t.validators?angular.copy(t.validators):[],m=t.isRequired,b=!1,v=Number(t.changeTimeout),p=!0,w=t.trim!==!1,h=!1,x=function(e){e=(a.isNullOrUndefined(e)?"":e).toString(),w&&(e=e.trim()),l=e},y=function(){t.isValid=!0;var e=r.val();if(g&&g.length)for(var a=0;a<g.length;a++)if(!g[a].validate(e)){t.isValid=!1;break}},V=function(a){if(P(a)){h=!0;var s=w?l.trim():l;a=w?a.trim():a,t.value=a,x(a),e(function(){t.change({maValue:a,maOldValue:s})})}},P=function(e){e=a.isNullOrUndefined(e)?"":e;var s=a.isNullOrUndefined(l)?"":l;return w?s.trim()!==e.trim():s!==e},T=function(){return t.isTouched=!0,P(r.val())?(y(),void(t.isValid&&V(r.val()))):void y()};t.isValueFocused=!1,t.isTouched=!1,t.canTogglePassword=!1,t.isPasswordVisible=!1,"password"===t.type&&(t.canTogglePassword=t.hasShowPasswordButton!==!1);for(var k=0;k<g.length;k++)if("IsNotEmpty"===g[k].name){b=!0;break}!b&&m&&g.unshift(s.isNotEmpty()),b&&(m=!0),t.isResetEnabled=function(){return!t.isDisabled&&""!==r.val()},t.onReset=function(){t.isDisabled||(x(r.val()),t.isTouched=!0,r.val(""),V(""),y(),r.focus())},t.onFocus=function(e){"value"===e&&(t.isValueFocused=!0),p&&(d=t.value,t.focus({maValue:t.value})),p=!1},r.focusout(function(e){R(e)}),c.focusout(function(e){R(e)}),f.focusout(function(e){R(e)}),t.togglePassword=function(){t.isPasswordVisible=!t.isPasswordVisible,r[0].type=t.isPasswordVisible?"text":"password"},t.isTogglePasswordEnabled=function(){return!t.isDisabled&&""!==r.val()};var R=function(s){var i=angular.element(s.relatedTarget);p=t.canTogglePassword?i[0]!==r[0]&&i[0]!==f[0]&&i[0]!==c[0]:i[0]!==r[0]&&i[0]!==c[0],u&&e.cancel(u),a.safeApply(function(){t.isValueFocused=!1}),p&&(T(),a.safeApply(function(){t.blur({maValue:t.value,maOldValue:d,maHasValueChanged:d!==t.value})}))};t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},r.on("input",function(s){if(s.keyCode!==a.keyCode.tab&&s.keyCode!==a.keyCode.shift){var t=!1;n=angular.element(s.target).val(),o!==n&&(t=!0),t&&(u&&e.cancel(u),u=e(function(){T()},v))}}),e(function(){i.removeAttr("id"),r.attr("id",t.id)}),t.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){var s=r.prop("selectionStart");x(e),r.val(e),y(),t.isValueFocused&&r.prop({selectionStart:s,selectionEnd:s})}}),r.val(t.value),y(),x(t.value),t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,y()},t.instance.isValid=function(){return t.isValid},t.instance.focus=function(){t.isValueFocused||r.focus()})}}}])}();