...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-focused\': isFocused,                        \'ma-select-box-is-disabled\': isDisabled                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()"                        ng-required="isRequired">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(o,n){var d,l,s,c,u=angular.element(n[0].querySelector(".ma-select-box-input")),r=null,a=null,m=!0,f=!1,g=o.showAddItemTooltip!==!1;o.isAddMode=!1,o.formatItem=o.itemTemplate||function(e){return e?o.itemTextField?e[o.itemTextField]:e.toString():""},o.isFocused=!1;var p=function(e){for(var t=o.itemValueField&&e[o.itemValueField],i=0;i<o.items.length;i++)if(t){if(o.items[i][o.itemValueField]===e[o.itemValueField])return!0}else if(o.items[i]===e)return!0;return!1},F=function(e){if(!e)return null;if(!o.itemTextField)return e;for(var t=0;t<o.items.length;t++)if(o.items[t][o.itemValueField].toString()===e.toString())return o.items[t];return null},I=function(e){if(!o.itemTextField)return e;if(e){var t={};return t[o.itemTextField]=e,t}return null},x=function(e){e&&(o.isAddMode=!p(e)),o.isAddMode?(e?o.itemTextField&&e[o.itemTextField]?o.text=e[o.itemTextField].toString():o.text=e:o.text=null,a=e,o.toggleMode("add")):(e?o.itemValueField&&e[o.itemValueField]?o.value=e[o.itemValueField].toString():"string"==typeof e&&(o.value=e):o.value=null,r=e,o.toggleMode("select"))},v=function(e,i){var n=angular.element(e.relatedTarget),l=angular.element(s.dropdown[0].querySelector(".select2-input"));o.isFocused=!1,"input"===i&&o.$apply(function(){if(o.itemTextField){if(o.selectedItem&&o.selectedItem[o.itemTextField]===o.text)return;o.selectedItem=I(o.text)}else{if(o.selectedItem===o.text)return;o.selectedItem=o.text}a=o.selectedItem,t(function(){o.change({item:o.selectedItem})})}),f||n[0]===d[0]||n[0]===u[0]||n[0]===s.focusser[0]||n[0]===l[0]||(o.blur({item:o.selectedItem}),m=!0),f=!1};o.onFocus=function(e){"input"===e&&(o.isFocused=!0),m&&o.focus({item:o.selectedItem}),m=!1},u.focusout(function(e){v(e,"input")}),o.getAddItemTooltip=function(){return g?o.isAddMode?"Back to the list":o.addItemTooltip?o.addItemTooltip:"Add new item":""},o.getItemValue=function(e){return o.itemValueField?e[o.itemValueField].toString():e},o.toggleMode=function(e){if(!(o.isAddMode&&"add"===e||!o.isAddMode&&"select"===e)){var i=!1;"select"===e?(o.isAddMode=!1,i=!0):"add"===e?(o.isAddMode=!0,i=!0):o.isAddMode=!o.isAddMode,o.isAddMode?(l&&l.select2("close"),r=F(o.value),o.selectedItem=a,o.selectedItem&&(o.text="string"==typeof o.selectedItem?o.selectedItem:o.selectedItem[o.itemTextField])):(a=I(o.text),o.selectedItem=r),i||t(function(){o.change({item:o.selectedItem}),o.isAddMode?(u.focus(),o.isFocused=!0):l.select2("focus")})}},o.onChange=function(){var e=i.isJson(o.value)?JSON.parse(o.value):o.value;if(o.itemValueField&&e)for(var n=0;n<o.items.length;n++)if(o.items[n][o.itemValueField].toString()===e.toString()){e=o.items[n];break}if(e||o.selectedItem){if(o.itemValueField){if(o.selectedItem&&o.selectedItem[o.itemValueField]&&o.selectedItem[o.itemValueField].toString()===e[o.itemValueField].toString())return}else if(e===o.selectedItem)return;o.selectedItem=e,r=e,t(function(){o.change({item:e})})}},o.$watch("selectedItem",function(e,t){e!==t&&x(e)}),o.instance&&(o.instance.switchToSelectMode=function(){o.isAddMode&&o.toggleMode("select")},o.instance.switchToAddMode=function(){o.isAddMode||o.toggleMode("add")}),t(function(){x(o.selectedItem),l=angular.element(n[0].querySelector(".select2-container")),s=l.data().select2,c=$('label[for="'+o.id+'"]'),d=angular.element(n[0].querySelector(".ma-button")),c.length>0&&$(e).on("click",'label[for="'+o.id+'"]',function(){o.isAddMode?u.focus():l.select2("focus")}),s.focusser.on("focus",function(){o.onFocus("select")}),s.focusser.on("focusout",function(e){v(e)}),s.dropdown.on("focus",".select2-input",function(){f=!0,o.onFocus()}),s.dropdown.on("focusout",".select2-input",function(e){v(e)}),d.focusout(function(e){v(e)}),s.dropdown.on("mouseenter",".select2-result",function(){f=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){f=!0})})}}}])}();
