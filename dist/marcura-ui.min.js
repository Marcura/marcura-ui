...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"="},replace:!0,template:function(){var e='            <div class="ma-text-box"                ng-class="{                    \'ma-text-box-is-disabled\': isDisabled,                    \'ma-text-box-is-focused\': isFocused,                    \'ma-text-box-is-invalid\': !isValid,                    \'ma-text-box-is-touched\': isTouched                }">                <input class="ma-text-box-value" type="text" id="{{id}}"                    type="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-keyup="onKeyup($event)"                    ng-disabled="isDisabled"/>            </div>';return e},link:function(t,n){var o,u,l,s,c=angular.element(n[0].querySelector(".ma-text-box-value")),d=t.validators?angular.copy(t.validators):[],r=t.isRequired,v=!1,f=Number(t.changeTimeout),m=function(){if(t.isValid=!0,d&&d.length)for(var e=0;e<d.length;e++)if(!d[e].validate(c.val())){t.isValid=!1;break}},b=function(a){l!==a&&(t.value=a,l=a,e(function(){t.change({maValue:a})}))},g=function(){t.isTouched=!0,m(),t.isValid&&b(c.val())};t.isFocused=!1,t.isTouched=!1;for(var y=0;y<d.length;y++)if("IsNotEmpty"===d[y].name){v=!0;break}!v&&r&&d.unshift(i.isNotEmpty()),v&&(r=!0),t.onFocus=function(){t.isFocused=!0,t.focus({maValue:t.value})},t.onBlur=function(){s&&e.cancel(s),t.isFocused=!1,g(),t.blur({maValue:t.value})},t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},t.onKeyup=function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var t=!1;u=angular.element(i.target).val(),o!==u&&(t=!0),t&&(f>0?(s&&e.cancel(s),s=e(function(){g()},f)):g())}},e(function(){n.removeAttr("id"),c.attr("id",t.id)}),t.$watch("value",function(e,a){e!==a&&(t.isValid=!0,t.isTouched=!1,c.val(e))}),c.val(t.value),m(),l=t.value,t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,m()},t.instance.isValid=function(){return t.isValid})}}}])}();