...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",selectItemTooltip:"@",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",isMultiple:"=",type:"@",minSearchCharacters:"=",noItemsFoundText:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !_hasValue,                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': _hasValue                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input class="ma-select-box-input" ma-select-box-wrapper="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select-box-wrapper="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items" value="{{item[_itemValueField]}}">                                {{item.text}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-toggle"                        ng-show="canAddItem" size="xs" modifier="simple"                        ma-tooltip="{{_addItemTooltip}}"                        ma-tooltip-is-disabled="!canAddItem"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode(null, null, true)"                        ng-focus="onFocus(\'toggle\')"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="isDisabled || !_hasValue">                    </ma-button>                </div>'},controller:["$scope",function(e){e._type=e.type?e.type:"object",e._itemValueField=e.itemValueField?e.itemValueField:"id",e._minSearchCharacters=e.minSearchCharacters>0?e.minSearchCharacters:1,e.getItemValue=function(t,l){if(l="boolean"!=typeof l||l,i.isNullOrWhiteSpace(t))return null;if("object"!=typeof t)return t.toString();for(var a=e._itemValueField.split("."),n=t[a[0]],o=1;o<a.length;o++)n=n[a[o]];return i.isNullOrUndefined(n)?null:l?n.toString():n},e.convertItemValue=function(t){return i.isNullOrUndefined(t)?null:"object"===e._type?t:"string"===e._type?t[e._itemValueField]:"boolean"===e._type?"true"===t[e._itemValueField]:"number"===e._type?Number(t[e._itemValueField]):t},e.getItemText=function(t){return e.itemTemplate?e.itemTemplate(e.convertItemValue(t)):t?"object"!==e._type?t[e._itemValueField]:e.itemTextField?t[e.itemTextField]:t.toString():""},e.runInitSelection=!0,e.options={},e.options.canAddItem=!!e.canAddItem,e.options.instance={},e.noItemsFoundText&&(e.options.formatNoMatches=function(){return e.noItemsFoundText}),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=e._minSearchCharacters,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.getItemText(l),l[e._itemValueField]=e.getItemValue(l,"object"!==e._type),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1},e.isMultiple&&(e.options.formatSelection=function(t){return e.getItemText(t)}))}],link:function(l,a,n){var o,u,s,c,d,r,m=angular.element(a[0].querySelector(".ma-select-box-text")),p=null,f=!0,g=!1,h=!1,v=!1,x=l.showAddItemTooltip!==!1,I=l.validators?angular.copy(l.validators):[],b=" ";l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.hasAjax=angular.isObject(l.ajax),l._hasValue=!1,l._items=[];var V=function(e){if(!l.hasAjax&&angular.isArray(e)){l._items.splice(0,l._items.length);var t,a=[];if("object"===l._type)a=angular.copy(e);else for(t=0;t<e.length;t++)if(!i.isNullOrUndefined(e[t])){var n={};n[l._itemValueField]=e[t].toString(),a.push(n)}for(t=0;t<a.length;t++)a[t].text=l.getItemText(a[t]);Array.prototype.push.apply(l._items,a)}};V(l.items);var _={name:"IsNotEmpty",validate:function(e){return l.isMultiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&("object"!==l._type&&!i.isNullOrWhiteSpace(e)||!!(l.hasAjax||l.isAddMode||A(e)))}},S=function(){for(var e=null,t=0;t<I.length;t++)if("IsNotEmpty"===I[t].name){e=t,I[t]=_;break}null===e&&l.isRequired?I.unshift(_):null===e||l.isRequired||I.splice(e,1)},A=function(e){if(l.hasAjax)return e&&!i.isNullOrWhiteSpace(e[l.itemValueField]);for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===l.getItemValue(e))return!0;return!1},M=function(e){if(i.isNullOrWhiteSpace(e))return null;if("object"!==l._type)return e;for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},T=function(e){if(i.isNullOrWhiteSpace(e))return null;var t={};return"object"===l._type?t[l.itemTextField]=e:e&&(t[l._itemValueField]=e),t},y=function(e){if(l.isMultiple){var t,a=[];if(l.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(l.getItemValue(e[t]));l.selectedItem=a,O(e)}else l.canAddItem&&e&&(l.isAddMode=!A(e),W()),O(e),l.isAddMode?(i.isNullOrWhiteSpace(e)?l.text=null:"object"===l._type?l.text=e[l.itemTextField].toString():l.text=e,p=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.hasAjax||(l.selectedItem=l.getItemValue(e)),l.previousSelectedItem=e,l.toggleMode("select")),W();w()},F=function(e){if(i.isNullOrWhiteSpace(e))return null;var t=angular.copy(e);if("object"===l._type)if(l.isMultiple)for(var a=0;a<t.length;a++)delete t[a].text;else delete t.text;return t},j=function(e,a){var n=angular.element(e.relatedTarget||e.toElement),s=n[0]===u[0],d=!l.isMultiple&&c.focusser[0]===n[0],x=e.target===o[0],I=e.target===u[0];if(l.isTextFocused=!1,"text"===a?l.$apply(function(){l.isTouched=!0;var e;if(!i.isNullOrWhiteSpace(l.text)||!i.isNullOrWhiteSpace(l.value)){if("object"===l._type){if(l.value&&l.value[l.itemTextField]===l.text)return;e=l.convertItemValue(T(l.text))}else{if(l.value===l.text)return;e=l.text}O(e),l.isValid&&(e=F(e),r=F(l.value)||null,l.value=e,p=l.value,w(),l.isValid&&!s&&t(function(){l.change({maValue:l.value,maOldValue:r})}))}}):"select"===a&&l.$apply(function(){l.isTouched=!0}),f=(!x&&!I||!d)&&(!h&&!v&&n[0]!==o[0]&&!s&&n[0]!==m[0]&&n[0]!==c.search[0]),l.isMultiple){var b=angular.element(e.target);b.hasClass("select2-input")&&b.hasClass("select2-default")?f=!0:g&&(f=!1)}f&&l.blur({maValue:l.value})},O=function(e){if(l.isValid=!0,I&&I.length)for(var t=0;t<I.length;t++)if(!I[t].validate(e)){l.isValid=!1;break}},N=function(){l.isAddMode?m.focus():s.select2("focus")},w=function(){l.isMultiple?l._hasValue=!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?l._hasValue=!i.isNullOrWhiteSpace(l.text):l._hasValue=!i.isNullOrUndefined(l.value)&&!l.isLoading},W=function(){x&&l.canAddItem?l.isAddMode?l._addItemTooltip=l.selectItemTooltip?l.selectItemTooltip:"Select"+b+"item":l._addItemTooltip=l.addItemTooltip?l.addItemTooltip:"Add"+b+"item":l._addItemTooltip=""},k=function(e,t){if(!e&&!t)return!0;if(e&&!t||!e&&t||e.length!==t.length)return!1;for(var i=!0,a=0;a<e.length;a++)if("object"===l._type){if(e[a][l._itemValueField]!==t[a][l._itemValueField]){i=!1;break}}else if(e[a]!==t[a]){i=!1;break}return i},q=function(e){return 1!==arguments.length?c?c.searchText:"":void(c&&(c.searchText=e))};l.reset=function(){r=l.value,l.value=l.isMultiple?[]:null,w()},l.onReset=function(){l.isTouched=!0,l.reset(),N(),t(function(){l.change({maValue:l.value,maOldValue:r})})},l.onFocus=function(e,t){"text"===e&&(l.isTextFocused=!0),f&&l.focus({maValue:l.value}),f=!1},l.options.instance.focus=function(){l.onFocus()},l.options.instance.blur=function(e){j(e,"select")},m.focusout(function(e){j(e,"text")}),l.toggleMode=function(e,a,n){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var o,u,c=!0;r=i.isNullOrWhiteSpace(l.value)?null:l.value,"select"===e?(l.isAddMode=!1,c=!1):"add"===e?(l.isAddMode=!0,c=!1):l.isAddMode=!l.isAddMode,"boolean"==typeof a&&(c=a),W(),l.isAddMode?(s&&s.select2("close"),l.hasAjax?l.previousSelectedItem=l.selectedItem:l.previousSelectedItem=M(l.selectedItem),o=q()?"object"===l._type?T(q()):q():F(p),i.isNullOrWhiteSpace(o)||(l.text="object"===l._type?o[l.itemTextField]:o),q("")):(p=l.convertItemValue(T(l.text)),o=F(l.previousSelectedItem)),O(o),u=!angular.equals(l.getItemValue(o),l.getItemValue(r)),l.isValid&&(l.value=o),n&&(l.isTouched=!0),w(),c&&t(function(){N(),l.isValid&&u&&l.change({maValue:l.value,maOldValue:r})})}},l.onChange=function(){var e;if(l.isMultiple){var a=l.selectedItem,n=[];if(l.hasAjax){if(n=c.data(),angular.equals(n,l.value))return;r=F(l.value)}else{r=F(l.value);for(var o=0;o<a.length;o++)e=M(a[o]),e&&n.push(e)}l.isTouched=!0,l.value=F(l.convertItemValue(n)),w(),t(function(){l.change({maValue:l.value,maOldValue:r})}),c.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"===l._type&&(e=l.selectedItem),l.hasAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.hasAjax&&l._itemValueField&&!i.isNullOrWhiteSpace(e))for(var u=0;u<l._items.length;u++)if(l.getItemValue(l._items[u])===e.toString()){e=l._items[u];break}if(i.isNullOrWhiteSpace(e)&&i.isNullOrWhiteSpace(l.value))return;if(l._itemValueField){var s=l.getItemValue(l.value);if(s&&s===l.getItemValue(e))return}else if(e===l.value)return;r=F(l.value),l.value=F(l.convertItemValue(e)),l.previousSelectedItem=e,w(),t(function(){l.change({maValue:l.value,maOldValue:r})})}};var C=function(){l.hasAjax&&c&&(c.opts.placeholder=l.value?"":l.placeholder,l.runInitSelection=!0,c.initSelection())};l.hasAjax||l.$watch("items",function(e){k(l._items,e)||(V(e),y(l.value),l.isAddMode||t(function(){var e,t;if(i.isNullOrWhiteSpace(l.value))c.data(null);else if(angular.isObject(l.value))if(l.isMultiple&&angular.isArray(l.value)){for(var a=[],n=0;n<l.value.length;n++)e=l.getItemValue(l.value[n]),t=angular.copy(M(e)||l.value[n]),t.text=l.getItemText(t),t[l._itemValueField]=e,t&&a.push(t);c.data(a)}else e=l.getItemValue(l.value),t=angular.copy(M(e)||l.value),t.text=l.getItemText(t),t[l._itemValueField]=e,c.data(t);else c.val(l.getItemValue(l.value))}))},!0),l.$watch("value",function(e,t){e!==t&&(C(),y(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,w(),O(e))}),l.$watch("isRequired",function(e,t){e!==t&&(S(),O(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.isEditor=function(){return!0},l.instance.toggleToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.toggleToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,O(l.isAddMode?l.text:l.value)},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),S(),t(function(){y(l.value),s=angular.element(a[0].querySelector(".select2-container")),c=s.data().select2,d=$('label[for="'+l.id+'"]'),o=angular.element(a[0].querySelector(".ma-button-toggle")),u=angular.element(a[0].querySelector(".ma-button-reset")),C(),d.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){N()}),l.isMultiple?(c.selection.on("mouseenter",function(){g=!0}),c.selection.on("mouseleave",function(){g=!1}),c.dropdown.on("mouseenter",function(){g=!0}),c.dropdown.on("mouseleave",function(){g=!1}),c.dropdown.on("click",function(){c.search.focus()})):c.addItemButton.on("click",function(e){l.$apply(function(){l.toggleMode("add",!0,!0)})}),o.focusout(function(e){j(e)}),u.focusout(function(e){j(e)}),o.mousedown(function(e){h=!0}),o.mouseup(function(e){h=!1}),u.mousedown(function(e){v=!0}),u.mouseup(function(e){v=!1}),l.init({maInstance:l.instance})})}}}])}();
