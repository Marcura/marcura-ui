...
!function(){angular.module("marcuraUI.components").provider("maTextBoxConfiguration",function(){this.$get=function(){return this}}).directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",changeWhenIsInvalid:"=",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"=",max:"=",min:"=",decimals:"=",reset:"&",defaultValue:"="},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text";"number"!==i&&"email"!==i||(i="text");var n="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return n},controller:["$scope","maTextBoxConfiguration",function(e,a){e.configuration={},e.decimals>=0?e.configuration.decimals=e.decimals:a.decimals>=0?e.configuration.decimals=a.decimals:e.configuration.decimals=2}],link:function(n,t,s){var o,l,u,r,d,c=angular.element(t[0].querySelector(".ma-text-box-value")),f=angular.element(t[0].querySelector(".ma-button-reset")),m=angular.element(t[0].querySelector(".ma-button-toggle-password")),v=[],g=n.isRequired,b=Number(n.changeTimeout),p=!0,h=n.trim!==!1,y=!1,x=null,V=n.configuration.decimals,w=void 0!==s.defaultValue,k=a.isNullOrUndefined(n.defaultValue)?"":n.defaultValue;"number"===n.type&&(k="number"==typeof n.defaultValue?n.defaultValue:null);var C=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==n.type&&h&&(e=e.trim()),u=e},T=function(){var e=c.val();return"number"===n.type?F(e):e},O=function(){n.isValid=!0,x=null;var e=c.val();if("number"===n.type&&(e=I(e)),v&&v.length)for(var a=0;a<v.length;a++)if(!v[a].validate(e)){n.isValid=!1,x=v[a];break}},N=function(i){if(E(i)){y=!0;var t=u;"number"!==n.type&&h&&(t=t.trim(),i=i.trim()),w&&(a.isNullOrUndefined(i)&&(i=k),a.isNullOrUndefined(t)&&(t=k)),n.value=i,C(i),e(function(){n.change({maValue:i,maOldValue:t})})}},E=function(e){e=a.isNullOrUndefined(e)?"":e;var i=a.isNullOrUndefined(u)?"":u,t=!1;return t="number"!==n.type&&h?i.trim()!==e.trim():i!==e},P=function(){return n.isTouched=!0,E(T())?(O(),void((n.isValid||n.changeWhenIsInvalid)&&N(T()))):void O()},F=function(e,i){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(I(e)),i||(e=parseFloat(e.toFixed(V))),isNaN(e)?null:e)},R=function(e){if(a.isNullOrWhiteSpace(e))return"";var i=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),n=e.replace(/(\.\d+)$/,""),t=n.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+t+i},I=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(/,/g,"")},q=function(e){if(a.isNullOrWhiteSpace(e))return e;var i=e;return"number"===n.type&&(e="number"==typeof e?e:Number(e),i=R(e.toFixed(V))),i},S=function(){var e=!1;v=n.validators?angular.copy(n.validators):[];for(var a=0;a<v.length;a++)if("IsNotEmpty"===v[a].name){e=!0;break}!e&&g&&v.unshift(i.isNotEmpty()),e&&(g=!0),"number"===n.type&&(v.push(i.isNumber(!0)),"number"==typeof n.min&&v.push(i.isGreaterOrEqual(n.min,!0)),"number"==typeof n.max&&v.push(i.isLessOrEqual(n.max,!0))),"email"===n.type&&v.push(i.isEmail(!0))};S(),n.isValueFocused=!1,n.isTouched=!1,n.canTogglePassword=!1,n.isPasswordVisible=!1,"password"===n.type&&(n.canTogglePassword=n.hasShowPasswordButton!==!1),n.isResetEnabled=function(){if(n.isDisabled)return!1;if("number"===n.type){var e=c.val();return""!==e&&!a.isNumber(e)||F(e,!0)!==k&&""!==e}return c.val()!==k},n.doReset=function(){C(T()),c.val(k)},n.onReset=function(){n.isDisabled||(n.doReset(),n.isTouched=!0,N(k),O(),c.focus(),e(function(){n.reset()}))},n.onFocus=function(e){"value"===e&&(n.isValueFocused=!0,"number"===n.type&&!a.isNullOrUndefined(n.value)&&n.isValid&&c.val(n.value.toFixed(V))),p&&(d=n.value,n.focus({maValue:n.value})),p=!1},c.focusout(function(e){D(e,"value")}),f.focusout(function(e){D(e)}),m.focusout(function(e){D(e)}),n.togglePassword=function(){n.isPasswordVisible=!n.isPasswordVisible,c[0].type=n.isPasswordVisible?"text":"password"},n.isTogglePasswordEnabled=function(){return!n.isDisabled&&""!==c.val()};var D=function(i,t){var s=angular.element(i.relatedTarget),o=c.val();p=n.canTogglePassword?s[0]!==c[0]&&s[0]!==m[0]&&s[0]!==f[0]:s[0]!==c[0]&&s[0]!==f[0],r&&e.cancel(r),"value"===t&&(w&&""===o.trim()&&(y=!0,n.value=k,c.val(q(k))),n.isResetEnabled()||s[0]!==f[0]||(p=!0),O(),n.isValid&&c.val(q(o))),a.safeApply(function(){n.isValueFocused=!1}),p&&(P(),a.safeApply(function(){n.blur({maValue:n.value,maOldValue:d,maHasValueChanged:d!==n.value})}))};n.onKeydown=function(e){if(e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val(),"number"===n.type)){if($.inArray(e.keyCode,[a.keyCode.backspace,a.keyCode["delete"],a.keyCode.home,a.keyCode.end,a.keyCode.period,a.keyCode.dash,a.keyCode.dash2])!==-1||37===e.keyCode||39===e.keyCode)return;(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()}},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var n=!1;l=angular.element(i.target).val(),o!==l&&(n=!0),n&&(r&&e.cancel(r),r=e(function(){P()},b))}}),e(function(){t.removeAttr("id"),c.attr("id",n.id)}),n.$watch("value",function(e,a){if(y)return void(y=!1);if(e!==a){E(e)&&(n.isTouched=!0);var i=c.prop("selectionStart");C(e),c.val(q(e)),O(),n.isValueFocused&&c.prop({selectionStart:i,selectionEnd:i})}});var U=function(e,a){if(e!==a){var i=T();S();for(var t=[],s=0;s<v.length;s++)"IsGreaterOrEqual"!==v[s].name&&"IsLessOrEqual"!==v[s].name||t.push(v[s]);if(t.length){for(!x||"IsGreaterOrEqual"!==x.name&&"IsLessOrEqual"!==x.name||(x=null,n.isValid=!0),s=0;s<t.length;s++)if(!t[s].validate(i)){n.isValid=!1,x=t[s];break}n.isValid||(n.isTouched=!0)}(n.isValid||n.changeWhenIsInvalid)&&N(i)}};n.$watch("max",function(e,a){U(e,a)}),n.$watch("min",function(e,a){U(e,a)}),w&&a.isNullOrUndefined(n.value)&&(n.value=k),c.val(q(n.value)),O(),C(n.value),n.instance&&(n.instance.isInitialized=!0,n.instance.validate=function(){n.isTouched=!0,O()},n.instance.isValid=function(){return n.isValid},n.instance.focus=function(){n.isValueFocused||c.focus()},n.instance.failedValidator=function(){return x},n.instance.clear=function(){n.doReset(),e(function(){n.isTouched=!1})})}}}])}();
