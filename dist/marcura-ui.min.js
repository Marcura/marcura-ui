...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","maDateConverter","maHelper","maValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",minDate:"=",maxDate:"="},replace:!0,template:function(){var e='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            ng-disabled="isDisabled"                            ng-focus="onFocus()"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"                            ng-blur="onBlur()"/><input class="ma-date-box-hours"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minutes" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return e},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(o,i){var s,d,l,u=null,r=o.configuration.displayFormat,c=o.configuration.format,m=o.configuration.timeZone,f=angular.element(i[0].querySelector(".ma-date-box-date")),v=angular.element(i[0].querySelector(".ma-date-box-hours")),y=angular.element(i[0].querySelector(".ma-date-box-minutes")),g=null,b=moment().utcOffset(m).utcOffset(),h=0,p=o.validators?angular.copy(o.validators):[],k=o.isRequired,x=a.parse(o.minDate),D=a.parse(o.maxDate),C=function(t){var n=null;g=t,t&&(n=moment(new Date),n.year(t.year()).month(t.month()).date(t.date()).hours(t.hours()).minutes(t.minutes()).seconds(0)),o.value=n?a.format(n,c,m):null,e(function(){o.change({maValue:o.value})})},T=function(e){return!(null===g&&null===e||g&&e&&0===g.diff(e))&&(o.isTouched=!0,!0)},w=function(e){var t=null;e&&e.date?(t=a.offsetUtc(e.date,b-e.offset),f.val(a.format(t,r)),v.val(a.format(t,"HH")),y.val(a.format(t,"mm")),s||(s=f.val())):(f.val(""),v.val("00"),y.val("00")),V(t)},V=function(e){u&&u.setDate(e?e.toDate():null,!0)},F=function(e){if(!e)return null;var t=null;if(o.parser)t=o.parser(e);else if(t=a.parse(e,o.culture),!t)return null;return{date:moment(t.date),offset:t.offset}},K=function(e){var a=moment(e);return moment([a.year(),a.month(),a.date(),Number(v.val()),Number(y.val()),0])},R=function(){h=b},q=function(){u=new Pikaday({field:angular.element(i[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",minDate:x?x.date:null,maxDate:D?D.date:null,onSelect:function(){var t=a.offsetUtc(u.getDate());e(function(){o.isValid=!0}),o.hasTime&&(t=K(t),R()),T(t)&&C(t)}}),V(g)},E=function(){u&&u.destroy()},B=function(e){if(o.isValid=!0,p&&p.length)for(var a=0;a<p.length;a++)if(!p[a].method(e)){o.isValid=!1;break}},Z=function(){for(var e=!1,a=0;a<p.length;a++)if("IsNotEmpty"===p[a].name){e=!0;break}!e&&k&&p.unshift(n.isNotEmpty()),e&&(k=!0),x&&p.push(n.isGreaterThanOrEqual(x.date)),D&&p.push(n.isLessThanOrEqual(D.date))};if(Z(),o.isFocused=!1,o.isValid=!0,o.isTouched=!1,o.isResetEnabled=function(){return!o.isDisabled&&(f.val()||"00"!==v.val()||"00"!==y.val())},o.onFocus=function(){o.isFocused=!0},o.onBlur=function(){o.isFocused=!1,o.isTouched=!0;var e=f.val().trim(),t=""===e,n=Number(v.val()),i=Number(y.val()),d={date:null,offset:0};return n>=0&&n<=23&&i>=0&&i<=59?(d=F(e)||d,d.offset=h,t?(B(d.date),void(o.isValid&&(w(),C()))):d.date?(d.date&&(o.hasTime||s===e)&&(d.date=K(d.date),d.date=a.offsetUtc(d.date,-(b-h))),B(d.date),T(d.date)?(d.date&&w(d),void(o.isValid&&C(d.date))):void w(d)):void(o.isValid=!1)):void(o.isValid=!1)},o.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(d=angular.element(e.target).val())},o.onKeyup=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(l=angular.element(e.target).val(),d!==l&&(o.isTouched=!0,R()))},o.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},o.onReset=function(){o.isDisabled||(g=null,o.isValid=!k,o.isTouched=!0,C(),w(),f.focus())},o.value){var M={date:null,offset:0};if(M=a.parse(o.value,o.culture)||M,M.date=a.offsetUtc(M.date),!M.date)return;w(M),g=M.date,h=M.offset}e(function(){o.isDisabled||q(),i.removeAttr("id"),f.attr("id",o.id)}),o.$watch("value",function(e,a){if(null!==e||null!==a){var t={date:null,offset:0};if(t=F(e)||t,null===t.date&&(g=null,w(null)),!T(t.date))return void w(t);w(t),g=t.date,h=t.offset}}),o.$watch("isDisabled",function(e,a){e!==a&&(o.isDisabled?E():q())}),o.instance&&(o.instance.validate=function(){return o.isTouched=!0,k&&!o.value?void(o.isValid=!1):void B(F(o.value))},o.instance.isValid=function(){return o.isValid})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maRadioBox",["maHelper","$timeout","$sce",function(e,i,t){return{restrict:"E",scope:{item:"=",itemTemplate:"=",itemTextField:"@",itemValueField:"@",value:"=",isDisabled:"=",hideText:"=",change:"&",size:"@"},replace:!0,template:function(){var e='            <div class="ma-radio-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-radio-box-is-checked\': isChecked(),                    \'ma-radio-box-is-disabled\': isDisabled,                    \'ma-radio-box-has-text\': hasText(),                    \'ma-radio-box-is-focused\': isFocused                }">                <span class="ma-radio-box-text" ng-bind-html="getItemText()"></span>                <div class="ma-radio-box-inner"></div>                <i class="ma-radio-box-icon" ng-show="isChecked()"></i>            </div>';return e},link:function(a,s,n){var l="&nbsp;",o=null,u=!a.itemTextField&&!a.itemValueField,r=function(){a.isDisabled?s.removeAttr("tabindex"):s.attr("tabindex","0")},d=function(){var e=null,i=a.$parent,t=n.value;for(t.indexOf(".")!==-1&&(o=t.split("."),t=o[0]);i&&!e;)i.hasOwnProperty(t)?e=i:i=i.$parent;return e},m=d();a._size=a.size?a.size:"xs",a.cssClass=" ma-radio-box-"+a._size,a.isFocused=!1,a.getItemText=function(){if(a.hideText)return l;var e;return a.itemTemplate?e=a.itemTemplate(a.item):u?e=a.item:a.itemTextField&&(e=a.item[a.itemTextField]),angular.isString(e)&&e||(e=l),t.trustAsHtml(e)},a.hasText=function(){return a.getItemText()!==l},a.isChecked=function(){return u?a.item===a.value:!!a.itemValueField&&(a.item&&a.value&&a.item[a.itemValueField]===a.value[a.itemValueField])},a.onChange=function(){if(!a.isDisabled){var e,t=a.value;if(a.value=a.item,m&&o){e=m;for(var s=0;s<o.length;s++)e=e[o[s]];e=a.item}else e=m[n.value],m[n.value]=a.item;var l=!0;l=u?t!==a.item:a.itemValueField?t&&t[a.itemValueField]!==a.item[a.itemValueField]:t&&JSON.stringify(t)===JSON.stringify(a.item),l&&i(function(){a.change({maValue:a.item,maOldValue:t})})}},a.onFocus=function(){a.isDisabled||(a.isFocused=!0)},a.onBlur=function(){a.isDisabled||(a.isFocused=!1)},a.onKeypress=function(i){i.keyCode===e.keyCode.space&&(i.preventDefault(),a.isDisabled||a.isChecked()||a.onChange())},a.$watch("isDisabled",function(e,i){e!==i&&(e&&(a.isFocused=!1),r())}),r()}}}])}();
...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,l){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.value&&e.value[e.itemValueField]){var n=angular.copy(e.value);n.text=e.itemTemplate?e.itemTemplate(n):n[e.itemTextField],n.id=n[e.itemValueField],e.previousSelectedItem=n,l(n)}else l();t.runs++})}],link:function(l,n){var o,s,a,d,u,c=angular.element(n[0].querySelector(".ma-select-box-text")),r=null,m=!0,f=!1,g=l.showAddItemTooltip!==!1,p=l.validators?angular.copy(l.validators):[],x=l.isRequired,v=!1;l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.formatItem=l.itemTemplate||function(e){return e?l.itemTextField?e[l.itemTextField]:e.toString():""},l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.isAjax=angular.isObject(l.ajax);var h=function(e){if(!angular.isArray(l.items))return!1;for(var t=l.itemValueField&&e[l.itemValueField],i=0;i<l.items.length;i++)if(t){if(l.items[i][l.itemValueField]===e[l.itemValueField])return!0}else if(l.items[i]===e)return!0;return!1},b=function(e){if(!e)return null;if(!l.itemTextField)return e;if(angular.isArray(l.items))for(var t=0;t<l.items.length;t++)if(l.items[t][l.itemValueField].toString()===e.toString())return l.items[t];return null},F=function(e){if(!l.itemTextField)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},A=function(e){l.canAddItem&&e&&(l.isAddMode=!h(e)),T(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,r=e,l.toggleMode("add")):(e?l.isAjax||(l.itemValueField&&e[l.itemValueField]?l.selectedItem=e[l.itemValueField].toString():"string"==typeof e&&(l.selectedItem=e)):l.selectedItem=null,l.previousSelectedItem=e,l.toggleMode("select"))},I=function(e,i){var n=angular.element(e.relatedTarget),a=angular.element(d.dropdown[0].querySelector(".select2-input"));l.isTextFocused=!1,"text"===i?(f=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=F(l.text)}else{if(l.value===l.text)return;e=l.text}T(e),l.isValid&&(l.value=e,r=l.value,l.isValid&&t(function(){l.change({maValue:l.value})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),m=l.canAddItem?!f&&n[0]!==o[0]&&n[0]!==s[0]&&n[0]!==c[0]&&n[0]!==d.focusser[0]&&n[0]!==a[0]:!f&&n[0]!==s[0]&&n[0]!==c[0]&&n[0]!==d.focusser[0]&&n[0]!==a[0],m&&l.blur({item:l.value}),f=!1},T=function(e){if(l.isValid=!0,p&&p.length)for(var t=0;t<p.length;t++)if(!p[t].method(e)){l.isValid=!1;break}},S=function(){l.isAddMode?(c.focus(),l.isTextFocused=!0):a.select2("focus")};l.isResetEnabled=function(){return!l.isDisabled&&(l.isAddMode?!i.isNullOrWhiteSpace(l.text):!i.isNullOrUndefined(l.value))},l.onReset=function(){l.value=null,S(),t(function(){l.change({maValue:l.value})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),m&&l.focus({item:l.value}),m=!1},c.focusout(function(e){I(e,"text")}),l.getAddItemTooltip=function(){return g?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getItemValue=function(e){return l.itemValueField?e[l.itemValueField].toString():e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(a&&a.select2("close"),l.previousSelectedItem=b(l.selectedItem),l.value=r,l.value&&(l.text="string"==typeof l.value?l.value:l.value[l.itemTextField])):(r=F(l.text),l.value=l.previousSelectedItem),i||t(function(){l.change({maValue:l.value}),S()})}},l.onChange=function(){var e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem;if(l.isAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.isAjax&&l.itemValueField&&!i.isNullOrWhiteSpace(e))for(var n=0;n<l.items.length;n++)if(l.items[n][l.itemValueField].toString()===e.toString()){e=l.items[n];break}if(e||l.value){if(l.itemValueField){if(l.value&&l.value[l.itemValueField]&&l.value[l.itemValueField].toString()===e[l.itemValueField].toString())return}else if(e===l.value)return;l.value=e,l.previousSelectedItem=e,t(function(){l.change({maValue:e})})}},l.$watch("value",function(e,t){e!==t&&A(e)}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,T(e))}),l.instance&&(l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,T(l.value)});for(var V={name:"IsNotEmpty",method:function(e){return!i.isNullOrWhiteSpace(e)&&!!(l.isAjax||l.isAddMode||h(e))}},M=0;M<p.length;M++)if("IsNotEmpty"===p[M].name){v=!0,p[M]=V;break}!v&&x&&p.unshift(V),v&&(x=!0),t(function(){A(l.value),a=angular.element(n[0].querySelector(".select2-container")),d=a.data().select2,u=$('label[for="'+l.id+'"]'),o=angular.element(n[0].querySelector(".ma-button-switch")),s=angular.element(n[0].querySelector(".ma-button-reset")),u.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){S()}),d.focusser.on("focus",function(){l.onFocus("select")}),d.focusser.on("focusout",function(e){I(e,"select")}),d.dropdown.on("focus",".select2-input",function(){f=!0,l.onFocus()}),d.dropdown.on("focusout",".select2-input",function(e){I(e,"select")}),o.focusout(function(e){I(e)}),s.focusout(function(e){I(e)}),d.dropdown.on("mouseenter",".select2-result",function(){f=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){f=!0})})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maTextArea",["$timeout","$window","maHelper","maValidators",function(e,t,a,i){return{restrict:"E",scope:{id:"@",value:"=",isDisabled:"=",fitContentHeight:"=",isResizable:"=",isRequired:"=",validators:"=",instance:"=",updateOn:"@"},replace:!0,template:function(){var e='            <div class="ma-text-area"                ng-class="{                    \'ma-text-area-is-disabled\': isDisabled,                    \'ma-text-area-is-focused\': isFocused,                    \'ma-text-area-fit-content-height\': fitContentHeight,                    \'ma-text-area-is-invalid\': !isValid,                    \'ma-text-area-is-touched\': isTouched                }">                <textarea class="ma-text-area-value"                    type="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-keyup="onKeyup($event)"                    ng-disabled="isDisabled">                </textarea>            </div>';return e},link:function(n,r){var o,l,u=angular.element(r[0].querySelector(".ma-text-area-value")),d=n.validators?angular.copy(n.validators):[],s=n.isRequired,g=!1,p=n.updateOn?n.updateOn:"input",h=function(){var e=t.getComputedStyle(u[0],null),a={},i=parseInt(e.getPropertyValue("padding-top"))+parseInt(e.getPropertyValue("padding-bottom")),n=parseInt(e.getPropertyValue("padding-left"))+parseInt(e.getPropertyValue("padding-right")),r=parseInt(e.getPropertyValue("border-top-width"))+parseInt(e.getPropertyValue("border-bottom-width")),o=parseInt(e.getPropertyValue("border-left-width"))+parseInt(e.getPropertyValue("border-right-width"));return a.width=parseInt(t.getComputedStyle(u[0],null).getPropertyValue("width"))-n,a.height=parseInt(t.getComputedStyle(u[0],null).getPropertyValue("height"))-i,a.paddingHeight=i,a.paddingWidth=n,a.borderHeight=r,a.borderWidth=o,a.lineHeight=e.getPropertyValue("line-height"),a.font=e.getPropertyValue("font-style")+" "+e.getPropertyValue("font-variant")+" "+e.getPropertyValue("font-weight")+" "+e.getPropertyValue("font-size")+" "+e.getPropertyValue("font-height")+" "+e.getPropertyValue("font-family"),a},c=function(){if(n.fitContentHeight){var e=h(),t=a.getTextHeight(u.val(),e.font,e.width+"px",e.lineHeight),i=t+e.paddingHeight+e.borderHeight;i<40&&(i=30),u[0].style.height=i+"px",r[0].style.height=i+"px"}},f=function(){if(n.isValid=!0,d&&d.length)for(var e=0;e<d.length;e++)if(!d[e].method(u.val())){n.isValid=!1;break}};n.isFocused=!1,n.isTouched=!1;for(var y=0;y<d.length;y++)if("IsNotEmpty"===d[y].name){g=!0;break}!g&&s&&d.unshift(i.isNotEmpty()),g&&(s=!0),n.onFocus=function(){n.isFocused=!0},n.onBlur=function(){n.isFocused=!1,n.isTouched=!0,n.isValid&&"blur"===p&&(n.value=u.val()),f()},n.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},n.onKeyup=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(l=angular.element(e.target).val(),o!==l&&(n.isTouched=!0))},u.on("input",function(e){f(),c(),n.isValid&&"input"===p&&n.$apply(function(){n.value=u.val()})}),angular.element(t).on("resize",function(){c()}),e(function(){if(c(),n.isResizable===!1&&u.css("resize","none"),r.removeAttr("id"),u.attr("id",n.id),n.fitContentHeight){var t=$(r[0]).closest(".ng-hide[ng-show]");if(1===t.length){var a=t.scope();a.$watch(t.attr("ng-show"),function(t){t&&e(function(){c()})})}}}),n.$watch("value",function(e,t){e!==t&&(n.isValid=!0,n.isTouched=!1,u.val(e),c())}),u.val(n.value),f(),n.instance&&(n.instance.isValid=function(){return n.isValid})}}}])}();
