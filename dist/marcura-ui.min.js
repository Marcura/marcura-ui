...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,s){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"="},replace:!0,template:function(e,a){var s="password"===a.type?"password":"text",t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+s+'" id="{{id}}"                    type="text"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return t},link:function(t,o){var i,n,l,u,d,r=angular.element(o[0].querySelector(".ma-text-box-value")),c=angular.element(o[0].querySelector(".ma-button-reset")),g=angular.element(o[0].querySelector(".ma-button-toggle-password")),f=t.validators?angular.copy(t.validators):[],m=t.isRequired,b=!1,v=Number(t.changeTimeout),p=!0,w=function(){t.isValid=!0;var e=r.val();if(f&&f.length)for(var a=0;a<f.length;a++)if(!f[a].validate(e)){t.isValid=!1;break}},h=function(a){if(l!==a){var s=l;t.value=a,l=a,e(function(){t.change({maValue:a,maOldValue:s})})}},x=function(){var e=r.val();return(!a.isNullOrUndefined(l)||""!==e)&&l!==e},y=function(){return t.isTouched=!0,x()?(w(),void(t.isValid&&h(r.val()))):void w()};t.isValueFocused=!1,t.isTouched=!1,t.canTogglePassword=!1,t.isPasswordVisible=!1,"password"===t.type&&(t.canTogglePassword=t.hasShowPasswordButton!==!1);for(var V=0;V<f.length;V++)if("IsNotEmpty"===f[V].name){b=!0;break}!b&&m&&f.unshift(s.isNotEmpty()),b&&(m=!0),t.isResetEnabled=function(){return!t.isDisabled&&""!==r.val()},t.onReset=function(){t.isDisabled||(l=r.val(),t.isTouched=!0,h(null),w(),r.focus())},t.onFocus=function(e){"value"===e&&(t.isValueFocused=!0),p&&(d=t.value,t.focus({maValue:t.value})),p=!1},r.focusout(function(e){P(e)}),c.focusout(function(e){P(e)}),g.focusout(function(e){P(e)}),t.togglePassword=function(){t.isPasswordVisible=!t.isPasswordVisible,r[0].type=t.isPasswordVisible?"text":"password"},t.isTogglePasswordEnabled=function(){return!t.isDisabled&&""!==r.val()};var P=function(s){var o=angular.element(s.relatedTarget);p=t.canTogglePassword?o[0]!==r[0]&&o[0]!==g[0]&&o[0]!==c[0]:o[0]!==r[0]&&o[0]!==c[0],u&&e.cancel(u),a.safeApply(function(){t.isValueFocused=!1}),p&&(y(),t.blur({maValue:t.value,maOldValue:d,maHasValueChanged:d!==t.value}))};t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(i=angular.element(e.target).val())},r.on("input",function(s){if(s.keyCode!==a.keyCode.tab&&s.keyCode!==a.keyCode.shift){var t=!1;n=angular.element(s.target).val(),i!==n&&(t=!0),t&&(u&&e.cancel(u),u=e(function(){y()},v))}}),e(function(){o.removeAttr("id"),r.attr("id",t.id)}),t.$watch("value",function(e,a){if(e!==a){var s=r.prop("selectionStart");l=e,r.val(e),w(),t.isValueFocused&&r.prop({selectionStart:s,selectionEnd:s})}}),r.val(t.value),w(),l=t.value,t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,w()},t.instance.isValid=function(){return t.isValid})}}}])}();