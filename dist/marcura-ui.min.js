...
!function(){angular.module("marcuraUI.components").directive("maRadioBox",["maHelper","$timeout","$sce",function(e,s,a){return{restrict:"E",scope:{text:"=",value:"=",selectedValue:"=",isDisabled:"=",change:"&",size:"@",comparer:"="},replace:!0,template:function(){var e='            <div class="ma-radio-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-radio-box-is-checked\': isChecked(),                    \'ma-radio-box-is-disabled\': isDisabled,                    \'ma-radio-box-has-text\': hasText,                    \'ma-radio-box-is-focused\': isFocused                }">                <span class="ma-radio-box-text" ng-bind-html="_text"></span>                <div class="ma-radio-box-inner"></div>                <i class="ma-radio-box-icon" ng-show="isChecked()"></i>            </div>';return e},link:function(i,n,t){var o=null,c=function(){i.isDisabled?n.removeAttr("tabindex"):n.attr("tabindex","0")},l=function(){var e=null,s=i.$parent,a=t.selectedValue;for(a.indexOf(".")!==-1&&(o=a.split("."),a=o[0]);s&&!e;)s.hasOwnProperty(a)?e=s:s=s.$parent;return e},r=l();i._size=i.size?i.size:"xs",i.cssClass=" ma-radio-box-"+i._size,i.hasText=!!i.text,i.isFocused=!1,i._text=a.trustAsHtml(i.text||"&nbsp;"),i.isChecked=function(){return i.comparer?i.comparer(i.value,i.selectedValue):JSON.stringify(i.value)===JSON.stringify(i.selectedValue)},i.onChange=function(){if(!i.isDisabled){var e;if(i.selectedValue=i.value,r&&o){e=r;for(var a=0;a<o.length;a++)e=e[o[a]];e=i.value}else e=r[t.selectedValue],r[t.selectedValue]=i.value;s(function(){i.change({value:i.value})})}},i.onFocus=function(){i.isDisabled||(i.isFocused=!0)},i.onBlur=function(){i.isDisabled||(i.isFocused=!1)},i.onKeypress=function(s){s.keyCode===e.keyCode.space&&(s.preventDefault(),i.isDisabled||i.isChecked()||i.onChange())},i.$watch("isDisabled",function(e,s){e!==s&&(e&&(i.isFocused=!1),c())}),c()}}}])}();
