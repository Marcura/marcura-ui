...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@"},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text",t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    type="text"                    placeholder="{{placeholder}}"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return t},link:function(t,n){var s,o,l,u,c,d=angular.element(n[0].querySelector(".ma-text-box-value")),r=t.validators?angular.copy(t.validators):[],v=t.isRequired,m=!1,f=Number(t.changeTimeout),b=function(){t.isValid=!0;var e=d.val();if(r&&r.length)for(var a=0;a<r.length;a++)if(!r[a].validate(e)){t.isValid=!1;break}},p=function(a){if(l!==a){var i=l;t.value=a,l=a,e(function(){t.change({maValue:a,maOldValue:i})})}},h=function(){var e=d.val();return(!a.isNullOrUndefined(l)||""!==e)&&l!==e},x=function(){return t.isTouched=!0,h()?(b(),void(t.isValid&&p(d.val()))):void b()};t.isFocused=!1,t.isTouched=!1;for(var g=0;g<r.length;g++)if("IsNotEmpty"===r[g].name){m=!0;break}!m&&v&&r.unshift(i.isNotEmpty()),m&&(v=!0),t.isResetEnabled=function(){return!t.isDisabled&&""!==d.val()},t.onReset=function(){t.isDisabled||(l=d.val(),t.isTouched=!0,p(null),b(),d.focus())},t.onFocus=function(){t.isFocused=!0,c=t.value,t.focus({maValue:t.value})},t.onBlur=function(){u&&e.cancel(u),t.isFocused=!1,x(),t.blur({maValue:t.value,maOldValue:c,maHasValueChanged:c!==t.value})},t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(s=angular.element(e.target).val())},d.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var t=!1;o=angular.element(i.target).val(),s!==o&&(t=!0),t&&(u&&e.cancel(u),u=e(function(){x()},f))}}),e(function(){n.removeAttr("id"),d.attr("id",t.id)}),t.$watch("value",function(e,a){if(e!==a){var i=d.prop("selectionStart");l=e,d.val(e),b(),t.isFocused&&d.prop({selectionStart:i,selectionEnd:i})}}),d.val(t.value),b(),l=t.value,t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,b()},t.instance.isValid=function(){return t.isValid})}}}])}();