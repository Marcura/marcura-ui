...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","maDateConverter","maHelper","maValidators",function(e,t,a,n){return{restrict:"E",scope:{id:"@",date:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",isResettable:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",minDate:"=",maxDate:"="},replace:!0,template:function(){var e='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !_isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': _isResettable,                        \'ma-date-box-is-reset-disabled\': _isResettable && !isDisabled && !isResetEnabled()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            ng-disabled="isDisabled"                            ng-focus="onFocus()"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"                            ng-blur="onBlur()"/><input class="ma-date-box-hours"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minutes" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="_isResettable" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return e},controller:["$scope","maDateBoxConfiguration",function(e,t){e.configuration={},e.configuration.displayFormat=(e.displayFormat||t.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||t.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||t.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,d,l,u=null,r=i.configuration.displayFormat,c=i.configuration.format,m=i.configuration.timeZone,f=angular.element(o[0].querySelector(".ma-date-box-date")),y=angular.element(o[0].querySelector(".ma-date-box-hours")),b=angular.element(o[0].querySelector(".ma-date-box-minutes")),v=null,g=moment().utcOffset(m).utcOffset(),h=0,p=i.validators?angular.copy(i.validators):[],k=i.isRequired,x=t.parse(i.minDate),D=t.parse(i.maxDate),T=function(a){var n=null;a&&(n=moment(new Date),n.year(a.year()).month(a.month()).date(a.date()).hours(a.hours()).minutes(a.minutes()).seconds(0)),i.date=n?t.format(n,c,m):null,e(function(){i.change({date:i.date})})},C=function(e){return!(null===v&&null===e||v&&e&&0===v.diff(e))&&(i.isTouched=!0,!0)},w=function(e,a){var n=null;e&&e.date?(n=t.offsetUtc(e.date,g-e.offset),f.val(t.format(n,r)),y.val(t.format(n,"HH")),b.val(t.format(n,"mm")),s||(s=f.val())):(f.val(""),y.val("00"),b.val("00")),_(n)},_=function(e){u&&u.setDate(e?e.toDate():null,!0)},V=function(e){if(!e)return null;var a=null;if(i.parser)a=i.parser(e);else if(a=t.parse(e,i.culture),!a)return null;return{date:moment(a.date),offset:a.offset}},F=function(e){var t=moment(e);return moment([t.year(),t.month(),t.date(),Number(y.val()),Number(b.val()),0])},R=function(){h=g},K=function(){u=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",minDate:x?x.date:null,maxDate:D?D.date:null,onSelect:function(){var a=t.offsetUtc(u.getDate());e(function(){i._isValid=!0}),i.hasTime&&(a=F(a),R()),C(a)&&(v=a,T(a))}}),_(v)},q=function(){u&&u.destroy()},E=function(e){if(p&&p.length)for(var t=0;t<p.length;t++)if(!p[t].method(e)){i._isValid=!1;break}},B=function(){for(var e=!1,t=0;t<p.length;t++)if("IsNotEmpty"===p[t].name){e=!0;break}!e&&k&&p.unshift(n.isNotEmpty()),e&&(k=!0),x&&p.push(n.isGreaterThanOrEqual(x.date)),D&&p.push(n.isLessThanOrEqual(D.date))};if(B(),i._isResettable=i.isResettable!==!1,i.isFocused=!1,i._isValid=!0,i.isTouched=!1,i.isResetEnabled=function(){return!i.isDisabled&&(f.val()||"00"!==y.val()||"00"!==b.val())},i.onFocus=function(){i.isFocused=!0},i.onBlur=function(){i.isFocused=!1;var e=f.val().trim(),a=""===e,n=Number(y.val()),o=Number(b.val()),d={date:null,offset:0};return n>=0&&n<=23&&o>=0&&o<=59?(d=V(e)||d,d.offset=h,!a&&!d.date||a&&i.isTouched&&k?void(i._isValid=!1):(d.date&&(i.hasTime||!i.isTouched&&s===e)&&(d.date=F(d.date),d.date=t.offsetUtc(d.date,-(g-h))),C(d.date)?(d.date&&(w(d),v=d.date),p&&p.length&&(i._isValid=!0,E(d.date)),void(i._isValid&&T(d.date))):(w(d),i._isValid=!0,void E(d.date)))):void(i._isValid=!1)},i.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(d=angular.element(e.target).val())},i.onKeyup=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(l=angular.element(e.target).val(),d!==l&&(i.isTouched=!0,R()))},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[a.keyCode.backspace,a.keyCode.tab,a.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(v=null,k?(i._isValid=!1,w()):T(),i.isTouched=!0,f.focus())},i.date){var Z={date:null,offset:0};if(Z=t.parse(i.date,i.culture)||Z,Z.date=t.offsetUtc(Z.date),!Z.date)return;w(Z),v=Z.date,h=Z.offset}e(function(){i.isDisabled||K(),o.removeAttr("id"),f.attr("id",i.id)}),i.$watch("date",function(e,t){if(null!==e||null!==t){var a={date:null,offset:0};if(a=V(e)||a,null===a.date&&(v=null,w(null)),!C(a.date))return void w(a);w(a),v=a.date,h=a.offset}}),i.$watch("isDisabled",function(e,t){e!==t&&(i.isDisabled?q():K())}),i.instance&&(i.instance.validate=function(){return i.isTouched=!0,k&&!i.date?void(i._isValid=!1):void E(V(i.date))},i.instance.isValid=function(){return i._isValid})}}}])}();
...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),o="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return o+=l?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',o+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,l){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.value&&e.value[e.itemValueField]){var o=angular.copy(e.value);o.text=e.itemTemplate?e.itemTemplate(o):o[e.itemTextField],o.id=o[e.itemValueField],e.previousSelectedItem=o,l(o)}else l();t.runs++})}],link:function(o,n){var s,a,d,u,c,r=angular.element(n[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=o.showAddItemTooltip!==!1,x=o.validators?angular.copy(o.validators):[],v=o.isRequired,h=!1;o.previousSelectedItem=o.previousSelectedItem||null,o.isAddMode=!1,o.formatItem=o.itemTemplate||function(e){return e?o.itemTextField?e[o.itemTextField]:e.toString():""},o.isTextFocused=!1,o.isValid=!0,o.isTouched=!1,o.isAjax=angular.isObject(o.ajax);var b=function(e){if(!angular.isArray(o.items))return!1;for(var t=o.itemValueField&&e[o.itemValueField],i=0;i<o.items.length;i++)if(t){if(o.items[i][o.itemValueField]===e[o.itemValueField])return!0}else if(o.items[i]===e)return!0;return!1},F=function(e){if(!e)return null;if(!o.itemTextField)return e;if(angular.isArray(o.items))for(var t=0;t<o.items.length;t++)if(o.items[t][o.itemValueField].toString()===e.toString())return o.items[t];return null},A=function(e){if(!o.itemTextField)return e;if(e){var t={};return t[o.itemTextField]=e,t}return null},I=function(e){o.canAddItem&&e&&(o.isAddMode=!b(e)),S(e),o.isAddMode?(e?o.itemTextField&&e[o.itemTextField]?o.text=e[o.itemTextField].toString():o.text=e:o.text=null,m=e,o.toggleMode("add")):(e?o.isAjax||(o.itemValueField&&e[o.itemValueField]?o.selectedItem=e[o.itemValueField].toString():"string"==typeof e&&(o.selectedItem=e)):o.selectedItem=null,o.previousSelectedItem=e,o.toggleMode("select"))},T=function(e,i){var l=angular.element(e.relatedTarget),n=angular.element(u.dropdown[0].querySelector(".select2-input"));o.isTextFocused=!1,"text"===i?(g=!1,o.$apply(function(){if(o.isTouched=!0,o.itemTextField){if(o.value&&o.value[o.itemTextField]===o.text)return;o.value=A(o.text)}else{if(o.value===o.text)return;o.value=o.text}m=o.value,o.isValid&&t(function(){o.change({maValue:o.value})})})):"select"===i&&o.$apply(function(){o.isTouched=!0}),f=o.canAddItem?!g&&l[0]!==s[0]&&l[0]!==a[0]&&l[0]!==r[0]&&l[0]!==u.focusser[0]&&l[0]!==n[0]:!g&&l[0]!==a[0]&&l[0]!==r[0]&&l[0]!==u.focusser[0]&&l[0]!==n[0],f&&o.blur({item:o.value}),g=!1},S=function(e){if(o.isValid=!0,x&&x.length)for(var t=0;t<x.length;t++)if(!x[t].method(e)){o.isValid=!1;break}},V=function(){o.isAddMode?(r.focus(),o.isTextFocused=!0):d.select2("focus")};o.isResetEnabled=function(){return!o.isDisabled&&(o.isAddMode?!i.isNullOrWhiteSpace(o.text):!i.isNullOrUndefined(o.value))},o.onReset=function(){o.value=null,V(),t(function(){o.change({maValue:o.value})})},o.onFocus=function(e){"text"===e&&(o.isTextFocused=!0),f&&o.focus({item:o.value}),f=!1},r.focusout(function(e){T(e,"text")}),o.getAddItemTooltip=function(){return p?o.isAddMode?"Back to the list":o.addItemTooltip?o.addItemTooltip:"Add new item":""},o.getItemValue=function(e){return o.itemValueField?e[o.itemValueField].toString():e},o.toggleMode=function(e){if(o.canAddItem&&!(o.isAddMode&&"add"===e||!o.isAddMode&&"select"===e)){var i=!1;"select"===e?(o.isAddMode=!1,i=!0):"add"===e?(o.isAddMode=!0,i=!0):o.isAddMode=!o.isAddMode,o.isAddMode?(d&&d.select2("close"),o.previousSelectedItem=F(o.selectedItem),o.value=m,o.value&&(o.text="string"==typeof o.value?o.value:o.value[o.itemTextField])):(m=A(o.text),o.value=o.previousSelectedItem),i||t(function(){o.change({maValue:o.value}),V()})}},o.onChange=function(){var e=i.isJson(o.selectedItem)?JSON.parse(o.selectedItem):o.selectedItem;if(o.isAjax){if(e===o.previousSelectedItem)return;if(!angular.isObject(e))return}if(!o.isAjax&&o.itemValueField&&!i.isNullOrWhiteSpace(e))for(var l=0;l<o.items.length;l++)if(o.items[l][o.itemValueField].toString()===e.toString()){e=o.items[l];break}if(e||o.value){if(o.itemValueField){if(o.value&&o.value[o.itemValueField]&&o.value[o.itemValueField].toString()===e[o.itemValueField].toString())return}else if(e===o.value)return;o.value=e,o.previousSelectedItem=e,t(function(){o.change({maValue:e})})}},o.$watch("value",function(e,t){e!==t&&I(e)}),o.$watch("text",function(e,t){e!==t&&(o.isTouched=!0,S(e))}),o.instance&&(o.instance.switchToSelectMode=function(){o.isAddMode&&o.toggleMode("select")},o.instance.switchToAddMode=function(){o.isAddMode||o.toggleMode("add")},o.instance.isValid=function(){return o.isValid});for(var M=0;M<x.length;M++)if("IsNotEmpty"===x[M].name){h=!0;break}!h&&v&&x.unshift(l.isNotEmpty()),h&&(v=!0),t(function(){I(o.value),d=angular.element(n[0].querySelector(".select2-container")),u=d.data().select2,c=$('label[for="'+o.id+'"]'),s=angular.element(n[0].querySelector(".ma-button-switch")),a=angular.element(n[0].querySelector(".ma-button-reset")),c.length>0&&$(e).on("click",'label[for="'+o.id+'"]',function(){V()}),u.focusser.on("focus",function(){o.onFocus("select")}),u.focusser.on("focusout",function(e){T(e,"select")}),u.dropdown.on("focus",".select2-input",function(){g=!0,o.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),s.focusout(function(e){T(e)}),a.focusout(function(e){T(e)}),u.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
