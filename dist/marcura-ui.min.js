...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getOptionValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.getItemValue=function(t){if(!t||!e.itemValueField)return null;for(var l=e.itemValueField.split("."),n=t[l[0]],o=1;o<l.length;o++)n=n[l[o]];return i.isNullOrUndefined(n)?null:n.toString()},e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,l){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.getItemValue(e.value)){var n=angular.copy(e.value);n.text=e.itemTemplate?e.itemTemplate(n):n[e.itemTextField],n.id=e.getItemValue(n),e.previousSelectedItem=n,l(n)}else l();t.runs++})}],link:function(l,n){var o,a,s,u,d,c,r=angular.element(n[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=l.showAddItemTooltip!==!1,v=l.validators?angular.copy(l.validators):[],x=l.isRequired,h=!1;l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.formatItem=l.itemTemplate||function(e){return e?l.itemTextField?e[l.itemTextField]:e.toString():""},l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.isAjax=angular.isObject(l.ajax);var b=function(e){if(!angular.isArray(l.items))return!1;for(var t=null!==l.getItemValue(e),i=0;i<l.items.length;i++)if(t){if(l.getItemValue(l.items[i])===l.getItemValue(e))return!0}else if(l.items[i]===e)return!0;return!1},I=function(e){if(!e)return null;if(!l.itemTextField)return e;if(angular.isArray(l.items))for(var t=0;t<l.items.length;t++)if(l.getItemValue(l.items[t])===e.toString())return l.items[t];return null},A=function(e){if(!l.itemTextField)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},V=function(e){l.canAddItem&&e&&(l.isAddMode=!b(e)),F(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(e?l.isAjax||(null!==l.getItemValue(e)?l.selectedItem=l.getItemValue(e):"string"==typeof e&&(l.selectedItem=e)):l.selectedItem=null,l.previousSelectedItem=e,l.toggleMode("select"))},T=function(e,i){var n=angular.element(e.relatedTarget),s=angular.element(u.dropdown[0].querySelector(".select2-input"));l.isTextFocused=!1,"text"===i?(g=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=A(l.text)}else{if(l.value===l.text)return;e=l.text}F(e),l.isValid&&(c=l.value||null,l.value=e,m=l.value,l.isValid&&t(function(){l.change({maValue:l.value,maOldValue:c})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),f=l.canAddItem?!g&&n[0]!==o[0]&&n[0]!==a[0]&&n[0]!==r[0]&&n[0]!==u.focusser[0]&&n[0]!==s[0]:!g&&n[0]!==a[0]&&n[0]!==r[0]&&n[0]!==u.focusser[0]&&n[0]!==s[0],f&&l.blur({maValue:l.value}),g=!1},F=function(e){if(l.isValid=!0,v&&v.length)for(var t=0;t<v.length;t++)if(!v[t].validate(e)){l.isValid=!1;break}},M=function(){l.isAddMode?(r.focus(),l.isTextFocused=!0):s.select2("focus")};l.isResetEnabled=function(){return!l.isDisabled&&(l.isAddMode?!i.isNullOrWhiteSpace(l.text):!i.isNullOrUndefined(l.value))},l.onReset=function(){c=l.value,l.value=null,M(),t(function(){l.change({maValue:l.value,maOldValue:c})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),f&&l.focus({maValue:l.value}),f=!1},r.focusout(function(e){T(e,"text")}),l.getAddItemTooltip=function(){return p?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getOptionValue=function(e){return l.itemValueField?l.getItemValue(e):e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;c=l.value||null,"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(s&&s.select2("close"),l.previousSelectedItem=I(l.selectedItem),l.value=m,l.value&&(l.text="string"==typeof l.value?l.value:l.value[l.itemTextField])):(m=A(l.text),l.value=l.previousSelectedItem),i||t(function(){l.change({maValue:l.value,maOldValue:c}),M()})}},l.onChange=function(){var e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem;if(l.isAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.isAjax&&l.itemValueField&&!i.isNullOrWhiteSpace(e))for(var n=0;n<l.items.length;n++)if(l.getItemValue(l.items[n])===e.toString()){e=l.items[n];break}if(e||l.value){if(l.itemValueField){var o=l.getItemValue(l.value);if(o&&o===l.getItemValue(e))return}else if(e===l.value)return;c=l.value,l.value=e,l.previousSelectedItem=e,t(function(){l.change({maValue:e,maOldValue:c})})}},l.$watch("value",function(e,t){e!==t&&V(e)}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,F(e))}),l.instance&&(l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,F(l.value)});for(var S={name:"IsNotEmpty",validate:function(e){return!i.isNullOrWhiteSpace(e)&&!!(l.isAjax||l.isAddMode||b(e))}},y=0;y<v.length;y++)if("IsNotEmpty"===v[y].name){h=!0,v[y]=S;break}!h&&x&&v.unshift(S),h&&(x=!0),t(function(){V(l.value),s=angular.element(n[0].querySelector(".select2-container")),u=s.data().select2,d=$('label[for="'+l.id+'"]'),o=angular.element(n[0].querySelector(".ma-button-switch")),a=angular.element(n[0].querySelector(".ma-button-reset")),d.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){M()}),u.focusser.on("focus",function(){l.onFocus("select")}),u.focusser.on("focusout",function(e){T(e,"select")}),u.dropdown.on("focus",".select2-input",function(){g=!0,l.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),o.focusout(function(e){T(e)}),a.focusout(function(e){T(e)}),u.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
