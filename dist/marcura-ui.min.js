...
!function(){angular.module("marcuraUI.components").directive("maLabel",[function(){return{restrict:"E",transclude:!0,scope:{"for":"@",isRequired:"="},replace:!0,template:function(){var e='                <div class="ma-label">                    <label class="ma-label-text" for="{{for}}"><ng-transclude></ng-transclude></label>                    <div class="ma-label-star" ng-if="isRequired">*</div>                </div>';return e}}}])}();
