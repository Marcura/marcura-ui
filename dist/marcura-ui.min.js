...
!function(){angular.module("marcuraUI.components").directive("maMessage",[function(){return{restrict:"E",transclude:!0,scope:{type:"@",state:"@",size:"@",textAlign:"@"},replace:!0,template:function(){var e="                <div class=\"ma-message{{cssClass}}\">                    <div class=\"ma-message-icon\">                        <i class=\"fa\" ng-class=\"{                            'fa-info-circle': _state === 'info',                            'fa-check-circle': _state === 'success',                            'fa-exclamation-triangle': _state === 'warning',                            'fa-times-circle': _state === 'danger'                        }\"></i>                    </div>                    <div class=\"ma-message-text\"><ng-transclude></ng-transclude></div>                </div>";return e},link:function(e){var s=e.type||"message",a=e.size?e.size:"md";e._state=e.state||"default",e.cssClass=" ma-message-"+s+" ma-message-"+e._state+" ma-message-"+a,e.textAlign&&(e.cssClass+=" ma-message-text-align-"+e.textAlign)}}}])}();
