...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","MaHelper","MaValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",validate:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",min:"=",max:"=",changeTimeout:"=",placeholder:"@",modifier:"@",eventDates:"=",disabledDates:"="},replace:!0,template:function(e){var a='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled(),                        \'ma-date-box-has-value\': hasValue()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            placeholder="{{placeholder}}"                            ng-disabled="isDisabled"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"/><input class="ma-date-box-hour"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minute" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return a},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,r,l,u,d,c,m,f=null,v=i.configuration.displayFormat,p=i.configuration.format,y=i.configuration.timeZone,b=angular.element(o[0].querySelector(".ma-date-box-date")),h=angular.element(o[0].querySelector(".ma-date-box-hour")),g=angular.element(o[0].querySelector(".ma-date-box-minute")),x=a.createEmpty(),E=a.parseTimeZone(y),D=0,k=[],w=i.isRequired,T=new a(i.min),C=new a(i.max),V=null,q=Number(i.changeTimeout),F=0,M=0,S=0,N=[],R=function(e){return!x.isEqual(e)&&(i.isTouched=!0,!0)},K=function(){var e=b.val().trim(),t=""===e,n=Number(h.val()),i=Number(g.val()),o=a.createEmpty();return n<0||n>23||i<0||i>59?null:t?o:(o=new a(e),o.isEmpty()?null:(o.add(n,"hour"),o.add(i,"minute"),o.offset(D),o))},O=function(a){var t=null;a&&!a.isEmpty()?(t=a.copy().toUtc().add(E,"minute"),b.val(t.format(v)),h.val(t.format("HH")),g.val(t.format("mm")),s||(s=b.val())):(b.val(""),h.val("00"),g.val("00")),i.isFocused&&(te(),ie(),d&&b.prop({selectionStart:F,selectionEnd:F}),c&&h.prop({selectionStart:M,selectionEnd:M}),m&&g.prop({selectionStart:S,selectionEnd:S}),e(function(){ae(),ne()})),f&&f.setDate(t?t.toDate():null,!0)},Z=function(){f&&(C=new a(i.max),C.isEmpty()&&(C=(new a).add(100,"year")),f.setMaxDate(C.toDate()))},B=function(){f&&(T=new a(i.min),T.isEmpty()&&(T=(new a).subtract(100,"year")),f.setMinDate(T.toDate()))},I=function(e){var t=a.createEmpty();return e?t=i.parser?i.parser(e):a.parse(e,i.culture):t},H=function(e){e.hour(Number(h.val())).minute(Number(g.val())).second(0)},G=function(){D=E},A=function(){var n="ma-pika";if(!t.isNullOrWhiteSpace(i.modifier))for(var s=i.modifier.split(" "),r=0;r<s.length;r++)n+=" ma-pika-"+s[r];f=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",onSelect:function(){var t=new a(f.getDate());return t.offset(E),i.hasTime&&(H(t),G()),e(function(){W(t)}),R(t)?void U(t):void O(t)},disableDayFn:function(e){var t=!1;if(e=new a(e).offset(E),i.disabledDates)for(var n=0;n<i.disabledDates.length;n++){var o=new a(i.disabledDates[n]).offset(E);if(e.isEqual(o)){t=!0;break}}return t},events:N,theme:n}),O(x),Z(),B()},L=function(){f&&f.destroy()},W=function(e,a){i.isValid=!0,V=null,a=void 0===a||a;var t=e?e.format(p):null;if(k&&k.length)for(var n=0;n<k.length;n++)if(!k[n].validate(t)){i.isValid=!1,V=k[n];break}a!==!1&&Y(e)},z=function(){var e=!1;k=i.validators?angular.copy(i.validators):[];for(var a=0;a<k.length;a++)if("IsNotEmpty"===k[a].name){e=!0;break}!e&&w&&k.unshift(n.isNotEmpty()),e&&(w=!0),T.isEmpty()||k.push(n.isGreaterOrEqual(T,!0)),C.isEmpty()||k.push(n.isLessOrEqual(C,!0))},U=function(t){x=t||a.createEmpty(),i.value=t?t.format(p):null,e(function(){i.change({maValue:i.value})})},Y=function(a){e(function(){i.validate({maValue:a?a.format(p):null})})},P=function(){i.isTouched=!0;var e=b.val().trim(),t=""===e,n=Number(h.val()),o=Number(g.val()),r=a.createEmpty();return n>=0&&n<=23&&o>=0&&o<=59?(r=I(e),r.offset(D),t&&x.isEmpty()?void W(null):t?(W(r),void(i.isValid&&(O(null),U()))):r.isEmpty()?void(i.isValid=!1):(r.isEmpty()||!i.hasTime&&s!==e||(H(r),r.subtract(E-D,"minute")),W(r),R(r)?(r.isEmpty()||O(r),void(i.isValid&&U(r))):void O(r))):void(i.isValid=!1)},j=function(){d=!0,c=!1,m=!1,i.onFocus()},J=function(){c=!0,d=!1,m=!1,i.onFocus()},Q=function(){m=!0,d=!1,c=!1,i.onFocus()},X=function(){d=!1,i.onBlur()},_=function(){c=!1,i.onBlur()},ee=function(){m=!1,i.onBlur()},ae=function(){te(),$(".ma-date-box-date",o).on("focus",j),$(".ma-date-box-hour",o).on("focus",J),$(".ma-date-box-minute",o).on("focus",Q)},te=function(){$(".ma-date-box-date",o).off("focus",j),$(".ma-date-box-hour",o).off("focus",J),$(".ma-date-box-minute",o).off("focus",Q)},ne=function(){ie(),$(".ma-date-box-date",o).on("blur",X),$(".ma-date-box-hour",o).on("blur",_),$(".ma-date-box-minute",o).on("blur",ee)},ie=function(){$(".ma-date-box-date",o).off("blur",X),$(".ma-date-box-hour",o).off("blur",_),$(".ma-date-box-minute",o).off("blur",ee)},oe=function(e){if(!t.isNullOrWhiteSpace(e)){e=e.split(" ");for(var a=0;a<e.length;a++)o.removeClass("ma-date-box-"+e[a])}var n="";t.isNullOrWhiteSpace(i.modifier)||(n=i.modifier.split(" "));for(var s=0;s<n.length;s++)o.addClass("ma-date-box-"+n[s])},se=function(){if(N=[],i.eventDates&&i.eventDates.length)for(var e=0;e<i.eventDates.length;e++){var t=new a(i.eventDates[e]);N.push(t.format("ddd")+" "+t.format("MMM dd yyyy"))}};if(z(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.hasValue=function(){return b.val()||"00"!==h.val()||"00"!==g.val()},i.isResetEnabled=function(){return!i.isDisabled&&(b.val()||"00"!==h.val()||"00"!==g.val())},i.onFocus=function(){t.safeApply(function(){i.isFocused=!0})},i.onBlur=function(){u&&e.cancel(u),i.$apply(function(){i.isFocused=!1,P()})},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(r=angular.element(e.target).val())},i.onKeyup=function(a){if(a.keyCode!==t.keyCode.tab&&a.keyCode!==t.keyCode.shift){var n=!1;l=angular.element(a.target).val(),r!==l&&(n=!0,i.isTouched=!0,G()),n&&q>0&&(F=b.prop("selectionStart"),M=h.prop("selectionStart"),S=g.prop("selectionStart"),u&&e.cancel(u),u=e(function(){P()},q))}},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(x=a.createEmpty(),i.isTouched=!0,W(null),U(),O(null),b.focus())},i.value){var re=I(i.value);if(re.isEmpty())return;O(re),x=re,D=re.offset()}ae(),ne(),e(function(){i.isDisabled||A(),o.removeAttr("id"),b.attr("id",i.id)}),i.$watch("value",function(e,t){if(null!==e||null!==t){var n=I(e);if(n.isEmpty()&&(x=a.createEmpty(),O(null)),!R(n))return void O(n);W(n,!1),O(n),x=n,D=n.offset()}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?L():A())});var le=function(e,a,t){if(e!==a){var n=I(b.val().trim());n.offset(E),"max"===t?Z():B(),z();for(var o=[],s=0;s<k.length;s++)"IsGreaterOrEqual"!==k[s].name&&"IsLessOrEqual"!==k[s].name||o.push(k[s]);if(o.length){var r=n.format(p);for(!V||"IsGreaterOrEqual"!==V.name&&"IsLessOrEqual"!==V.name||(V=null,i.isValid=!0),s=0;s<o.length;s++)if(!o[s].validate(r)){i.isValid=!1,V=o[s];break}i.isValid||(i.isTouched=!0),Y(n)}i.isValid&&R(n)&&U(n)}};i.$watch("max",function(e,a){le(e,a,"max")}),i.$watch("min",function(e,a){le(e,a,"min")}),i.$watch("modifier",function(e,a){e!==a&&oe(a)}),i.$watch("eventDates",function(e,a){angular.equals(e,a)||se()}),oe(),se(),i.instance&&(i.instance.isInitialized=!0,i.instance.isEditor=function(){return!0},i.instance.validate=function(){i.isTouched=!0;var e=K();return!e||w&&e.isEmpty()?void(i.isValid=!1):void W(e,!1)},i.instance.isValid=function(){return i.isValid},i.instance.failedValidator=function(){return V},i.instance.refresh=function(){var e=I(i.value);O(e),W(e,!1)})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",modeToggle:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",selectItemTooltip:"@",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",isMultiple:"=",type:"@",minSearchCharacters:"=",noItemsFoundText:"@"},replace:!0,template:function(e,t){var i=!l.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !_hasValue,                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': _hasValue                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"ma-pace\">                                <div class=\"ma-pace-activity\"></div>                            </div>                        </div>";return n+=i?'<input class="ma-select-box-input" ma-select-box-wrapper="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select-box-wrapper="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items" value="{{item[_itemValueField]}}">                                {{item.text}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-toggle"                        ng-show="canAddItem" size="xs" modifier="simple"                        ma-tooltip="{{_addItemTooltip}}"                        ma-tooltip-is-disabled="!canAddItem"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="changeMode()"                        ng-focus="onFocus(\'toggle\')"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="isDisabled || !_hasValue">                    </ma-button>                </div>'},controller:["$scope",function(e){e._type=e.type?e.type:"object",e._itemValueField=e.itemValueField?e.itemValueField:"id",e._minSearchCharacters=e.minSearchCharacters>0?e.minSearchCharacters:1,e.getItemValue=function(t,i){if(i="boolean"!=typeof i||i,l.isNullOrWhiteSpace(t))return null;if("object"!=typeof t)return t.toString();for(var a=e._itemValueField.split("."),n=t[a[0]],o=1;o<a.length;o++)n=n[a[o]];return l.isNullOrUndefined(n)?null:i?n.toString():n},e.convertItemValue=function(t){return l.isNullOrUndefined(t)?null:"object"===e._type?t:"string"===e._type?t[e._itemValueField]:"boolean"===e._type?"true"===t[e._itemValueField]:"number"===e._type?Number(t[e._itemValueField]):t},e.getItemText=function(t){return e.itemTemplate?e.itemTemplate(e.convertItemValue(t)):t?"object"!==e._type?t[e._itemValueField]:e.itemTextField?t[e.itemTextField]:t.toString():""},e.runInitSelection=!0,e.options={},e.options.canAddItem=!!e.canAddItem,e.options.instance={},e.noItemsFoundText&&(e.options.formatNoMatches=function(){return e.noItemsFoundText}),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=e._minSearchCharacters,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,l){if(e.runInitSelection&&e.getItemValue(e.value)){var i=angular.copy(e.value);i.text=e.getItemText(i),i[e._itemValueField]=e.getItemValue(i,"object"!==e._type),e.previousSelectedItem=i,l(i)}else l();e.runInitSelection=!1},e.isMultiple&&(e.options.formatSelection=function(t){return e.getItemText(t)}))}],link:function(i,a,n){var o,u,s,d,c,r,m=angular.element(a[0].querySelector(".ma-select-box-text")),f=null,p=!0,g=!1,h=!1,v=!1,x=i.showAddItemTooltip!==!1,I=i.validators?angular.copy(i.validators):[],b=" ",V=null;i.previousSelectedItem=i.previousSelectedItem||null,i.isAddMode=!1,i.isTextFocused=!1,i.isValid=!0,i.isTouched=!1,i.hasAjax=angular.isObject(i.ajax),i._hasValue=!1,i._items=[];var _=function(e){if(!i.hasAjax&&angular.isArray(e)){i._items.splice(0,i._items.length);var t,a=[];if("object"===i._type)a=angular.copy(e);else for(t=0;t<e.length;t++)if(!l.isNullOrUndefined(e[t])){var n={};n[i._itemValueField]=e[t].toString(),a.push(n)}for(t=0;t<a.length;t++)a[t].text=i.getItemText(a[t]);Array.prototype.push.apply(i._items,a)}};_(i.items);var S={name:"IsNotEmpty",validate:function(e){return i.isMultiple&&angular.isArray(e)?e.length>0:!l.isNullOrWhiteSpace(e)&&("object"!==i._type&&!l.isNullOrWhiteSpace(e)||!!(i.hasAjax||i.isAddMode||T(e)))}},A=function(){for(var e=null,t=0;t<I.length;t++)if("IsNotEmpty"===I[t].name){e=t,I[t]=S;break}null===e&&i.isRequired?I.unshift(S):null===e||i.isRequired||I.splice(e,1)},T=function(e){if(i.hasAjax)return e&&!l.isNullOrWhiteSpace(e[i.itemValueField]);for(var t=0;t<i._items.length;t++)if(i.getItemValue(i._items[t])===i.getItemValue(e))return!0;return!1},M=function(e){if(l.isNullOrWhiteSpace(e))return null;if("object"!==i._type)return e;for(var t=0;t<i._items.length;t++)if(i.getItemValue(i._items[t])===e.toString())return i._items[t];return null},y=function(e){if(l.isNullOrWhiteSpace(e))return null;var t={};return"object"===i._type?t[i.itemTextField]=e:e&&(t[i._itemValueField]=e),t},F=function(e){if(i.isMultiple){var t,a=[];if(i.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(i.getItemValue(e[t]));i.selectedItem=a,N(e)}else i.canAddItem&&e&&(i.isAddMode=!T(e),k()),N(e),i.isAddMode?(l.isNullOrWhiteSpace(e)?i.text=null:"object"===i._type?i.text=e[i.itemTextField].toString():i.text=e,f=e,i.toggleMode("add")):(l.isNullOrWhiteSpace(e)?i.selectedItem=null:i.hasAjax||(i.selectedItem=i.getItemValue(e)),i.previousSelectedItem=e,i.toggleMode("select")),k();W()},j=function(e){if(l.isNullOrWhiteSpace(e))return null;var t=angular.copy(e);if("object"===i._type)if(i.isMultiple)for(var a=0;a<t.length;a++)delete t[a].text;else delete t.text;return t},O=function(e,a){var n=angular.element(e.relatedTarget||e.toElement),s=n[0]===u[0],c=!i.isMultiple&&d.focusser[0]===n[0],x=e.target===o[0],I=e.target===u[0];if(i.isTextFocused=!1,"text"===a?i.$apply(function(){i.isTouched=!0;var e;if(!l.isNullOrWhiteSpace(i.text)||!l.isNullOrWhiteSpace(i.value)){if("object"===i._type){if(i.value&&i.value[i.itemTextField]===i.text)return;e=i.convertItemValue(y(i.text))}else{if(i.value===i.text)return;e=i.text}N(e),i.isValid&&(e=j(e),r=j(i.value)||null,i.value=e,f=i.value,W(),i.isValid&&!s&&t(function(){i.change({maValue:i.value,maOldValue:r})}))}}):"select"===a&&i.$apply(function(){i.isTouched=!0}),p=(!x&&!I||!c)&&(!h&&!v&&n[0]!==o[0]&&!s&&n[0]!==m[0]&&n[0]!==d.search[0]),i.isMultiple){var b=angular.element(e.target);b.hasClass("select2-input")&&b.hasClass("select2-default")?p=!0:g&&(p=!1)}p&&i.blur({maValue:i.value})},N=function(e){if(i.isValid=!0,V=null,I&&I.length)for(var t=0;t<I.length;t++)if(!I[t].validate(e)){i.isValid=!1,V=I[t];break}},w=function(){i.isAddMode?m.focus():s.select2("focus")},W=function(){i.isMultiple?i._hasValue=!l.isNullOrUndefined(i.value)&&i.value.length:i.isAddMode?i._hasValue=!l.isNullOrWhiteSpace(i.text):i._hasValue=!l.isNullOrUndefined(i.value)&&!i.isLoading},k=function(){x&&i.canAddItem?i.isAddMode?i._addItemTooltip=i.selectItemTooltip?i.selectItemTooltip:"Select"+b+"item":i._addItemTooltip=i.addItemTooltip?i.addItemTooltip:"Add"+b+"item":i._addItemTooltip=""},q=function(e,t){if(!e&&!t)return!0;if(e&&!t||!e&&t||e.length!==t.length)return!1;for(var l=!0,a=0;a<e.length;a++)if("object"===i._type){if(e[a][i._itemValueField]!==t[a][i._itemValueField]){l=!1;break}}else if(e[a]!==t[a]){l=!1;break}return l},C=function(e){return 1!==arguments.length?d?d.searchText:"":void(d&&(d.searchText=e))};i.changeMode=function(){i.toggleMode(null,null,!0),t(function(){i.modeToggle({maValue:i.value,maOldValue:r})})},i.reset=function(){r=i.value,i.value=i.isMultiple?[]:null,W()},i.onReset=function(){i.isTouched=!0,i.reset(),w(),t(function(){i.change({maValue:i.value,maOldValue:r})})},i.onFocus=function(e,t){"text"===e&&(i.isTextFocused=!0),p&&i.focus({maValue:i.value}),p=!1},i.options.instance.focus=function(){i.onFocus()},i.options.instance.blur=function(e){O(e,"select")},m.focusout(function(e){O(e,"text")}),i.toggleMode=function(e,a,n){if(i.canAddItem&&!(i.isAddMode&&"add"===e||!i.isAddMode&&"select"===e)){var o,u,d=!0;r=l.isNullOrWhiteSpace(i.value)?null:i.value,"select"===e?(i.isAddMode=!1,d=!1):"add"===e?(i.isAddMode=!0,d=!1):i.isAddMode=!i.isAddMode,"boolean"==typeof a&&(d=a),k(),i.isAddMode?(s&&s.select2("close"),i.hasAjax?i.previousSelectedItem=i.selectedItem:i.previousSelectedItem=M(i.selectedItem),o=C()?"object"===i._type?y(C()):C():j(f),l.isNullOrWhiteSpace(o)||(i.text="object"===i._type?o[i.itemTextField]:o),C("")):(f=i.convertItemValue(y(i.text)),o=j(i.previousSelectedItem)),N(o),u=!angular.equals(i.getItemValue(o),i.getItemValue(r)),i.isValid&&(i.value=o),n&&(i.isTouched=!0),W(),d&&t(function(){w(),i.isValid&&u&&i.change({maValue:i.value,maOldValue:r})})}},i.onChange=function(){var e;if(i.isMultiple){var a=i.selectedItem,n=[];if(i.hasAjax){if(n=d.data(),angular.equals(n,i.value))return;r=j(i.value)}else{r=j(i.value);for(var o=0;o<a.length;o++)e=M(a[o]),e&&n.push(e)}i.isTouched=!0,i.value=j(i.convertItemValue(n)),W(),t(function(){i.change({maValue:i.value,maOldValue:r})}),d.dropdown.mouseleave()}else{if(e=l.isJson(i.selectedItem)?JSON.parse(i.selectedItem):i.selectedItem,"number"===i._type&&(e=i.selectedItem),i.hasAjax){if(e===i.previousSelectedItem)return;if(!angular.isObject(e))return}if(!i.hasAjax&&i._itemValueField&&!l.isNullOrWhiteSpace(e))for(var u=0;u<i._items.length;u++)if(i.getItemValue(i._items[u])===e.toString()){e=i._items[u];break}if(l.isNullOrWhiteSpace(e)&&l.isNullOrWhiteSpace(i.value))return;if(i._itemValueField){var s=i.getItemValue(i.value);if(s&&s===i.getItemValue(e))return}else if(e===i.value)return;i.isTouched=!0,r=j(i.value),i.value=j(i.convertItemValue(e)),i.previousSelectedItem=e,W(),t(function(){i.change({maValue:i.value,maOldValue:r})})}};var R=function(){i.hasAjax&&d&&(d.opts.placeholder=i.value?"":i.placeholder,i.runInitSelection=!0,d.initSelection())};i.hasAjax||i.$watch("items",function(e){q(i._items,e)||(_(e),F(i.value),i.isAddMode||t(function(){var e,t;if(l.isNullOrWhiteSpace(i.value))d.data(null);else if(angular.isObject(i.value))if(i.isMultiple&&angular.isArray(i.value)){for(var a=[],n=0;n<i.value.length;n++)e=i.getItemValue(i.value[n]),t=angular.copy(M(e)||i.value[n]),t.text=i.getItemText(t),t[i._itemValueField]=e,t&&a.push(t);d.data(a)}else e=i.getItemValue(i.value),t=angular.copy(M(e)||i.value),t.text=i.getItemText(t),t[i._itemValueField]=e,d.data(t);else d.val(i.getItemValue(i.value))}))},!0),i.$watch("value",function(e,t){e!==t&&(R(),F(e))}),i.$watch("text",function(e,t){e!==t&&(i.isTouched=!0,W(),N("object"===i._type?y(e):e))}),i.$watch("isRequired",function(e,t){e!==t&&(A(),N(i.isAddMode?i.text:i.value))}),i.instance&&(i.instance.isInitialized=!0,i.instance.isEditor=function(){return!0},i.instance.mode=function(e){return 1!==arguments.length?i.isAddMode?"add":"select":void("select"===e&&i.isAddMode?i.toggleMode("select"):"add"!==e||i.isAddMode||i.toggleMode("add"))},i.instance.isValid=function(){return i.isValid},i.instance.validate=function(){i.isTouched=!0,N(i.isAddMode?i.text:i.selectedItem)},i.instance.failedValidator=function(){return V},i.instance.clear=function(){i.reset(),t(function(){i.isTouched=!1})}),A(),t(function(){F(i.value),s=angular.element(a[0].querySelector(".select2-container")),d=s.data().select2,c=$('label[for="'+i.id+'"]'),o=angular.element(a[0].querySelector(".ma-button-toggle")),u=angular.element(a[0].querySelector(".ma-button-reset")),R(),c.length>0&&$(e).on("click",'label[for="'+i.id+'"]',function(){w()}),i.isMultiple?(d.selection.on("mouseenter",function(){g=!0}),d.selection.on("mouseleave",function(){g=!1}),d.dropdown.on("mouseenter",function(){g=!0}),d.dropdown.on("mouseleave",function(){g=!1}),d.dropdown.on("click",function(){d.search.focus()})):d.addItemButton.on("click",function(){i.$apply(function(){i.toggleMode("add",!0,!0),t(function(){i.modeToggle({maValue:i.value,maOldValue:r})})})}),o.focusout(function(e){O(e)}),u.focusout(function(e){O(e)}),o.mousedown(function(e){h=!0}),o.mouseup(function(e){h=!1}),u.mousedown(function(e){v=!0}),u.mouseup(function(e){v=!1}),i.init({maInstance:i.instance})})}}}])}();
