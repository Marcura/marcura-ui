...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,o){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-focused\': isFocused,                        \'ma-select-box-is-disabled\': isDisabled,                        \'ma-select-box-is-invalid\': !isValid,                        \'ma-select-box-is-touched\': isTouched                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(l,n){var d,s,c,u,a=angular.element(n[0].querySelector(".ma-select-box-input")),r=null,m=null,f=!0,g=!1,p=l.showAddItemTooltip!==!1,F=l.validators?angular.copy(l.validators):[],I=l.isRequired,x=!1;l.isAddMode=!1,l.formatItem=l.itemTemplate||function(e){return e?l.itemTextField?e[l.itemTextField]:e.toString():""},l.isFocused=!1,l.isValid=!0,l.isTouched=!1;var h=function(e){for(var t=l.itemValueField&&e[l.itemValueField],i=0;i<l.items.length;i++)if(t){if(l.items[i][l.itemValueField]===e[l.itemValueField])return!0}else if(l.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!l.itemTextField)return e;for(var t=0;t<l.items.length;t++)if(l.items[t][l.itemValueField].toString()===e.toString())return l.items[t];return null},b=function(e){if(!l.itemTextField)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},T=function(e){e&&(l.isAddMode=!h(e)),M(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(e?l.itemValueField&&e[l.itemValueField]?l.value=e[l.itemValueField].toString():"string"==typeof e&&(l.value=e):l.value=null,r=e,l.toggleMode("select"))},A=function(e,i){var o=angular.element(e.relatedTarget),n=angular.element(c.dropdown[0].querySelector(".select2-input"));l.isFocused=!1,"input"===i?l.$apply(function(){if(l.isTouched=!0,l.itemTextField){if(l.selectedItem&&l.selectedItem[l.itemTextField]===l.text)return;l.selectedItem=b(l.text)}else{if(l.selectedItem===l.text)return;l.selectedItem=l.text}m=l.selectedItem,t(function(){l.change({item:l.selectedItem})})}):"select"===i&&l.$apply(function(){l.isTouched=!0}),g||o[0]===d[0]||o[0]===a[0]||o[0]===c.focusser[0]||o[0]===n[0]||(l.blur({item:l.selectedItem}),f=!0),g=!1},M=function(e){if(l.isValid=!0,F&&F.length)for(var t=0;t<F.length;t++)if(!F[t].method(e)){l.isValid=!1;break}};l.onFocus=function(e){l.isFocused=!0,f&&l.focus({item:l.selectedItem}),f=!1},a.focusout(function(e){A(e,"input")}),l.getAddItemTooltip=function(){return p?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getItemValue=function(e){return l.itemValueField?e[l.itemValueField].toString():e},l.toggleMode=function(e){if(!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(s&&s.select2("close"),r=v(l.value),l.selectedItem=m,l.selectedItem&&(l.text="string"==typeof l.selectedItem?l.selectedItem:l.selectedItem[l.itemTextField])):(m=b(l.text),l.selectedItem=r),i||t(function(){l.change({item:l.selectedItem}),l.isAddMode?a.focus():s.select2("focus"),l.isFocused=!0})}},l.onChange=function(){var e=i.isJson(l.value)?JSON.parse(l.value):l.value;if(l.itemValueField&&e)for(var o=0;o<l.items.length;o++)if(l.items[o][l.itemValueField].toString()===e.toString()){e=l.items[o];break}if(e||l.selectedItem){if(l.itemValueField){if(l.selectedItem&&l.selectedItem[l.itemValueField]&&l.selectedItem[l.itemValueField].toString()===e[l.itemValueField].toString())return}else if(e===l.selectedItem)return;l.selectedItem=e,r=e,t(function(){l.change({item:e})})}},l.$watch("selectedItem",function(e,t){e!==t&&T(e)}),l.$watch("text",function(e,t){l.isTouched=!0,M(e)}),l.instance&&(l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid});for(var V=0;V<F.length;V++)if("IsNotEmpty"===F[V].name){x=!0;break}!x&&I&&F.unshift(o.isNotEmpty()),x&&(I=!0),t(function(){T(l.selectedItem),s=angular.element(n[0].querySelector(".select2-container")),c=s.data().select2,u=$('label[for="'+l.id+'"]'),d=angular.element(n[0].querySelector(".ma-button")),u.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){l.isAddMode?a.focus():s.select2("focus")}),c.focusser.on("focus",function(){l.onFocus("select")}),c.focusser.on("focusout",function(e){A(e,"select")}),c.dropdown.on("focus",".select2-input",function(){g=!0,l.onFocus()}),c.dropdown.on("focusout",".select2-input",function(e){A(e,"select")}),d.focusout(function(e){A(e)}),c.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
