...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,t){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@"},replace:!0,template:function(e,a){var t="password"===a.type?"password":"text",i="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+t+'" id="{{id}}"                    type="text"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return i},link:function(i,n){var o,s,l,u,c,d=angular.element(n[0].querySelector(".ma-text-box-value")),r=angular.element(n[0].querySelector(".ma-button-reset")),v=i.validators?angular.copy(i.validators):[],f=i.isRequired,m=!1,b=Number(i.changeTimeout),p=!0,g=function(){i.isValid=!0;var e=d.val();if(v&&v.length)for(var a=0;a<v.length;a++)if(!v[a].validate(e)){i.isValid=!1;break}},h=function(a){if(l!==a){var t=l;i.value=a,l=a,e(function(){i.change({maValue:a,maOldValue:t})})}},x=function(){var e=d.val();return(!a.isNullOrUndefined(l)||""!==e)&&l!==e},y=function(){return i.isTouched=!0,x()?(g(),void(i.isValid&&h(d.val()))):void g()};i.isValueFocused=!1,i.isTouched=!1;for(var V=0;V<v.length;V++)if("IsNotEmpty"===v[V].name){m=!0;break}!m&&f&&v.unshift(t.isNotEmpty()),m&&(f=!0),i.isResetEnabled=function(){return!i.isDisabled&&""!==d.val()},i.onReset=function(){i.isDisabled||(l=d.val(),i.isTouched=!0,h(null),g(),d.focus())},i.onFocus=function(e){"value"===e&&(i.isValueFocused=!0),p&&(c=i.value,i.focus({maValue:i.value})),p=!1},d.focusout(function(e){k(e)}),r.focusout(function(e){k(e)});var k=function(t){var n=angular.element(t.relatedTarget);p=n[0]!==d[0]&&n[0]!==r[0],u&&e.cancel(u),a.safeApply(function(){i.isValueFocused=!1}),p&&(y(),i.blur({maValue:i.value,maOldValue:c,maHasValueChanged:c!==i.value}))};i.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},d.on("input",function(t){if(t.keyCode!==a.keyCode.tab&&t.keyCode!==a.keyCode.shift){var i=!1;s=angular.element(t.target).val(),o!==s&&(i=!0),i&&(u&&e.cancel(u),u=e(function(){y()},b))}}),e(function(){n.removeAttr("id"),d.attr("id",i.id)}),i.$watch("value",function(e,a){if(e!==a){var t=d.prop("selectionStart");l=e,d.val(e),g(),i.isValueFocused&&d.prop({selectionStart:t,selectionEnd:t})}}),d.val(i.value),g(),l=i.value,i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){i.isTouched=!0,g()},i.instance.isValid=function(){return i.isValid})}}}])}();
