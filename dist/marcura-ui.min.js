...
!function(){angular.module("marcuraUI.components").directive("maRadioBox",["maHelper","$timeout",function(e,s){return{restrict:"E",scope:{text:"@",value:"=",selectedValue:"=",isDisabled:"=",change:"&",size:"@",comparer:"="},replace:!0,template:function(){var e='            <div class="ma-radio-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-radio-box-is-checked\': isChecked(),                    \'ma-radio-box-is-disabled\': isDisabled,                    \'ma-radio-box-has-text\': hasText,                    \'ma-radio-box-is-focused\': isFocused                }">                <span class="ma-radio-box-text">{{text || \'&nbsp;\'}}</span>                <div class="ma-radio-box-inner"></div>                <i class="ma-radio-box-icon" ng-show="isChecked()"></i>            </div>';return e},link:function(a,i,n){var o=null,t=function(){a.isDisabled?i.removeAttr("tabindex"):i.attr("tabindex","0")},c=function(){var e=null,s=a.$parent,i=n.selectedValue;for(i.indexOf(".")!==-1&&(o=i.split("."),i=o[0]);s&&!e;)s.hasOwnProperty(i)?e=s:s=s.$parent;return e},l=c();a._size=a.size?a.size:"xs",a.cssClass=" ma-radio-box-"+a._size,a.hasText=!!a.text,a.isFocused=!1,a.isChecked=function(){return a.comparer?a.comparer(a.value,a.selectedValue):JSON.stringify(a.value)===JSON.stringify(a.selectedValue)},a.onChange=function(){if(!a.isDisabled){var e;if(a.selectedValue=a.value,l&&o){e=l;for(var i=0;i<o.length;i++)e=e[o[i]];e=a.value}else e=l[n.selectedValue],l[n.selectedValue]=a.value;s(function(){a.change({value:a.value})})}},a.onFocus=function(){a.isDisabled||(a.isFocused=!0)},a.onBlur=function(){a.isDisabled||(a.isFocused=!1)},a.onKeypress=function(s){s.keyCode===e.keyCode.space&&(s.preventDefault(),a.isDisabled||a.isChecked()||a.onChange())},a.$watch("isDisabled",function(e,s){e!==s&&(e&&(a.isFocused=!1),t())}),t()}}}])}();
