...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",instance:"=",orderBy:"="},replace:!0,template:function(){var e='            <div class="ma-select-box"                ng-class="{                    \'ma-select-box-can-add-item\': canAddItem,                    \'ma-select-box-is-focused\': isFocused,                    \'ma-select-box-is-disabled\': isDisabled                }">                <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                    <div class="pace">                        <div class="pace-activity"></div>                    </div>                </div>                <select ui-select2="options"                    ng-show="!addingItem"                    ng-disabled="isDisabled"                    ng-model="value"                    ng-change="onChange()"                    ng-required="isRequired">                    <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                        {{formatItem(item)}}                    </option>                </select>                <input class="ma-select-box-input" type="text" ng-show="addingItem"                    ng-model="text"                    ng-disabled="isDisabled"                    ng-focus="onFocus()"                    ng-blur="onBlur()"/>                <ma-button ng-if="canAddItem" size="xs" modifier="secondary"                    tooltip="{{getAddItemTooltip()}}"                    right-icon="{{addingItem ? \'bars\' : \'plus\'}}"                    click="toggleView()"                    is-disabled="isDisabled">                </ma-button>            </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(l,n){var d,s,c,a,o=angular.element(n[0].querySelector(".ma-select-box-input"));l.addingItem=!1,l.formatItem=l.itemTemplate||function(e){return e?l.itemTextField?e[l.itemTextField]:e.toString():""},l.isFocused=!1;var m=function(e){e?l.itemValueField&&e[l.itemValueField]?l.value=e[l.itemValueField].toString():"string"==typeof e?l.value=e:l.value=JSON.stringify(e):(l.value=null,l.text=null,s=null)};l.getAddItemTooltip=function(){return l.addingItem?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item"},l.getItemValue=function(e){return l.itemValueField?e[l.itemValueField].toString():e},l.toggleView=function(e){var i=!1;"select"===e?(l.addingItem=!1,i=!0):"add"===e?(l.addingItem=!0,i=!0):l.addingItem=!l.addingItem,l.addingItem?(c.select2("close"),d=l.selectedItem,l.selectedItem=s,l.selectedItem&&(l.text="string"==typeof l.selectedItem?l.selectedItem:l.selectedItem[l.itemTextField])):(s=l.selectedItem,l.selectedItem=d),i||t(function(){l.change({item:l.selectedItem}),l.addingItem?(o.focus(),l.isFocused=!0):c.select2("focus")})},l.onFocus=function(){l.isFocused=!0},l.onBlur=function(){if(l.isFocused=!1,l.itemTextField){if(l.selectedItem&&l.selectedItem[l.itemTextField]===l.text)return;l.text?(l.selectedItem={},l.selectedItem[l.itemTextField]=l.text):l.selectedItem=null}else{if(l.selectedItem===l.text)return;l.selectedItem=l.text}s=l.selectedItem,t(function(){l.change({item:l.selectedItem})})},l.onChange=function(){var e=i.isJson(l.value)?JSON.parse(l.value):l.value;if(l.itemValueField&&e)for(var n=0;n<l.items.length;n++)if(l.items[n][l.itemValueField].toString()===e.toString()){e=l.items[n];break}if(e||l.selectedItem){if(l.itemValueField){if(l.selectedItem&&l.selectedItem[l.itemValueField]&&l.selectedItem[l.itemValueField].toString()===e[l.itemValueField].toString())return}else if(e===l.selectedItem)return;l.selectedItem=e,d=e,t(function(){l.change({item:e})})}},l.$watch("selectedItem",function(e,t){e!==t&&m(e)}),m(l.selectedItem),l.instance&&(l.instance.showSelectView=function(){l.addingItem&&l.toggleView("select")},l.instance.showAddView=function(){l.addingItem||l.toggleView("add")}),t(function(){c=angular.element(n[0].querySelector(".select2-container")),a=$('label[for="'+l.id+'"]'),a.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){l.addingItem?o.focus():c.select2("focus")})})}}}])}();
