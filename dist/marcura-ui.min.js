...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,o){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-input-focused\': isInputFocused,                        \'ma-select-box-is-disabled\': isDisabled,                        \'ma-select-box-is-invalid\': !isValid,                        \'ma-select-box-is-touched\': isTouched,                        \'ma-select-box-mode-add\': isAddMode,                        \'ma-select-box-mode-select\': !isAddMode                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(d,n){var l,s,c,u,a=angular.element(n[0].querySelector(".ma-select-box-input")),r=null,m=null,f=!0,g=!1,p=d.showAddItemTooltip!==!1,I=d.validators?angular.copy(d.validators):[],F=d.isRequired,x=!1;d.isAddMode=!1,d.formatItem=d.itemTemplate||function(e){return e?d.itemTextField?e[d.itemTextField]:e.toString():""},d.isInputFocused=!1,d.isValid=!0,d.isTouched=!1;var h=function(e){if(!angular.isArray(d.items))return!1;for(var t=d.itemValueField&&e[d.itemValueField],i=0;i<d.items.length;i++)if(t){if(d.items[i][d.itemValueField]===e[d.itemValueField])return!0}else if(d.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!d.itemTextField)return e;if(angular.isArray(d.items))for(var t=0;t<d.items.length;t++)if(d.items[t][d.itemValueField].toString()===e.toString())return d.items[t];return null},b=function(e){if(!d.itemTextField)return e;if(e){var t={};return t[d.itemTextField]=e,t}return null},A=function(e){d.canAddItem&&e&&(d.isAddMode=!h(e)),M(e),d.isAddMode?(e?d.itemTextField&&e[d.itemTextField]?d.text=e[d.itemTextField].toString():d.text=e:d.text=null,m=e,d.toggleMode("add")):(e?d.itemValueField&&e[d.itemValueField]?d.value=e[d.itemValueField].toString():"string"==typeof e&&(d.value=e):d.value=null,r=e,d.toggleMode("select"))},T=function(e,i){var o=angular.element(e.relatedTarget),n=angular.element(c.dropdown[0].querySelector(".select2-input"));d.isInputFocused=!1,"input"===i?d.$apply(function(){if(d.isTouched=!0,d.itemTextField){if(d.selectedItem&&d.selectedItem[d.itemTextField]===d.text)return;d.selectedItem=b(d.text)}else{if(d.selectedItem===d.text)return;d.selectedItem=d.text}m=d.selectedItem,d.isValid&&t(function(){d.change({item:d.selectedItem})})}):"select"===i&&d.$apply(function(){d.isTouched=!0}),g||o[0]===l[0]||o[0]===a[0]||o[0]===c.focusser[0]||o[0]===n[0]||(d.blur({item:d.selectedItem}),f=!0),g=!1},M=function(e){if(d.isValid=!0,I&&I.length)for(var t=0;t<I.length;t++)if(!I[t].method(e)){d.isValid=!1;break}};d.onFocus=function(e){"input"===e&&(d.isInputFocused=!0),f&&d.focus({item:d.selectedItem}),f=!1},a.focusout(function(e){T(e,"input")}),d.getAddItemTooltip=function(){return p?d.isAddMode?"Back to the list":d.addItemTooltip?d.addItemTooltip:"Add new item":""},d.getItemValue=function(e){return d.itemValueField?e[d.itemValueField].toString():e},d.toggleMode=function(e){if(d.canAddItem&&!(d.isAddMode&&"add"===e||!d.isAddMode&&"select"===e)){var i=!1;"select"===e?(d.isAddMode=!1,i=!0):"add"===e?(d.isAddMode=!0,i=!0):d.isAddMode=!d.isAddMode,d.isAddMode?(s&&s.select2("close"),r=v(d.value),d.selectedItem=m,d.selectedItem&&(d.text="string"==typeof d.selectedItem?d.selectedItem:d.selectedItem[d.itemTextField])):(m=b(d.text),d.selectedItem=r),i||t(function(){d.change({item:d.selectedItem}),d.isAddMode?(a.focus(),d.isInputFocused=!0):s.select2("focus")})}},d.onChange=function(){var e=i.isJson(d.value)?JSON.parse(d.value):d.value;if(d.itemValueField&&e)for(var o=0;o<d.items.length;o++)if(d.items[o][d.itemValueField].toString()===e.toString()){e=d.items[o];break}if(e||d.selectedItem){if(d.itemValueField){if(d.selectedItem&&d.selectedItem[d.itemValueField]&&d.selectedItem[d.itemValueField].toString()===e[d.itemValueField].toString())return}else if(e===d.selectedItem)return;d.selectedItem=e,r=e,t(function(){d.change({item:e})})}},d.$watch("selectedItem",function(e,t){e!==t&&A(e)}),d.$watch("text",function(e,t){e!==t&&(d.isTouched=!0,M(e))}),d.instance&&(d.instance.switchToSelectMode=function(){d.isAddMode&&d.toggleMode("select")},d.instance.switchToAddMode=function(){d.isAddMode||d.toggleMode("add")},d.instance.isValid=function(){return d.isValid});for(var V=0;V<I.length;V++)if("IsNotEmpty"===I[V].name){x=!0;break}!x&&F&&I.unshift(o.isNotEmpty()),x&&(F=!0),t(function(){A(d.selectedItem),s=angular.element(n[0].querySelector(".select2-container")),c=s.data().select2,u=$('label[for="'+d.id+'"]'),l=angular.element(n[0].querySelector(".ma-button")),u.length>0&&$(e).on("click",'label[for="'+d.id+'"]',function(){d.isAddMode?a.focus():s.select2("focus")}),c.focusser.on("focus",function(){d.onFocus("select")}),c.focusser.on("focusout",function(e){T(e,"select")}),c.dropdown.on("focus",".select2-input",function(){g=!0,d.onFocus()}),c.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),l.focusout(function(e){T(e)}),c.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
