...
!function(){angular.module("marcuraUI.components").directive("maMessage",[function(){return{restrict:"E",transclude:!0,scope:{type:"@",state:"@",size:"@",textAlign:"@",hasIcon:"="},replace:!0,template:function(){var s="                <div class=\"ma-message{{cssClass}}\">                    <div class=\"ma-message-icon\" ng-if=\"_hasIcon\">                        <i class=\"fa\" ng-class=\"{                            'fa-info-circle': _state === 'info',                            'fa-check-circle': _state === 'success',                            'fa-exclamation-triangle': _state === 'warning',                            'fa-times-circle': _state === 'danger'                        }\"></i>                    </div>                    <div class=\"ma-message-text\"><ng-transclude></ng-transclude></div>                </div>";return s},link:function(s){var a=s.type||"message",e=s.size?s.size:"md";s._hasIcon=s.hasIcon!==!1;var t=function(){s._state=s.state||"default"},n=function(){s.cssClass=" ma-message-"+a+" ma-message-"+s._state+" ma-message-"+e,s.textAlign&&(s.cssClass+=" ma-message-text-align-"+s.textAlign),s._hasIcon&&(s.cssClass+=" ma-message-has-icon")};s.$watch("state",function(s,a){s!==a&&(t(),n())}),t(),n()}}}])}();
