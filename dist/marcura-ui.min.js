...
!function(){angular.module("marcuraUI.components").directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",validate:"&",modeToggle:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",selectItemTooltip:"@",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",isMultiple:"=",type:"@",minSearchCharacters:"=",noItemsFoundText:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !_hasValue,                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': _hasValue,                            'ma-select-box-is-rendered': isRendering                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"ma-pace\">                                <div class=\"ma-pace-activity\"></div>                            </div>                        </div>                        <div class=\"ma-select-box-rendering\" ng-if=\"isRendering\"></div>";return n+=l?'<input class="ma-select-box-input" ma-select-box-wrapper="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select-box-wrapper="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items" value="{{item[_itemValueField]}}">                                {{item.text}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text"                        ng-class="{ \'ng-hide\': !isAddMode }"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-toggle"                        ng-show="canAddItem" size="xs" simple                        ma-tooltip="{{_addItemTooltip}}"                        ma-tooltip-is-disabled="!canAddItem"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="changeMode()"                        ng-focus="onFocus(\'toggle\')"                        is-disabled="{{isDisabled}}">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" simple                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="{{isDisabled || !_hasValue}}">                    </ma-button>                </div>'},controller:["$scope",function(e){e._type=e.type?e.type:"object",e._itemValueField=e.itemValueField?e.itemValueField:"id",e._minSearchCharacters=e.minSearchCharacters>0?e.minSearchCharacters:1,e.getItemValue=function(t,l){if(l="boolean"!=typeof l||l,i.isNullOrWhiteSpace(t))return null;if("object"!=typeof t)return t.toString();for(var a=e._itemValueField.split("."),n=t[a[0]],o=1;o<a.length;o++)n=n[a[o]];return i.isNullOrUndefined(n)?null:l?n.toString():n},e.convertItemValue=function(t){return i.isNullOrUndefined(t)?null:"object"===e._type?t:"string"===e._type?t[e._itemValueField]:"boolean"===e._type?"true"===t[e._itemValueField]:"number"===e._type?Number(t[e._itemValueField]):t},e.getItemText=function(t){return e.itemTemplate?e.itemTemplate(e.convertItemValue(t)):t?"object"!==e._type?t[e._itemValueField]:e.itemTextField?t[e.itemTextField]:t.toString():""},e.runInitSelection=!0,e.options={},e.options.canAddItem=!!e.canAddItem,e.options.instance={},e.noItemsFoundText&&(e.options.formatNoMatches=function(){return e.noItemsFoundText}),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=e._minSearchCharacters,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.getItemText(l),l[e._itemValueField]=e.getItemValue(l,"object"!==e._type),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1},e.isMultiple&&(e.options.formatSelection=function(t){return e.getItemText(t)}))}],link:function(l,a,n){var o,u,s,d,c,r,m=angular.element(a[0].querySelector(".ma-select-box-text")),f=null,p=!0,g=!1,h=!1,v=!1,x=l.showAddItemTooltip!==!1,I=l.validators?angular.copy(l.validators):[],b=" ",V=null;l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.hasAjax=angular.isObject(l.ajax),l._hasValue=!1,l._items=[],l.isRendering=!0;var _=function(e){if(!l.hasAjax&&angular.isArray(e)){l._items.splice(0,l._items.length);var t,a=[];if("object"===l._type)a=angular.copy(e);else for(t=0;t<e.length;t++)if(!i.isNullOrUndefined(e[t])){var n={};n[l._itemValueField]=e[t].toString(),a.push(n)}for(t=0;t<a.length;t++)a[t].text=l.getItemText(a[t]);Array.prototype.push.apply(l._items,a)}};_(l.items);var A={name:"IsNotEmpty",validate:function(e){return l.isMultiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&("object"!==l._type&&!i.isNullOrWhiteSpace(e)||!!(l.hasAjax||l.isAddMode||M(e)))}},S=function(){for(var e=null,t=0;t<I.length;t++)if("IsNotEmpty"===I[t].name){e=t,I[t]=A;break}null===e&&l.isRequired?I.unshift(A):null===e||l.isRequired||I.splice(e,1)},T=function(e){t(function(){l.validate({maValue:e})})},M=function(e){if(l.hasAjax)return e&&!i.isNullOrWhiteSpace(e[l.itemValueField]);for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===l.getItemValue(e))return!0;return!1},y=function(e){if(i.isNullOrWhiteSpace(e))return null;if("object"!==l._type)return e;for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},F=function(e){if(i.isNullOrWhiteSpace(e))return null;var t={};return"object"===l._type?t[l.itemTextField]=e:e&&(t[l._itemValueField]=e),t},j=function(e){if(l.isMultiple){var t,a=[];if(l.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(l.getItemValue(e[t]));l.selectedItem=a,W(e)}else l.canAddItem&&e&&(l.isAddMode=!M(e),k()),W(e),l.isAddMode?(i.isNullOrWhiteSpace(e)?l.text=null:"object"===l._type?l.text=e[l.itemTextField].toString():l.text=e,f=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.hasAjax||(l.selectedItem=l.getItemValue(e)),l.previousSelectedItem=e,l.toggleMode("select")),k();R()},O=function(e){if(i.isNullOrWhiteSpace(e))return null;var t=angular.copy(e);if("object"===l._type)if(l.isMultiple)for(var a=0;a<t.length;a++)delete t[a].text;else delete t.text;return t},N=function(e,a){var n=angular.element(e.relatedTarget||e.toElement),s=n[0]===u[0],c=!l.isMultiple&&d.focusser[0]===n[0],x=e.target===o[0],I=e.target===u[0];if(l.isTextFocused=!1,"text"===a?l.$apply(function(){l.isTouched=!0;var e;if(!i.isNullOrWhiteSpace(l.text)||!i.isNullOrWhiteSpace(l.value)){if("object"===l._type){if(l.value&&l.value[l.itemTextField]===l.text)return;e=l.convertItemValue(F(l.text))}else{if(l.value===l.text)return;e=l.text}W(e),l.isValid&&(e=O(e),r=O(l.value)||null,l.value=e,f=l.value,R(),l.isValid&&!s&&t(function(){l.change({maValue:l.value,maOldValue:r})}))}}):"select"===a&&i.safeApply(function(){l.isTouched=!0}),p=(!x&&!I||!c)&&(!h&&!v&&n[0]!==o[0]&&!s&&n[0]!==m[0]&&n[0]!==d.search[0]),l.isMultiple){var b=angular.element(e.target);b.hasClass("select2-input")&&b.hasClass("select2-default")?p=!0:g&&(p=!1)}p&&l.blur({maValue:l.value})},W=function(e,t){if(l.isValid=!0,V=null,t=void 0===t||t,I&&I.length)for(var i=0;i<I.length;i++)if(!I[i].validate(e)){l.isValid=!1,V=I[i];break}t!==!1&&T(e)},w=function(){l.isAddMode?m.focus():s.select2("focus")},R=function(){l.isMultiple?l._hasValue=!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?l._hasValue=!i.isNullOrWhiteSpace(l.text):l._hasValue=!i.isNullOrUndefined(l.value)&&!l.isLoading},k=function(){x&&l.canAddItem?l.isAddMode?l._addItemTooltip=l.selectItemTooltip?l.selectItemTooltip:"Select"+b+"item":l._addItemTooltip=l.addItemTooltip?l.addItemTooltip:"Add"+b+"item":l._addItemTooltip=""},q=function(e,t){if(!e&&!t)return!0;if(e&&!t||!e&&t||e.length!==t.length)return!1;for(var i=!0,a=0;a<e.length;a++)if("object"===l._type){if(e[a][l._itemValueField]!==t[a][l._itemValueField]){i=!1;break}}else if(e[a]!==t[a]){i=!1;break}return i},C=function(e){return 1!==arguments.length?d?d.searchText:"":void(d&&(d.searchText=e))};l.changeMode=function(){l.toggleMode(null,null,!0),t(function(){l.modeToggle({maValue:l.value,maOldValue:r})})},l.reset=function(){r=l.value,l.value=l.isMultiple?[]:null,R()},l.onReset=function(){l.isTouched=!0,l.reset(),w(),t(function(){l.change({maValue:l.value,maOldValue:r})})},l.onFocus=function(e,t){"text"===e&&(l.isTextFocused=!0),p&&l.focus({maValue:l.value}),p=!1},l.options.instance.focus=function(){l.onFocus()},l.options.instance.blur=function(e){N(e,"select")},m.focusout(function(e){N(e,"text")}),l.toggleMode=function(e,a,n){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var o,u,d=!0;r=i.isNullOrWhiteSpace(l.value)?null:l.value,"select"===e?(l.isAddMode=!1,d=!1):"add"===e?(l.isAddMode=!0,d=!1):l.isAddMode=!l.isAddMode,"boolean"==typeof a&&(d=a),k(),l.isAddMode?(s&&s.select2("close"),l.hasAjax?l.previousSelectedItem=l.selectedItem:l.previousSelectedItem=y(l.selectedItem),o=C()?"object"===l._type?F(C()):C():O(f),i.isNullOrWhiteSpace(o)||(l.text="object"===l._type?o[l.itemTextField]:o),C("")):(f=l.convertItemValue(F(l.text)),o=O(l.previousSelectedItem)),W(o),u=!angular.equals(l.getItemValue(o),l.getItemValue(r)),l.isValid&&(l.value=o),n&&(l.isTouched=!0),R(),d&&t(function(){w(),l.isValid&&u&&l.change({maValue:l.value,maOldValue:r})})}},l.onChange=function(){var e;if(l.isMultiple){var a=l.selectedItem,n=[];if(l.hasAjax){if(n=d.data(),angular.equals(n,l.value))return;r=O(l.value)}else{r=O(l.value);for(var o=0;o<a.length;o++)e=y(a[o]),e&&n.push(e)}l.isTouched=!0,l.value=O(l.convertItemValue(n)),R(),t(function(){l.change({maValue:l.value,maOldValue:r})}),d.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"==typeof e&&"string"===l._type&&(e=l.selectedItem),l.hasAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.hasAjax&&l._itemValueField&&!i.isNullOrWhiteSpace(e))for(var u=0;u<l._items.length;u++)if(l.getItemValue(l._items[u])===e.toString()){e=l._items[u];break}if(i.isNullOrWhiteSpace(e)&&i.isNullOrWhiteSpace(l.value))return;if(l._itemValueField){var s=l.getItemValue(l.value);if(s&&s===l.getItemValue(e))return}else if(e===l.value)return;l.isTouched=!0,r=O(l.value),l.value=O(l.convertItemValue(e)),l.previousSelectedItem=e,R(),t(function(){l.change({maValue:l.value,maOldValue:r})})}};var D=function(){l.hasAjax&&d&&(d.opts.placeholder=l.value?"":l.placeholder,l.runInitSelection=!0,d.initSelection())};l.hasAjax||l.$watch("items",function(e){q(l._items,e)||(_(e),j(l.value),l.isAddMode||t(function(){if(d){var e,t;if(i.isNullOrWhiteSpace(l.value))d.data(null);else if(angular.isObject(l.value))if(l.isMultiple&&angular.isArray(l.value)){for(var a=[],n=0;n<l.value.length;n++)e=l.getItemValue(l.value[n]),t=angular.copy(y(e)||l.value[n]),t.text=l.getItemText(t),t[l._itemValueField]=e,t&&a.push(t);d.data(a)}else e=l.getItemValue(l.value),t=angular.copy(y(e)||l.value),t.text=l.getItemText(t),t[l._itemValueField]=e,d.data(t);else d.val(l.getItemValue(l.value))}}))},!0),l.$watch("value",function(e,t){e!==t&&(D(),j(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,R(),W("object"===l._type?F(e):e))}),l.$watch("isRequired",function(e,t){e!==t&&(S(),W(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.isEditor=function(){return!0},l.instance.mode=function(e){return 1!==arguments.length?l.isAddMode?"add":"select":void("select"===e&&l.isAddMode?l.toggleMode("select"):"add"!==e||l.isAddMode||l.toggleMode("add"))},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,W(l.isAddMode?l.text:l.selectedItem,!1)},l.instance.failedValidator=function(){return V},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),S(),t(function(){l.isRendering=!1,j(l.value),s=angular.element(a[0].querySelector(".select2-container")),d=s.data()?s.data().select2:null,c=$('label[for="'+l.id+'"]'),o=angular.element(a[0].querySelector(".ma-button-toggle")),u=angular.element(a[0].querySelector(".ma-button-reset")),D(),c.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){w()}),d&&(l.isMultiple?(d.selection.on("mouseenter",function(){g=!0}),d.selection.on("mouseleave",function(){g=!1}),d.dropdown.on("mouseenter",function(){g=!0}),d.dropdown.on("mouseleave",function(){g=!1}),d.dropdown.on("click",function(){d.search.focus()})):d.addItemButton.on("click",function(){l.$apply(function(){l.toggleMode("add",!0,!0),t(function(){l.modeToggle({maValue:l.value,maOldValue:r})})})})),o.focusout(function(e){N(e)}),u.focusout(function(e){N(e)}),o.mousedown(function(e){h=!0}),o.mouseup(function(e){h=!1}),u.mousedown(function(e){v=!0}),u.mouseup(function(e){v=!1}),l.init({maInstance:l.instance})})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","MaHelper","MaValidators",function(e,a,t){return{restrict:"E",scope:{id:"@",type:"@",useFormat:"@",changeWhenIsInvalid:"@",placeholder:"@",hasShowPasswordButton:"@",canReset:"@",trim:"@",decimals:"@",defaultValue:"@",max:"@",min:"@",isDisabled:"@",isRequired:"@",changeTimeout:"@",change:"&",blur:"&",focus:"&",validate:"&",reset:"&",value:"=",validators:"=",instance:"="},replace:!0,template:function(e,a){var t="password"===a.type?"password":"text";"number"!==t&&"email"!==t||(t="text");var i="                <div class=\"ma-text-box\"                    ng-class=\"{                        'ma-text-box-is-disabled': isDisabled === 'true',                        'ma-text-box-is-focused': isValueFocused,                        'ma-text-box-is-invalid': !isValid,                        'ma-text-box-is-touched': isTouched,                        'ma-text-box-can-reset': canReset === 'true',                        'ma-text-box-is-reset-disabled': canReset === 'true' && isDisabled !== 'true' && !isResetEnabled(),                        'ma-text-box-can-toggle-password': canTogglePassword,                        'ma-text-box-is-toggle-password-disabled': canTogglePassword && isDisabled !== 'true' && !isTogglePasswordEnabled(),                        'ma-text-box-has-value': hasValue()                    }\">                    <input class=\"ma-text-box-value\" type=\""+t+'" id="{{id}}"                        autocomplete="off"                        placeholder="{{placeholder}}"                        ng-focus="onFocus(\'value\')"                        ng-keydown="onKeydown($event)"                        ng-disabled="isDisabled === \'true\'"/>                    <ma-button class="ma-button-toggle-password"                        ng-show="canTogglePassword" size="xs" simple                        right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                        click="togglePassword()"                        ng-focus="onFocus()"                        is-disabled="{{!isTogglePasswordEnabled()}}">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset === \'true\'" size="xs" simple                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="{{!isResetEnabled()}}">                    </ma-button>                </div>';return i},link:function(i,n,s){var u,l,r,o,d,c=angular.element(n[0].querySelector(".ma-text-box-value")),f=angular.element(n[0].querySelector(".ma-button-reset")),m=angular.element(n[0].querySelector(".ma-button-toggle-password")),v=[],b=Number(i.changeTimeout)||0,p=!0,g="false"!==i.trim,h=!1,y=null,V=i.decimals?Number(i.decimals):2,x=void 0!==s.defaultValue,w=a.isNullOrUndefined(i.defaultValue)?"":i.defaultValue,k=a.isNumber(i.min),N=a.isNumber(i.max),C=k?Number(i.min):null,T=N?Number(i.max):null,O="false"!==i.useFormat,E="true"===i.changeWhenIsInvalid,F="true"===i.hasShowPasswordButton,P=0;"number"===i.type&&(w=a.isNumber(i.defaultValue)?Number(i.defaultValue):null);var R=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==i.type&&g&&(e=e.trim()),r=e},q=function(){var e=c.val();return"number"===i.type?W(e):e},I=function(e){i.isValid=!0,y=null,e=void 0===e||e;var a=c.val();if("number"===i.type&&(a=G(a)),v&&v.length)for(var t=0;t<v.length;t++)if(!v[t].validate(a)){i.isValid=!1,y=v[t];break}e!==!1&&D(a)},S=function(t){if(U(t)){h=!0;var n=r;"number"!==i.type&&g&&(n=n.trim(),t=t.trim()),x&&(a.isNullOrUndefined(t)&&(t=w),a.isNullOrUndefined(n)&&(n=w)),i.value=t,R(t),e(function(){i.change({maValue:t,maOldValue:n})})}},D=function(a){e(function(){i.validate({maValue:a})})},U=function(e){e=a.isNullOrUndefined(e)?"":e;var t=a.isNullOrUndefined(r)?"":r,n=!1;return n="number"!==i.type&&g?t.trim()!==e.trim():t!==e},L=function(){return i.isTouched=!0,U(q())?(I(),void((i.isValid||E)&&S(q()))):void I()},W=function(e,t){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(G(e)),t||(e=parseFloat(e.toFixed(V))),isNaN(e)?null:e)},A=function(e){if(a.isNullOrWhiteSpace(e))return"";var t=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),i=e.replace(/(\.\d+)$/,""),n=i.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+n+t},G=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(/,/g,"")},z=function(e){if(a.isNullOrWhiteSpace(e))return e;var t=e;return"number"===i.type&&(e="number"==typeof e?e:Number(e),t=O?A(e.toFixed(V)):e.toFixed(0)),t},B=function(){var e=!1;v=i.validators?angular.copy(i.validators):[];for(var a=0;a<v.length;a++)if("IsNotEmpty"===v[a].name){e=!0;break}e||"true"!==i.isRequired||v.unshift(t.isNotEmpty()),"number"===i.type&&v.push(t.isNumber(!0)),k&&("number"===i.type?v.push(t.isGreaterOrEqual(C,!0)):v.push(t.isLengthGreaterOrEqual(C,!0))),N&&("number"===i.type?v.push(t.isLessOrEqual(T,!0)):v.push(t.isLengthLessOrEqual(T,!0))),"email"===i.type&&v.push(t.isEmail(!0))};B(),i.isValueFocused=!1,i.isTouched=!1,i.canTogglePassword=!1,i.isPasswordVisible=!1,"password"===i.type&&(i.canTogglePassword=F!==!1),i.hasValue=function(){if("number"===i.type){var e=c.val();return""!==e&&!a.isNumber(e)||W(e,!0)!==w&&""!==e}return c.val()!==w},i.isResetEnabled=function(){if("true"===i.isDisabled)return!1;if("number"===i.type){var e=c.val();return""!==e&&!a.isNumber(e)||W(e,!0)!==w&&""!==e}return c.val()!==w},i.doReset=function(){R(q()),c.val(w)},i.onReset=function(){"true"!==i.isDisabled&&(i.doReset(),i.isTouched=!0,S(w),I(),c.focus(),e(function(){i.reset()}))},i.onFocus=function(e){if("value"===e&&(i.isValueFocused=!0,"number"===i.type&&!a.isNullOrUndefined(i.value)&&i.isValid)){var t=i.value.toFixed(O?V:0);c.val(t)}p&&(d=c.val(),i.focus({maValue:i.value})),p=!1},c.focusout(function(e){K(e,"value")}),f.focusout(function(e){K(e)}),m.focusout(function(e){K(e)}),i.togglePassword=function(){i.isPasswordVisible=!i.isPasswordVisible,c[0].type=i.isPasswordVisible?"text":"password"},i.isTogglePasswordEnabled=function(){return"true"!==i.isDisabled&&""!==c.val()};var K=function(t,n){var s=angular.element(t.relatedTarget),u=c.val(),l=d!==u;R(i.value),p=i.canTogglePassword?s[0]!==c[0]&&s[0]!==m[0]&&s[0]!==f[0]:s[0]!==c[0]&&s[0]!==f[0],o&&e.cancel(o),"value"===n&&(x&&""===u.trim()&&(h=!0,u=w,l&&(i.value=u),c.val(z(u))),i.isResetEnabled()||s[0]!==f[0]||(p=!0),I(),i.isValid&&c.val(z(u))),a.safeApply(function(){i.isValueFocused=!1,i.isTouched=!0}),p&&(l&&L(),a.safeApply(function(){i.blur({maValue:i.value,maOldValue:d,maHasValueChanged:l})}))};i.onKeydown=function(e){if(e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(u=angular.element(e.target).val(),"number"===i.type)){if($.inArray(e.keyCode,[a.keyCode.backspace,a.keyCode["delete"],a.keyCode.home,a.keyCode.end,a.keyCode.period,a.keyCode.numLock.period,a.keyCode.dash,a.keyCode.dash2])!==-1||37===e.keyCode||39===e.keyCode)return;(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()}},c.on("input",function(t){if(t.keyCode!==a.keyCode.tab&&t.keyCode!==a.keyCode.shift){var i=!1;l=angular.element(t.target).val(),u!==l&&(i=!0),i&&(o&&e.cancel(o),o=e(function(){L()},b))}}),e(function(){n.removeAttr("id"),i.id?c.attr("id",i.id):c.removeAttr("id")}),i.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){U(e)&&(i.isTouched=!0);var t=c.prop("selectionStart");R(e),c.val(z(e)),I(!1),i.isValueFocused&&c.prop({selectionStart:t,selectionEnd:t})}}),s.$observe("isRequired",function(e,a){e!==a&&(B(),I())});var H=function(e,a){if(e!==a){var t=q();B();for(var n=[],s=0;s<v.length;s++)"IsGreaterOrEqual"!==v[s].name&&"IsLessOrEqual"!==v[s].name||n.push(v[s]);if(n.length){for(!y||"IsGreaterOrEqual"!==y.name&&"IsLessOrEqual"!==y.name||(y=null,i.isValid=!0),s=0;s<n.length;s++)if(!n[s].validate(t)){i.isValid=!1,y=n[s];break}i.isValid||0===P||(i.isTouched=!0)}(i.isValid||E)&&S(t),P++}};k&&s.$observe("min",function(e,a){C=Number(e),H(e,a)}),N&&s.$observe("max",function(e,a){T=Number(e),H(e,a)}),x&&a.isNullOrUndefined(i.value)&&(i.value=w),c.val(z(i.value)),I(),R(i.value),i.instance&&(i.instance.isInitialized=!0,i.instance.isEditor=function(){return!0},i.instance.validate=function(){if(i.isTouched=!0,I(!1),i.isValid){var e=q();U(e)&&(i.value=e)}},i.instance.isValid=function(){return i.isValid},i.instance.focus=function(){i.isValueFocused||c.focus()},i.instance.failedValidator=function(){return y},i.instance.rawValue=function(e){return 1!==arguments.length?q():void c.val(e)},i.instance.clear=function(){i.doReset(),e(function(){i.isTouched=!1})},i.instance.isTouched=function(){return i.isTouched})}}}])}();