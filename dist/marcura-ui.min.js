...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"="},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text",t="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    type="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>            </div>';return t},link:function(t,n){var o,s,u,l,c=angular.element(n[0].querySelector(".ma-text-box-value")),d=t.validators?angular.copy(t.validators):[],r=t.isRequired,v=!1,f=Number(t.changeTimeout),m=function(){if(t.isValid=!0,d&&d.length)for(var e=0;e<d.length;e++)if(!d[e].validate(c.val())){t.isValid=!1;break}},b=function(a){u!==a&&(t.value=a,u=a,e(function(){t.change({maValue:a})}))},p=function(){t.isTouched=!0,m(),t.isValid&&b(c.val())};t.isFocused=!1,t.isTouched=!1;for(var g=0;g<d.length;g++)if("IsNotEmpty"===d[g].name){v=!0;break}!v&&r&&d.unshift(i.isNotEmpty()),v&&(r=!0),t.onFocus=function(){t.isFocused=!0,t.focus({maValue:t.value})},t.onBlur=function(){l&&e.cancel(l),t.isFocused=!1,p(),t.blur({maValue:t.value})},t.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val())},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var t=!1;s=angular.element(i.target).val(),o!==s&&(t=!0),t&&(f>0?(l&&e.cancel(l),l=e(function(){p()},f)):p())}}),e(function(){n.removeAttr("id"),c.attr("id",t.id)}),t.$watch("value",function(e,a){if(e!==a){var i=c.prop("selectionStart");t.isValid=!0,t.isTouched=!1,c.val(e),c.prop({selectionStart:i,selectionEnd:i})}}),c.val(t.value),m(),u=t.value,t.instance&&(t.instance.isInitialized=!0,t.instance.validate=function(){t.isTouched=!0,m()},t.instance.isValid=function(){return t.isValid})}}}])}();