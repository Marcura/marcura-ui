...
!function(){angular.module("marcuraUI.components").directive("maPager",["$timeout",function(e){return{restrict:"E",scope:{page:"=",totalPages:"=",visiblePages:"=",change:"&"},replace:!0,template:function(){var e='<div class="ma-pager"                ><ma-button                    class="ma-button-first"                    text="First"                    size="xs"                    modifier="default"                    click="firstClick()"                    is-disabled="_page <= 1"                ></ma-button><ma-button                    class="ma-button-previous"                    text="Previous"                    size="xs"                    modifier="default"                    click="previousClick()"                    is-disabled="_page <= 1"                ></ma-button><ma-button                    class="ma-button-previous-range"                    text="..."                    size="xs"                    modifier="default"                    click="previousRangeClick()"                    is-disabled="isFirstRange"                ></ma-button><div class="ma-pager-pages"><ma-button                    ng-repeat="rangePage in rangePages"                    class="ma-button-page"                    text="{{rangePage}}"                    size="xs"                    modifier="{{_page === rangePage ? \'selected\' : \'default\'}}"                    click="pageClick(rangePage)"></div></ma-button                ><ma-button                    class="ma-button-next-range"                    text="..."                    size="xs"                    modifier="default"                    click="nextRangeClick()"                    is-disabled="isLastRange"                ></ma-button><ma-button                    class="ma-button-next"                    text="Next"                    size="xs"                    modifier="default"                    click="nextClick()"                    is-disabled="_page >= totalPages"                ></ma-button><ma-button                    class="ma-button-last"                    text="Last"                    size="xs"                    modifier="default"                    click="lastClick()"                    is-disabled="_page >= totalPages"                ></ma-button>            </div>';return e},link:function(a){a._page=a.page;var t=function(){a._visiblePages=a.visiblePages>1?a.visiblePages:5,a.totalPages<a._visiblePages&&(a._visiblePages=a.totalPages),a.rangePages=[],a.range=Math.ceil(a._page/a._visiblePages)-1,a.isFirstRange=0===a.range,a.isLastRange=a.totalPages-a._page<a._visiblePages;for(var e=a.range*a._visiblePages,t=1;t<=a._visiblePages;t++)a.rangePages.push(e+t)},i=function(){a.page!==a._page&&(a.page=a._page,t(),e(function(){a.change({maPage:a.page})}))};a.firstClick=function(){a._page=1,i()},a.previousClick=function(){a._page=a._page<=1?1:a._page-1,i()},a.nextClick=function(){a._page=a._page>=a.totalPages?1:a._page+1,i()},a.lastClick=function(){a._page=a.totalPages,i()},a.pageClick=function(e){a._page=e,i()},a.previousRangeClick=function(){a._page=a.range*a._visiblePages,i()},a.nextRangeClick=function(){a._page=a.range*a._visiblePages+a._visiblePages+1,i()},a.$watch("visiblePages",function(e,a){e!==a&&t()}),a.$watch("page",function(e,i){if(e!==i){var s=a.page;s<1?s=1:s>a.totalPages&&(s=a.totalPages),a._page=s,t()}}),t()}}}])}();
