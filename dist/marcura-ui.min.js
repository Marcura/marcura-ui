...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,l){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canSearch:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@"},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"                        placeholder="{{placeholder}}"/>':'                        <select ui-select2="options"                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.options={},e.canSearch||(e.options.minimumResultsForSearch=-1),e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function t(i,l){if(t.runs=t.runs?t.runs:1,1===t.runs&&e.value&&e.value[e.itemValueField]){var n=angular.copy(e.value);n.text=e.itemTemplate?e.itemTemplate(n):n[e.itemTextField],n.id=n[e.itemValueField],e.previousSelectedItem=n,l(n)}else l();t.runs++})}],link:function(n,o){var s,a,d,u,c,r=angular.element(o[0].querySelector(".ma-select-box-text")),m=null,f=!0,g=!1,p=n.showAddItemTooltip!==!1,v=n.validators?angular.copy(n.validators):[],x=n.isRequired,h=!1;n.previousSelectedItem=n.previousSelectedItem||null,n.isAddMode=!1,n.formatItem=n.itemTemplate||function(e){return e?n.itemTextField?e[n.itemTextField]:e.toString():""},n.isTextFocused=!1,n.isValid=!0,n.isTouched=!1,n.isAjax=angular.isObject(n.ajax);var b=function(e){if(!angular.isArray(n.items))return!1;for(var t=n.itemValueField&&e[n.itemValueField],i=0;i<n.items.length;i++)if(t){if(n.items[i][n.itemValueField]===e[n.itemValueField])return!0}else if(n.items[i]===e)return!0;return!1},F=function(e){if(!e)return null;if(!n.itemTextField)return e;if(angular.isArray(n.items))for(var t=0;t<n.items.length;t++)if(n.items[t][n.itemValueField].toString()===e.toString())return n.items[t];return null},A=function(e){if(!n.itemTextField)return e;if(e){var t={};return t[n.itemTextField]=e,t}return null},T=function(e){n.canAddItem&&e&&(n.isAddMode=!b(e)),S(e),n.isAddMode?(e?n.itemTextField&&e[n.itemTextField]?n.text=e[n.itemTextField].toString():n.text=e:n.text=null,m=e,n.toggleMode("add")):(e?n.isAjax||(n.itemValueField&&e[n.itemValueField]?n.selectedItem=e[n.itemValueField].toString():"string"==typeof e&&(n.selectedItem=e)):n.selectedItem=null,n.previousSelectedItem=e,n.toggleMode("select"))},I=function(e,i){var l=angular.element(e.relatedTarget),o=angular.element(u.dropdown[0].querySelector(".select2-input"));n.isTextFocused=!1,"text"===i?(g=!1,n.$apply(function(){if(n.isTouched=!0,n.itemTextField){if(n.value&&n.value[n.itemTextField]===n.text)return;n.value=A(n.text)}else{if(n.value===n.text)return;n.value=n.text}m=n.value,n.isValid&&t(function(){n.change({maValue:n.value})})})):"select"===i&&n.$apply(function(){n.isTouched=!0}),f=n.canAddItem?!g&&l[0]!==s[0]&&l[0]!==a[0]&&l[0]!==r[0]&&l[0]!==u.focusser[0]&&l[0]!==o[0]:!g&&l[0]!==a[0]&&l[0]!==r[0]&&l[0]!==u.focusser[0]&&l[0]!==o[0],f&&n.blur({item:n.value}),g=!1},S=function(e){if(n.isValid=!0,v&&v.length)for(var t=0;t<v.length;t++)if(!v[t].method(e)){n.isValid=!1;break}},V=function(){n.isAddMode?(r.focus(),n.isTextFocused=!0):d.select2("focus")};n.isResetEnabled=function(){return!n.isDisabled&&(n.isAddMode?!i.isNullOrWhiteSpace(n.text):!i.isNullOrUndefined(n.value))},n.onReset=function(){n.value=null,V(),t(function(){n.change({maValue:n.value})})},n.onFocus=function(e){"text"===e&&(n.isTextFocused=!0),f&&n.focus({item:n.value}),f=!1},r.focusout(function(e){I(e,"text")}),n.getAddItemTooltip=function(){return p?n.isAddMode?"Back to the list":n.addItemTooltip?n.addItemTooltip:"Add new item":""},n.getItemValue=function(e){return n.itemValueField?e[n.itemValueField].toString():e},n.toggleMode=function(e){if(n.canAddItem&&!(n.isAddMode&&"add"===e||!n.isAddMode&&"select"===e)){var i=!1;"select"===e?(n.isAddMode=!1,i=!0):"add"===e?(n.isAddMode=!0,i=!0):n.isAddMode=!n.isAddMode,n.isAddMode?(d&&d.select2("close"),n.previousSelectedItem=F(n.selectedItem),n.value=m,n.value&&(n.text="string"==typeof n.value?n.value:n.value[n.itemTextField])):(m=A(n.text),n.value=n.previousSelectedItem),i||t(function(){n.change({maValue:n.value}),V()})}},n.onChange=function(){var e=i.isJson(n.selectedItem)?JSON.parse(n.selectedItem):n.selectedItem;if(n.isAjax){if(e===n.previousSelectedItem)return;if(!angular.isObject(e))return}if(!n.isAjax&&n.itemValueField&&!i.isNullOrWhiteSpace(e))for(var l=0;l<n.items.length;l++)if(n.items[l][n.itemValueField].toString()===e.toString()){e=n.items[l];break}if(e||n.value){if(n.itemValueField){if(n.value&&n.value[n.itemValueField]&&n.value[n.itemValueField].toString()===e[n.itemValueField].toString())return}else if(e===n.value)return;n.value=e,n.previousSelectedItem=e,t(function(){n.change({maValue:e})})}},n.$watch("value",function(e,t){e!==t&&T(e)}),n.$watch("text",function(e,t){e!==t&&(n.isTouched=!0,S(e))}),n.instance&&(n.instance.switchToSelectMode=function(){n.isAddMode&&n.toggleMode("select")},n.instance.switchToAddMode=function(){n.isAddMode||n.toggleMode("add")},n.instance.isValid=function(){return n.isValid},n.instance.validate=function(){n.isTouched=!0,S(n.value)});for(var M=0;M<v.length;M++)if("IsNotEmpty"===v[M].name){h=!0;break}!h&&x&&v.unshift(l.isNotEmpty()),h&&(x=!0),t(function(){T(n.value),d=angular.element(o[0].querySelector(".select2-container")),u=d.data().select2,c=$('label[for="'+n.id+'"]'),s=angular.element(o[0].querySelector(".ma-button-switch")),a=angular.element(o[0].querySelector(".ma-button-reset")),c.length>0&&$(e).on("click",'label[for="'+n.id+'"]',function(){V()}),u.focusser.on("focus",function(){n.onFocus("select")}),u.focusser.on("focusout",function(e){I(e,"select")}),u.dropdown.on("focus",".select2-input",function(){g=!0,n.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){I(e,"select")}),s.focusout(function(e){I(e)}),a.focusout(function(e){I(e)}),u.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
