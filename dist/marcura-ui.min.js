...
!function(){angular.module("marcuraUI.components").directive("maGridOrder",["maHelper",function(r){return{require:"^^maGrid",restrict:"E",scope:{orderBy:"@"},replace:!0,template:function(){var r='            <div class="ma-grid-order ma-grid-order-{{direction}}"                ng-show="isVisible()"                ng-click="order()">                <i class="fa fa-sort-{{direction}}"></i>            </div>';return r},link:function(e,o,i,a){var n=function(){for(var r=null,o=e.$parent;o&&!r;)o.hasOwnProperty("componentName")&&"maGrid"===o.componentName?r=o:o=o.$parent;return r},d=n(),s=o.closest(".ma-grid-header-col"),c=o.closest(".ma-grid-caption");s.hasClass("ma-grid-header-col-sortable")||s.addClass("ma-grid-header-col-sortable");var t=function(){d.orderBy=e.orderBy,d.orderIsReverse=!d.orderIsReverse,e.direction=d.orderIsReverse?"desc":"asc"};d.orderBy===e.orderBy&&(e.direction=d.orderIsReverse?"desc":"asc"),e.isVisible=function(){return d.orderBy===e.orderBy},c.on("click",function(){r.safeApply(function(){t()})})}}}])}();
