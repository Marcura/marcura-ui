...
!function(){angular.module("marcuraUI.components").provider("maTextBoxConfiguration",function(){this.$get=function(){return this}}).directive("maTextBox",["$timeout","maHelper","maValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",changeWhenIsInvalid:"=",blur:"&",focus:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"=",max:"=",min:"=",decimals:"=",reset:"&"},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text";"number"===i&&(i="text");var n="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return n},controller:["$scope","maTextBoxConfiguration",function(e,a){e.configuration={},e.decimals>=0?e.configuration.decimals=e.decimals:a.decimals>=0?e.configuration.decimals=a.decimals:e.configuration.decimals=2}],link:function(n,t){var s,o,l,u,r,c=angular.element(t[0].querySelector(".ma-text-box-value")),d=angular.element(t[0].querySelector(".ma-button-reset")),f=angular.element(t[0].querySelector(".ma-button-toggle-password")),m=[],g=n.isRequired,v=Number(n.changeTimeout),b=!0,p=n.trim!==!1,h=!1,x=null,y=n.configuration.decimals,w=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==n.type&&p&&(e=e.trim()),l=e},V=function(){var e=c.val();return"number"===n.type?k(e):e},T=function(){n.isValid=!0,x=null;var e=c.val();if("number"===n.type&&(e=R(e)),m&&m.length)for(var a=0;a<m.length;a++)if(!m[a].validate(e)){n.isValid=!1,x=m[a];break}},P=function(a){if(O(a)){h=!0;var i=l;"number"!==n.type&&p&&(i=i.trim(),a=a.trim()),n.value=a,w(a),e(function(){n.change({maValue:a,maOldValue:i})})}},O=function(e){e=a.isNullOrUndefined(e)?"":e;var i=a.isNullOrUndefined(l)?"":l,t=!1;return t="number"!==n.type&&p?i.trim()!==e.trim():i!==e},E=function(){return n.isTouched=!0,O(V())?(T(),void((n.isValid||n.changeWhenIsInvalid)&&P(V()))):void T()},k=function(e){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(R(e)),e=parseFloat(e.toFixed(y)))},F=function(e){if(a.isNullOrWhiteSpace(e))return"";var i=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),n=e.replace(/(\.\d+)$/,""),t=n.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+t+i},R=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(",","")},I=function(e){if(a.isNullOrWhiteSpace(e))return e;var i=e;return"number"===n.type&&(i=F(e.toFixed(y))),i},N=function(){var e=!1;m=n.validators?angular.copy(n.validators):[];for(var a=0;a<m.length;a++)if("IsNotEmpty"===m[a].name){e=!0;break}!e&&g&&m.unshift(i.isNotEmpty()),e&&(g=!0),"number"===n.type&&(m.push(i.isNumber(!0)),"number"==typeof n.min&&m.push(i.isGreaterOrEqual(n.min,!0)),"number"==typeof n.max&&m.push(i.isLessOrEqual(n.max,!0)))};N(),n.isValueFocused=!1,n.isTouched=!1,n.canTogglePassword=!1,n.isPasswordVisible=!1,"password"===n.type&&(n.canTogglePassword=n.hasShowPasswordButton!==!1),n.isResetEnabled=function(){return!n.isDisabled&&""!==c.val()},n.doReset=function(){w(V()),c.val("")},n.onReset=function(){n.isDisabled||(n.doReset(),n.isTouched=!0,P("number"===n.type?null:""),T(),c.focus(),e(function(){n.reset()}))},n.onFocus=function(e){"value"===e&&(n.isValueFocused=!0,"number"===n.type&&!a.isNullOrUndefined(n.value)&&n.isValid&&c.val(n.value.toFixed(y))),b&&(r=n.value,n.focus({maValue:n.value})),b=!1},c.focusout(function(e){q(e,"value")}),d.focusout(function(e){q(e)}),f.focusout(function(e){q(e)}),n.togglePassword=function(){n.isPasswordVisible=!n.isPasswordVisible,c[0].type=n.isPasswordVisible?"text":"password"},n.isTogglePasswordEnabled=function(){return!n.isDisabled&&""!==c.val()};var q=function(i,t){var s=angular.element(i.relatedTarget);b=n.canTogglePassword?s[0]!==c[0]&&s[0]!==f[0]&&s[0]!==d[0]:s[0]!==c[0]&&s[0]!==d[0],u&&e.cancel(u),"value"===t&&n.isValid&&c.val(I(n.value)),a.safeApply(function(){n.isValueFocused=!1}),b&&(E(),a.safeApply(function(){n.blur({maValue:n.value,maOldValue:r,maHasValueChanged:r!==n.value})}))};n.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(s=angular.element(e.target).val())},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var n=!1;o=angular.element(i.target).val(),s!==o&&(n=!0),n&&(u&&e.cancel(u),u=e(function(){E()},v))}}),e(function(){t.removeAttr("id"),c.attr("id",n.id)}),n.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){O(e)&&(n.isTouched=!0);var i=c.prop("selectionStart");w(e),c.val(I(e)),T(),n.isValueFocused&&c.prop({selectionStart:i,selectionEnd:i})}});var C=function(e,a){if(e!==a){var i=V();N();for(var t=[],s=0;s<m.length;s++)"IsGreaterOrEqual"!==m[s].name&&"IsLessOrEqual"!==m[s].name||t.push(m[s]);if(t.length){for(!x||"IsGreaterOrEqual"!==x.name&&"IsLessOrEqual"!==x.name||(x=null,n.isValid=!0),s=0;s<t.length;s++)if(!t[s].validate(i)){n.isValid=!1,x=t[s];break}n.isValid||(n.isTouched=!0)}(n.isValid||n.changeWhenIsInvalid)&&P(i)}};n.$watch("max",function(e,a){C(e,a)}),n.$watch("min",function(e,a){C(e,a)}),c.val(I(n.value)),T(),w(n.value),n.instance&&(n.instance.isInitialized=!0,n.instance.validate=function(){n.isTouched=!0,T()},n.instance.isValid=function(){return n.isValid},n.instance.focus=function(){n.isValueFocused||c.focus()},n.instance.failedValidator=function(){return x},n.instance.clear=function(){n.doReset(),e(function(){n.isTouched=!1})})}}}])}();