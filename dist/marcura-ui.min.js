...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","maHelper","maValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",minDate:"=",maxDate:"="},replace:!0,template:function(){var e='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            ng-disabled="isDisabled"                            ng-focus="onFocus()"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"                            ng-blur="onBlur()"/><input class="ma-date-box-hours"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minutes" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return e},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,d,l,u=null,r=i.configuration.displayFormat,c=i.configuration.format,m=i.configuration.timeZone,f=angular.element(o[0].querySelector(".ma-date-box-date")),y=angular.element(o[0].querySelector(".ma-date-box-hours")),v=angular.element(o[0].querySelector(".ma-date-box-minutes")),g=null,b=a.parseTimeZone(m),h=0,p=i.validators?angular.copy(i.validators):[],k=i.isRequired,x=new a(i.minDate),D=new a(i.maxDate),w=function(t){var n=null;g=t,t&&(n=moment(new Date),n.year(t.year()).month(t.month()).date(t.date()).hours(t.hours()).minutes(t.minutes()).seconds(0)),i.value=n?a.format(n,c,m):null,e(function(){i.change({maValue:i.value})})},T=function(e){return!(null===g&&null===e||g&&e&&0===g.diff(e))&&(i.isTouched=!0,!0)},C=function(e){var t=null;e&&e.date?(t=a.offsetUtc(e.date,b-e.offset),f.val(a.format(t,r)),y.val(a.format(t,"HH")),v.val(a.format(t,"mm")),s||(s=f.val())):(f.val(""),y.val("00"),v.val("00")),V(t)},V=function(e){u&&u.setDate(e?e.toDate():null,!0)},F=function(e){var t=new a;return e?(t=i.parser?i.parser(e):a.parse(e,i.culture),t.date=moment(t.date),t):t},E=function(e){var a=moment(e);return moment([a.year(),a.month(),a.date(),Number(y.val()),Number(v.val()),0])},K=function(){h=b},R=function(){u=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",minDate:x.isEmpty()?null:x.date,maxDate:D.isEmpty()?null:D.date,onSelect:function(){var t=a.offsetUtc(u.getDate());e(function(){i.isValid=!0}),i.hasTime&&(t=E(t),K()),T(t)&&w(t)}}),V(g)},q=function(){u&&u.destroy()},Z=function(e){i.isValid=!0;var t=a.format(e,c);if(p&&p.length)for(var n=0;n<p.length;n++)if(!p[n].method(t)){i.isValid=!1;break}},B=function(){for(var e=!1,a=0;a<p.length;a++)if("IsNotEmpty"===p[a].name){e=!0;break}!e&&k&&p.unshift(n.isNotEmpty()),e&&(k=!0),x.isEmpty()||p.push(n.isGreaterThanOrEqual(x)),D.isEmpty()||p.push(n.isLessThanOrEqual(D))};if(B(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.isResetEnabled=function(){return!i.isDisabled&&(f.val()||"00"!==y.val()||"00"!==v.val())},i.onFocus=function(){i.isFocused=!0},i.onBlur=function(){i.isFocused=!1,i.isTouched=!0;var e=f.val().trim(),t=""===e,n=Number(y.val()),o=Number(v.val()),d=new a;return n>=0&&n<=23&&o>=0&&o<=59?(d=F(e),d.offset=h,t?(Z(d.date),void(i.isValid&&(C(),w()))):d.date?(d.date&&(i.hasTime||s===e)&&(d.date=E(d.date),d.date=a.offsetUtc(d.date,-(b-h))),Z(d.date),T(d.date)?(d.date&&C(d),void(i.isValid&&w(d.date))):void C(d)):void(i.isValid=!1)):void(i.isValid=!1)},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(d=angular.element(e.target).val())},i.onKeyup=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(l=angular.element(e.target).val(),d!==l&&(i.isTouched=!0,K()))},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(g=null,i.isValid=!k,i.isTouched=!0,w(),C(),f.focus())},i.value){var M={date:null,offset:0};if(M=a.parse(i.value,i.culture)||M,M.date=a.offsetUtc(M.date),!M.date)return;C(M),g=M.date,h=M.offset}e(function(){i.isDisabled||R(),o.removeAttr("id"),f.attr("id",i.id)}),i.$watch("value",function(e,a){if(null!==e||null!==a){var t=F(e);if(null===t.date&&(g=null,C(null)),!T(t.date))return void C(t);C(t),g=t.date,h=t.offset}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?q():R())}),i.instance&&(i.instance.validate=function(){return i.isTouched=!0,k&&!i.value?void(i.isValid=!1):void Z(F(i.value).date)},i.instance.isValid=function(){return i.isValid})}}}])}();
