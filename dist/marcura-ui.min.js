...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","maHelper","maValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",minDate:"=",maxDate:"="},replace:!0,template:function(e,a){var t='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            ng-disabled="isDisabled"                            ng-focus="onFocus()"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"                            ng-blur="onBlur()"/><input class="ma-date-box-hours"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minutes" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-focus="onFocus()"                                ng-keydown="onKeydown($event)"                                ng-keyup="onKeyup($event)"                                ng-blur="onBlur()"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return t},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,l,d,r=null,u=i.configuration.displayFormat,c=i.configuration.format,m=i.configuration.timeZone,f=angular.element(o[0].querySelector(".ma-date-box-date")),v=angular.element(o[0].querySelector(".ma-date-box-hours")),y=angular.element(o[0].querySelector(".ma-date-box-minutes")),g=null,h=a.parseTimeZone(m),b=0,p=[],D=i.isRequired,k=new a(i.minDate),x=new a(i.maxDate),w=function(t){var n=null;g=t,t&&(n=moment(new Date),n.year(t.year()).month(t.month()).date(t.date()).hours(t.hours()).minutes(t.minutes()).seconds(0)),i.value=n?a.format(n,c,m):null,e(function(){i.change({maValue:i.value})})},T=function(e){return!(null===g&&null===e||g&&e&&0===g.diff(e))&&(i.isTouched=!0,!0)},E=function(e){var t=null;e&&!e.isEmpty()?(t=a.offsetUtc(e.date(),h-e.offset()),f.val(a.format(t,u)),v.val(a.format(t,"HH")),y.val(a.format(t,"mm")),s||(s=f.val())):(f.val(""),v.val("00"),y.val("00")),C(t)},C=function(e){r&&r.setDate(e?e.toDate():null,!0)},V=function(){if(r){x=new a(i.maxDate);var e=x.date();e||(e=new Date,e=new Date(e.setFullYear(e.getFullYear()+100)),x=new a(e)),r.setMaxDate(e)}},F=function(){if(r){k=new a(i.minDate);var e=k.date();e||(e=new Date,e=new Date(e.setFullYear(e.getFullYear()-100)),k=new a(e)),r.setMinDate(e)}},q=function(e){var t=a.createEmpty();return e?(t=i.parser?i.parser(e):a.parse(e,i.culture),t.isEmpty()||t.date(moment(t.date())),t):t},K=function(e){var a=moment(e);return moment([a.year(),a.month(),a.date(),Number(v.val()),Number(y.val()),0])},R=function(){b=h},M=function(){r=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",onSelect:function(){var t=new a(r.getDate());return t.date(a.offsetUtc(t.date())),i.hasTime&&(t.date(K(t.date())),R()),e(function(){I(t.date())}),T(t.date())?void w(t.date()):void E(t)}}),C(g),V(),F()},Z=function(){r&&r.destroy()},B=null,I=function(e){i.isValid=!0,B=null;var t=e?a.format(e,c):null;if(p&&p.length)for(var n=0;n<p.length;n++)if(!p[n].validate(t)){i.isValid=!1,B=p[n];break}},N=function(){var e=!1;p=i.validators?angular.copy(i.validators):[];for(var a=0;a<p.length;a++)if("IsNotEmpty"===p[a].name){e=!0;break}!e&&D&&p.unshift(n.isNotEmpty()),e&&(D=!0),k.isEmpty()||p.push(n.isGreaterThanOrEqual(k,!0)),x.isEmpty()||p.push(n.isLessThanOrEqual(x,!0))};if(N(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.isResetEnabled=function(){return!i.isDisabled&&(f.val()||"00"!==v.val()||"00"!==y.val())},i.onFocus=function(){i.isFocused=!0},i.onBlur=function(){i.isFocused=!1,i.isTouched=!0;var e=f.val().trim(),t=""===e,n=Number(v.val()),o=Number(y.val()),l=a.createEmpty();return n>=0&&n<=23&&o>=0&&o<=59?(l=q(e),l.offset(b),t&&null===g?void I(null):t?(I(l.date()),void(i.isValid&&(E(),w()))):l.isEmpty()?void(i.isValid=!1):(l.isEmpty()||!i.hasTime&&s!==e||(l.date(K(l.date())),l.date(a.offsetUtc(l.date(),-(h-b)))),I(l.date()),T(l.date())?(l.date()&&E(l),void(i.isValid&&w(l.date()))):void E(l))):void(i.isValid=!1)},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(l=angular.element(e.target).val())},i.onKeyup=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(d=angular.element(e.target).val(),l!==d&&(i.isTouched=!0,R()))},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(g=null,i.isTouched=!0,I(null),w(),E(),f.focus())},i.value){var O=a.parse(i.value,i.culture);if(O.date(a.offsetUtc(O.date())),O.isEmpty())return;E(O),g=O.date(),b=O.offset()}e(function(){i.isDisabled||M(),o.removeAttr("id"),f.attr("id",i.id)}),i.$watch("value",function(e,a){if(null!==e||null!==a){var t=q(e);if(t.isEmpty()&&(g=null,E(null)),!T(t.date()))return void E(t);E(t),g=t.date(),b=t.offset()}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?Z():M())});var Y=function(e,t,n){if(e!==t){var o=q(f.val().trim());"maxDate"===n?V():F(),N();for(var s=[],l=0;l<p.length;l++)"IsGreaterThanOrEqual"!==p[l].name&&"IsLessThanOrEqual"!==p[l].name||s.push(p[l]);if(s.length){var d=o.date()?a.format(o.date(),c):null;for(!B||"IsGreaterThanOrEqual"!==B.name&&"IsLessThanOrEqual"!==B.name||(B=null,i.isValid=!0),l=0;l<s.length;l++)if(!s[l].validate(d)){i.isValid=!1,B=s[l];break}i.isValid||(i.isTouched=!0)}i.isValid&&T(o.date())&&w(o.date())}};i.$watch("maxDate",function(e,a){Y(e,a,"maxDate")}),i.$watch("minDate",function(e,a){Y(e,a,"minDate")}),i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){return i.isTouched=!0,D&&!i.value?void(i.isValid=!1):void I(q(i.value).date())},i.instance.isValid=function(){return i.isValid},i.instance.failedValidator=function(){return B})}}}])}();
...
!function(){angular.module("marcuraUI.services").factory("MaDate",[function(){function e(t,r){if(this._date=t||null,this._offset=r||0,t instanceof e&&(this._date=t.date(),this._offset=t.offset()),angular.isString(t)){var n=u(t);this._date=n.date(),this._offset=n.offset()}0===arguments.length&&(this._date=new Date)}var t=[{language:"en",items:["January","February","March","April","May","June","July","August","September","October","November","December"]}],r=[31,28,31,30,31,30,31,31,30,31,30,31],n=function(e){return!!e&&("[object Date]"===Object.prototype.toString.call(e)&&e.getTime&&!isNaN(e.getTime()))},a=function(e,t){return e.match(new RegExp(t,"i"))},i=function(n,i,s,u,o,c,f){var d,l=e.createEmpty();s=s.toString(),i=i.toString(),u=u||0,o=o||0,c=c||0,f=f||0,n<=99&&(n=n>=0&&n<30?"20"+n:"19"+n);var m=1===new Date(n,1,29).getMonth();if(m?r[1]=29:r[1]=28,null!==i.match(/([^\u0000-\u0080]|[a-zA-Z])$/)){for(var h=0;h<t.length;h++)for(var y=0;y<t[h].items.length;y++)if(a(i,t[h].items[y].slice(0,3))){d=y+1;break}if(!d)return l;i=d}return i>12?l:s>r[i-1]?l:(l=new e(new Date(n,i-1,s,u,o,c)),l.offset(f),l)},s=function(e,t,r){var n={day:e,month:t,isValid:!0};return"en-GB"===r&&t>12&&(n.isValid=!1),"en-US"===r&&(n.day=t,n.month=e,e>12&&(n.isValid=!1)),!r&&t>12&&(n.day=t,n.month=e),n},u=function(t,r){var n,a,u,o=e.createEmpty();if(t instanceof Date||t instanceof e)return t;if(!angular.isString(t))return o;if(n=/^\d{1,2}$/,null!==t.match(n)){var c=new Date;return i(c.getFullYear(),c.getMonth()+1,t)}if(n=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),u=s(a[1],a[3],r),u.isValid?i((new Date).getFullYear(),u.month,u.day):o;if(n=/^(\d{1,2})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(n))return a=n.exec(t),i(a[5],a[3],a[1]);if(n=/([^\u0000-\u0080]|[a-zA-Z]{3})(\s|)(\d{1,2})(,)(\s|)(\d{2,4})$/,null!==t.match(n))return a=n.exec(t),i(a[6],a[1],a[3]);if(n=/^([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(n))return a=n.exec(t),i(a[5],a[1],a[3]);if(n=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),i(a[1],a[3],a[5]);if(n=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4})$/,null!==t.match(n))return a=n.exec(t),u=s(a[1],a[3],r),u.isValid?i(a[5],u.month,u.day):o;if(n=/^(\d{4})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),i(a[1],a[3],a[5]);if(n=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})T(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)(?:Z|([+-])(2[0-3]|[01][0-9]):([0-5][0-9]))$/,null!==t.match(n)){a=n.exec(t);var f=0;return 12===a.length&&(f=60*(Number(a[10])||0)+(Number(a[11])||0),"-"===a[9]&&0!==f&&(f=-f)),i(a[1],a[3],a[5],a[6],a[7],a[8],f)}return o},o=function(e,r,a){var i=0,s=e&&e.isValid&&e.isValid();if(r=angular.isString(r)?r:"yyyy-MM-ddTHH:mm:ssZ",a=a||"",!n(e)&&!s)return null;var u={s:["ss"],m:["mm"],H:["HH"],d:["d","dd"],M:["M","MM","MMM","MMMM"],y:["yy","yyyy"],Z:["Z"]},o=function(e){var t="";try{t=r.match(new RegExp(e+"+",""))[0]}catch(n){}return u[e].indexOf(t)},c=function(e,t){for(var r="",n=0;n<t;n++)r+="0";return(r+e).slice(-t)},f=s?e.date():e.getDate(),d=s?e.month():e.getMonth(),l=s?e.year():e.getFullYear(),m=s?e.hours():e.getHours(),h=s?e.minutes():e.getMinutes(),y=s?e.seconds():e.getSeconds(),p=function(e){var r="";switch(e){case u.d[0]:r=f;break;case u.d[1]:r=c(f,2);break;case u.M[0]:r=d+1;break;case u.M[1]:r=c(d+1,2);break;case u.M[2]:r=t[i].items[d].substr(0,3);break;case u.M[3]:r=t[i].items[d];break;case u.y[0]:r=c(l,2);break;case u.y[1]:r=l;break;case u.H[0]:r=c(m,2);break;case u.m[0]:r=c(h,2);break;case u.s[0]:r=c(y,2);break;case u.Z[0]:r=a||"Z";break;default:return""}return r},g={days:p(u.d[o("d")]),months:p(u.M[o("M")]),years:p(u.y[o("y")]),hours:p(u.H[o("H")]),minutes:p(u.m[o("m")]),seconds:p(u.s[o("s")]),timeZone:p(u.Z[0]),separator:/^\w+([^\w])/.exec(r)};return r.replace(/d+/,g.days).replace(/y+/,g.years).replace(/M+/,g.months).replace(/H+/,g.hours).replace(/m+/,g.minutes).replace(/s+/,g.seconds).replace(/Z+/,g.timeZone)},c=function(e,t){if(!e)return null;if(t=t||0,n(e)||e.isValid&&e.isValid())return moment(e).add(t,"m");if("string"==typeof e){var r=moment(e).minute(moment(e).minute()+moment().utcOffset()*-1+t);return r.isValid()?r:null}},f=function(t,r){return new e(t).valueOf()-new e(r).valueOf()},d=function(e){if(!e)return 0;e=e.replace(/GMT/gi,"");var t=/^(?:Z|([+-]?)(2[0-3]|[01][0-9]):([0-5][0-9]))$/.exec(e);if(!t||4!==t.length)return 0;if("Z"===t[0])return 0;var r=60*Number(t[2])+Number(t[3]);return 0!==r&&"-"===t[1]&&(r*=-1),r};return e.prototype.date=function(e){return 0===arguments.length?this._date:void(this._date=e)},e.prototype.offset=function(e){return 0===arguments.length?this._offset:void(this._offset=e)},e.prototype.isEmpty=function(){return!this._date},e.prototype.difference=function(e){return f(this,e)},e.prototype.valueOf=function(){if(this.isEmpty())return 0;var e=this._date.valueOf();return 0!==this._offset&&(e-=6e4*this._offset),e},e.prototype.format=function(e,t){return this.isEmpty()?null:o(this._date,e,t)},e.prototype.add=function(e,t){return this.isEmpty()||!e?this:("day"===t&&this._date.setTime(this._date.valueOf()+864e5*e),this)},e.prototype.second=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getSeconds():void this._date.setSeconds(e)},e.prototype.minute=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getMinutes():void this._date.setMinutes(e)},e.prototype.hour=function(e){return this.isEmpty()?0:0===arguments.length?this._date.getHours():void this._date.setHours(e)},e.createEmpty=function(){return new e(null)},e.parse=u,e.parseTimeZone=d,e.format=o,e.offsetUtc=c,e.isDate=n,e.difference=f,e}])}();
