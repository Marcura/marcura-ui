...
!function(){angular.module("marcuraUI.components").provider("maDateBoxConfiguration",function(){this.$get=function(){return this}}).directive("maDateBox",["$timeout","MaDate","MaHelper","MaValidators",function(e,a,t,n){return{restrict:"E",scope:{id:"@",value:"=",timeZone:"=",culture:"=",isDisabled:"=",isRequired:"=",change:"&",validate:"&",canReset:"=",displayFormat:"=",format:"=",hasTime:"=",parser:"=",validators:"=",instance:"=",min:"=",max:"=",changeTimeout:"=",placeholder:"@"},replace:!0,template:function(e){var a='                <div class="ma-date-box" ng-class="{                        \'ma-date-box-has-time\': hasTime,                        \'ma-date-box-is-invalid\': !isValid,                        \'ma-date-box-is-disabled\': isDisabled,                        \'ma-date-box-is-focused\': isFocused,                        \'ma-date-box-is-touched\': isTouched,                        \'ma-date-box-can-reset\': canReset,                        \'ma-date-box-is-reset-disabled\': canReset && !isDisabled && !isResetEnabled(),                        \'ma-date-box-has-value\': hasValue()                    }">                    <div class="ma-date-box-inner">                        <input class="ma-date-box-date" type="text" id="{{id}}"                            placeholder="{{placeholder}}"                            ng-disabled="isDisabled"                            ng-keydown="onKeydown($event)"                            ng-keyup="onKeyup($event)"/><input class="ma-date-box-hour"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"                                /><div class="ma-date-box-colon" ng-if="hasTime">:</div><input                                 class="ma-date-box-minute" type="text"                                maxlength="2"                                ng-disabled="isDisabled"                                ng-show="hasTime"                                ng-keyup="onKeyup($event)"                                ng-keydown="onTimeKeydown($event)"/>                        <i class="ma-date-box-icon fa fa-calendar"></i>                    </div>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>';return a},controller:["$scope","maDateBoxConfiguration",function(e,a){e.configuration={},e.configuration.displayFormat=(e.displayFormat||a.displayFormat||"dd MMM yyyy").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.format=(e.format||a.format||"yyyy-MM-ddTHH:mm:ssZ").replace(/Y/g,"y").replace(/D/g,"d"),e.configuration.timeZone=(e.timeZone||a.timeZone||"Z").replace(/GMT/g,"")}],link:function(i,o){var s,u,l,r,d,c,m,f=null,v=i.configuration.displayFormat,y=i.configuration.format,p=i.configuration.timeZone,b=angular.element(o[0].querySelector(".ma-date-box-date")),h=angular.element(o[0].querySelector(".ma-date-box-hour")),g=angular.element(o[0].querySelector(".ma-date-box-minute")),x=a.createEmpty(),E=a.parseTimeZone(p),k=0,D=[],w=i.isRequired,T=new a(i.min),V=new a(i.max),C=null,F=Number(i.changeTimeout),q=0,M=0,R=0,S=function(e){return!x.isEqual(e)&&(i.isTouched=!0,!0)},K=function(a){var t=null;a&&!a.isEmpty()?(t=a.copy().toUtc().add(E,"minute"),b.val(t.format(v)),h.val(t.format("HH")),g.val(t.format("mm")),s||(s=b.val())):(b.val(""),h.val("00"),g.val("00")),i.isFocused&&(ee(),te(),d&&b.prop({selectionStart:q,selectionEnd:q}),c&&h.prop({selectionStart:M,selectionEnd:M}),m&&g.prop({selectionStart:R,selectionEnd:R}),e(function(){_(),ae()})),f&&f.setDate(t?t.toDate():null,!0)},Z=function(){f&&(V=new a(i.max),V.isEmpty()&&(V=(new a).add(100,"year")),f.setMaxDate(V.toDate()))},B=function(){f&&(T=new a(i.min),T.isEmpty()&&(T=(new a).subtract(100,"year")),f.setMinDate(T.toDate()))},I=function(e){var t=a.createEmpty();return e?t=i.parser?i.parser(e):a.parse(e,i.culture):t},N=function(e){e.hour(Number(h.val())).minute(Number(g.val())).second(0)},O=function(){k=E},H=function(){f=new Pikaday({field:angular.element(o[0].querySelector(".ma-date-box-icon"))[0],position:"bottom right",onSelect:function(){var t=new a(f.getDate());return t.offset(E),i.hasTime&&(N(t),O()),e(function(){A(t)}),S(t)?void z(t):void K(t)}}),K(x),Z(),B()},G=function(){f&&f.destroy()},A=function(e,a){i.isValid=!0,C=null;var t=e?e.format(y):null;if(D&&D.length)for(var n=0;n<D.length;n++)if(!D[n].validate(t)){i.isValid=!1,C=D[n];break}a!==!1&&U(e)},L=function(){var e=!1;D=i.validators?angular.copy(i.validators):[];for(var a=0;a<D.length;a++)if("IsNotEmpty"===D[a].name){e=!0;break}!e&&w&&D.unshift(n.isNotEmpty()),e&&(w=!0),T.isEmpty()||D.push(n.isGreaterOrEqual(T,!0)),V.isEmpty()||D.push(n.isLessOrEqual(V,!0))},z=function(t){x=t||a.createEmpty(),i.value=t?t.format(y):null,e(function(){i.change({maValue:i.value})})},U=function(a){e(function(){i.validate({maValue:a?a.format(y):null})})},Y=function(){i.isTouched=!0;var e=b.val().trim(),t=""===e,n=Number(h.val()),o=Number(g.val()),u=a.createEmpty();return n>=0&&n<=23&&o>=0&&o<=59?(u=I(e),u.offset(k),t&&x.isEmpty()?void A(null):t?(A(u),void(i.isValid&&(K(null),z()))):u.isEmpty()?void(i.isValid=!1):(u.isEmpty()||!i.hasTime&&s!==e||(N(u),u.subtract(E-k,"minute")),A(u),S(u)?(u.isEmpty()||K(u),void(i.isValid&&z(u))):void K(u))):void(i.isValid=!1)},P=function(){d=!0,c=!1,m=!1,i.onFocus()},j=function(){c=!0,d=!1,m=!1,i.onFocus()},J=function(){m=!0,d=!1,c=!1,i.onFocus()},Q=function(){d=!1,i.onBlur()},W=function(){c=!1,i.onBlur()},X=function(){m=!1,i.onBlur()},_=function(){ee(),$(".ma-date-box-date",o).on("focus",P),$(".ma-date-box-hour",o).on("focus",j),$(".ma-date-box-minute",o).on("focus",J)},ee=function(){$(".ma-date-box-date",o).off("focus",P),$(".ma-date-box-hour",o).off("focus",j),$(".ma-date-box-minute",o).off("focus",J)},ae=function(){te(),$(".ma-date-box-date",o).on("blur",Q),$(".ma-date-box-hour",o).on("blur",W),$(".ma-date-box-minute",o).on("blur",X)},te=function(){$(".ma-date-box-date",o).off("blur",Q),$(".ma-date-box-hour",o).off("blur",W),$(".ma-date-box-minute",o).off("blur",X)};if(L(),i.isFocused=!1,i.isValid=!0,i.isTouched=!1,i.hasValue=function(){return b.val()||"00"!==h.val()||"00"!==g.val()},i.isResetEnabled=function(){return!i.isDisabled&&(b.val()||"00"!==h.val()||"00"!==g.val())},i.onFocus=function(){t.safeApply(function(){i.isFocused=!0})},i.onBlur=function(){r&&e.cancel(r),i.$apply(function(){i.isFocused=!1,Y()})},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(u=angular.element(e.target).val())},i.onKeyup=function(a){if(a.keyCode!==t.keyCode.tab&&a.keyCode!==t.keyCode.shift){var n=!1;l=angular.element(a.target).val(),u!==l&&(n=!0,i.isTouched=!0,O()),n&&F>0&&(q=b.prop("selectionStart"),M=h.prop("selectionStart"),R=g.prop("selectionStart"),r&&e.cancel(r),r=e(function(){Y()},F))}},i.onTimeKeydown=function(e){$.inArray(e.keyCode,[t.keyCode.backspace,t.keyCode.tab,t.keyCode["delete"]])===-1&&37!==e.keyCode&&39!==e.keyCode&&(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()},i.onReset=function(){i.isDisabled||(x=a.createEmpty(),i.isTouched=!0,A(null),z(),K(null),b.focus())},i.value){var ne=I(i.value);if(ne.isEmpty())return;K(ne),x=ne,k=ne.offset()}_(),ae(),e(function(){i.isDisabled||H(),o.removeAttr("id"),b.attr("id",i.id)}),i.$watch("value",function(e,t){if(null!==e||null!==t){var n=I(e);if(n.isEmpty()&&(x=a.createEmpty(),K(null)),!S(n))return void K(n);A(n,!1),K(n),x=n,k=n.offset()}}),i.$watch("isDisabled",function(e,a){e!==a&&(i.isDisabled?G():H())});var ie=function(e,a,t){if(e!==a){var n=I(b.val().trim());n.offset(E),"maxDate"===t?Z():B(),L();for(var o=[],s=0;s<D.length;s++)"IsGreaterOrEqual"!==D[s].name&&"IsLessOrEqual"!==D[s].name||o.push(D[s]);if(o.length){var u=n.format(y);for(!C||"IsGreaterOrEqual"!==C.name&&"IsLessOrEqual"!==C.name||(C=null,i.isValid=!0),s=0;s<o.length;s++)if(!o[s].validate(u)){i.isValid=!1,C=o[s];break}i.isValid||(i.isTouched=!0),U(n)}i.isValid&&S(n)&&z(n)}};i.$watch("maxDate",function(e,a){ie(e,a,"maxDate")}),i.$watch("minDate",function(e,a){ie(e,a,"minDate")}),i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){return i.isTouched=!0,w&&!i.value?void(i.isValid=!1):void A(I(i.value))},i.instance.isValid=function(){return i.isValid},i.instance.failedValidator=function(){return C},i.instance.refresh=function(){var e=I(i.value);K(e),A(e,!1)})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maLabel",[function(){return{restrict:"E",transclude:!0,scope:{cutOverflow:"=","for":"@",isRequired:"="},replace:!0,template:function(){var e='                <div class="ma-label" ng-class="{                    \'ma-label-is-required\': isRequired,                    \'ma-label-has-content\': hasContent,                    \'ma-label-cut-overflow\': cutOverflow                }">                    <label class="ma-label-text" for="{{for}}"><ng-transclude></ng-transclude></label><!--                    --><div class="ma-label-star" ng-if="isRequired">&nbsp;<i class="fa fa-star"></i></div>                </div>';return e},link:function(e,a){e.hasContent=a.find("span").contents().length>0}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maRadioBox",["MaHelper","$timeout","$sce","MaValidators",function(e,i,a,t){var s={};return{restrict:"E",scope:{item:"=",itemTemplate:"=",itemTextField:"@",itemValueField:"@",value:"=",isDisabled:"=",hideText:"=",change:"&",size:"@",isRequired:"=",validators:"=",instance:"=",id:"@",modifier:"@"},replace:!0,template:function(){var e='            <div class="ma-radio-box{{cssClass}}"                ng-focus="onFocus()"                ng-blur="onBlur()"                ng-keypress="onKeypress($event)"                ng-click="onChange()"                ng-class="{                    \'ma-radio-box-is-checked\': isChecked(),                    \'ma-radio-box-is-disabled\': isDisabled,                    \'ma-radio-box-has-text\': hasText(),                    \'ma-radio-box-is-focused\': isFocused,                    \'ma-radio-box-is-invalid\': !isValid,                    \'ma-radio-box-is-touched\': isTouched                }">                <span class="ma-radio-box-text" ng-bind-html="getItemText()"></span>                <div class="ma-radio-box-inner"></div>                <i class="ma-radio-box-icon" ng-show="isChecked()"></i>            </div>';return e},link:function(n,l,o){var d=null,r=!n.itemTextField&&!n.itemValueField,u=n.validators?angular.copy(n.validators):[],m=n.isRequired,c=!1,f=function(i){if(!e.isNullOrWhiteSpace(i)){i=i.split(" ");for(var a=0;a<i.length;a++)l.removeClass("ma-radio-box-"+i[a])}var t="";e.isNullOrWhiteSpace(n.modifier)||(t=n.modifier.split(" "));for(var s=0;s<t.length;s++)l.addClass("ma-radio-box-"+t[s])},v=function(){n.isDisabled?l.removeAttr("tabindex"):l.attr("tabindex","0")},h=function(){var e=null,i=n.$parent,a=o.value;for(a.indexOf(".")!==-1&&(d=a.split("."),a=d[0]);i&&!e;)i.hasOwnProperty(a)?e=i:i=i.$parent;return e},b=h();n._size=n.size?n.size:"xs",n.cssClass=" ma-radio-box-"+n._size,n.isFocused=!1,n.isValid=!0,n.isTouched=!1,n.id&&(s[n.id]||(s[n.id]=[]),s[n.id].push(n));var x=function(e){if(s[n.id])for(var i=0;i<s[n.id].length;i++){var a=s[n.id][i];a.isTouched=!0,a.validateThis(a.value)}else n.isTouched=!0,n.validateThis(e)};n.validateThis=function(e){if(n.isValid=!0,u&&u.length)for(var i=0;i<u.length;i++)if(!u[i].validate(e)){n.isValid=!1;break}},n.getItemText=function(){if(n.hideText)return e.html.nbsp;var i;return n.itemTemplate?i=n.itemTemplate(n.item):r?i=n.item:n.itemTextField&&(i=n.item[n.itemTextField]),angular.isString(i)&&i||(i=e.html.nbsp),a.trustAsHtml(i)},n.hasText=function(){return n.getItemText()!==e.html.nbsp},n.isChecked=function(){return r?n.item===n.value:!!n.itemValueField&&(n.item&&n.value&&n.item[n.itemValueField]===n.value[n.itemValueField])},n.onChange=function(){if(!n.isDisabled){var e,a=n.value;if(n.value=n.item,b&&d){e=b;for(var t=0;t<d.length;t++)e=e[d[t]];e=n.item}else e=b[o.value],b[o.value]=n.item;var s=!0;s=r?a!==n.item:n.itemValueField?!(a||!n.item[n.itemValueField])||a[n.itemValueField]!==n.item[n.itemValueField]:!(a||!n.item)||JSON.stringify(a)===JSON.stringify(n.item),s&&i(function(){x(n.value),n.change({maValue:n.item,maOldValue:a})})}},n.onFocus=function(){n.isDisabled||(n.isFocused=!0)},n.onBlur=function(){n.isDisabled||(n.isFocused=!1,x(n.value))},n.onKeypress=function(i){i.keyCode===e.keyCode.space&&(i.preventDefault(),n.isDisabled||n.isChecked()||n.onChange())},n.$watch("isDisabled",function(e,i){e!==i&&(e&&(n.isFocused=!1),v())}),n.$watch("modifier",function(e,i){e!==i&&f(i)});for(var p=0;p<u.length;p++)if("IsNotEmpty"===u[p].name){c=!0;break}!c&&m&&u.unshift(t.isNotEmpty()),c&&(m=!0),n.instance&&(n.instance.isInitialized=!0,n.instance.isValid=function(){return n.isValid},n.instance.validate=function(){x(n.value)}),i(function(){n.id&&l.removeAttr("id"),f()}),v()}}}])}();
...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","MaHelper",function(e,t,i){return{restrict:"E",scope:{id:"@",items:"=",value:"=",isLoading:"=",change:"&",blur:"&",focus:"&",init:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"=",ajax:"=",canReset:"=",placeholder:"@",textPlaceholder:"@",isMultiple:"=",storeItemValueOnly:"="},replace:!0,template:function(e,t){var l=!i.isNullOrWhiteSpace(t.ajax),a="true"===t.isMultiple,n="                    <div class=\"ma-select-box\"                        ng-class=\"{                            'ma-select-box-can-add-item': canAddItem,                            'ma-select-box-is-text-focused': isTextFocused,                            'ma-select-box-is-disabled': isDisabled,                            'ma-select-box-is-invalid': !isValid,                            'ma-select-box-is-touched': isTouched,                            'ma-select-box-mode-add': isAddMode,                            'ma-select-box-mode-select': !isAddMode,                            'ma-select-box-can-reset': canReset,                            'ma-select-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                            'ma-select-box-is-loading': isLoading,                            'ma-select-box-has-value': hasValue()                        }\">                        <div class=\"ma-select-box-spinner\" ng-if=\"isLoading && !isDisabled\">                            <div class=\"pace\">                                <div class=\"pace-activity\"></div>                            </div>                        </div>";return n+=l?'<input class="ma-select-box-input" ma-select2="options"'+(a?" multiple":"")+'                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-change="onChange()"                        ng-model="selectedItem"/>':'                        <select ma-select2="options"'+(a?" multiple":"")+'                            ng-show="!isAddMode"                            ng-disabled="isDisabled"                            ng-model="selectedItem"                            ng-change="onChange()"                            placeholder="{{placeholder}}">                            <option></option>                            <option ng-repeat="item in _items | maSelectBoxOrderBy:orderBy" value="{{getOptionValue(item)}}">                                {{formatItem(item)}}                            </option>                        </select>',n+='                    <input class="ma-select-box-text" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'text\')"                        placeholder="{{textPlaceholder}}"/>                    <ma-button class="ma-button-switch"                        ng-show="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                    <ma-button class="ma-button-reset"                        ng-show="canReset" size="xs" modifier="simple"                        right-icon="times-circle"                        click="onReset()"                        ng-focus="onFocus(\'reset\')"                        is-disabled="!isResetEnabled()">                    </ma-button>                </div>'},controller:["$scope",function(e){e.getItemValue=function(t){if(i.isNullOrWhiteSpace(t)||!e.itemValueField)return null;if(e.storeItemValueOnly)return(angular.isObject(t)?t[e.itemValueField]:t).toString();for(var l=e.itemValueField.split("."),a=t[l[0]],n=1;n<l.length;n++)a=a[l[n]];return i.isNullOrUndefined(a)?null:a.toString()},e.formatItem=function(t){return e.itemTemplate?e.itemTemplate(t):t?e.itemTextField?t[e.itemTextField]:t.toString():""},e.options={},e.runInitSelection=!0,e.ajax&&(e.options.ajax=e.ajax,e.options.minimumInputLength=3,e.options.escapeMarkup=function(e){return e},e.options.initSelection=function(t,i){if(e.runInitSelection&&e.getItemValue(e.value)){var l=angular.copy(e.value);l.text=e.formatItem(l),l.id=e.getItemValue(l),e.previousSelectedItem=l,i(l)}else i();e.runInitSelection=!1},e.isMultiple&&(e.options.formatSelection=function(t){return e.formatItem(t)}))}],link:function(l,a){var n,s,o,u,c,d,r=angular.element(a[0].querySelector(".ma-select-box-text")),m=null,f=!0,p=!1,g=!1,v=l.showAddItemTooltip!==!1,h=l.validators?angular.copy(l.validators):[],x=l.itemTextField||l.itemValueField;l._items=angular.isArray(l.items)?angular.copy(l.items):[],l.previousSelectedItem=l.previousSelectedItem||null,l.isAddMode=!1,l.isTextFocused=!1,l.isValid=!0,l.isTouched=!1,l.hasAjax=angular.isObject(l.ajax);var I={name:"IsNotEmpty",validate:function(e){return l.isMultiple&&angular.isArray(e)?e.length>0:!i.isNullOrWhiteSpace(e)&&!!(l.hasAjax||l.isAddMode||V(e))}},b=function(){for(var e=null,t=0;t<h.length;t++)if("IsNotEmpty"===h[t].name){e=t,h[t]=I;break}null===e&&l.isRequired?h.unshift(I):null===e||l.isRequired||h.splice(e,1)},V=function(e){if(!angular.isArray(l._items))return!1;for(var t=null!==l.getItemValue(e),i=0;i<l._items.length;i++)if(t){if(l.getItemValue(l._items[i])===l.getItemValue(e))return!0}else if(l._items[i]===e)return!0;return!1},A=function(e){if(i.isNullOrWhiteSpace(e))return null;if(!x)return e;if(angular.isArray(l._items))for(var t=0;t<l._items.length;t++)if(l.getItemValue(l._items[t])===e.toString())return l._items[t];return null},M=function(e){if(!x)return e;if(e){var t={};return t[l.itemTextField]=e,t}return null},S=function(e){if(l.isMultiple){var t,a=[];if(l.hasAjax){if(e&&e.length)for(t=0;t<e.length;t++)a.push(e[t]);a=JSON.stringify(a)}else if(e&&e.length)for(t=0;t<e.length;t++)a.push(l.getItemValue(e[t]));l.selectedItem=a,T(e)}else l.canAddItem&&e&&(l.isAddMode=!V(e)),T(e),l.isAddMode?(e?l.itemTextField&&e[l.itemTextField]?l.text=e[l.itemTextField].toString():l.text=e:l.text=null,m=e,l.toggleMode("add")):(i.isNullOrWhiteSpace(e)?l.selectedItem=null:l.hasAjax||(null!==l.getItemValue(e)?l.selectedItem=l.getItemValue(e):"string"==typeof e&&(l.selectedItem=e)),l.previousSelectedItem=e,l.toggleMode("select"))},y=function(e,i){var o=angular.element(e.relatedTarget);l.isTextFocused=!1,"text"===i?(p=!1,l.$apply(function(){l.isTouched=!0;var e;if(l.itemTextField){if(l.value&&l.value[l.itemTextField]===l.text)return;e=M(l.text)}else{if(l.value===l.text)return;e=l.text}T(e),l.isValid&&(d=l.value||null,l.value=e,m=l.value,l.isValid&&t(function(){l.change({maValue:l.value,maOldValue:d})}))})):"select"===i&&l.$apply(function(){l.isTouched=!0}),f=!p&&o[0]!==n[0]&&o[0]!==s[0]&&o[0]!==r[0]&&o[0]!==u.search[0],l.isMultiple?g&&(f=!1):p||o[0]!==u.focusser[0]||(f=!1),f&&(a.removeClass("ma-select-box-is-select-focused"),l.blur({maValue:l.storeItemValueOnly?A(l.value):l.value})),p=!1},T=function(e){if(l.isValid=!0,h&&h.length)for(var t=0;t<h.length;t++)if(!h[t].validate(e)){l.isValid=!1;break}},F=function(){l.isAddMode?(r.focus(),l.isTextFocused=!0):o.select2("focus")};l.hasValue=function(){return l.isMultiple?!i.isNullOrUndefined(l.value)&&l.value.length:l.isAddMode?!i.isNullOrWhiteSpace(l.text):!i.isNullOrUndefined(l.value)&&!l.isLoading},l.isResetEnabled=function(){return!l.isDisabled&&l.hasValue()},l.reset=function(){d=l.value,l.value=l.isMultiple?[]:null},l.onReset=function(){l.isTouched=!0,l.reset(),F(),t(function(){l.change({maValue:l.value,maOldValue:d})})},l.onFocus=function(e){"text"===e&&(l.isTextFocused=!0),"reset"===e&&a.removeClass("ma-select-box-is-select-focused"),f&&l.focus({maValue:l.storeItemValueOnly?A(l.value):l.value}),f=!1},r.focusout(function(e){y(e,"text")}),l.getAddItemTooltip=function(){return v?l.isAddMode?"Back to the list":l.addItemTooltip?l.addItemTooltip:"Add new item":""},l.getOptionValue=function(e){return l.itemValueField?l.getItemValue(e):e},l.toggleMode=function(e){if(l.canAddItem&&!(l.isAddMode&&"add"===e||!l.isAddMode&&"select"===e)){var i=!1;d=l.value||null,"select"===e?(l.isAddMode=!1,i=!0):"add"===e?(l.isAddMode=!0,i=!0):l.isAddMode=!l.isAddMode,l.isAddMode?(o&&o.select2("close"),l.previousSelectedItem=A(l.selectedItem),l.value=m,l.value&&(l.text="string"==typeof l.value?l.value:l.value[l.itemTextField])):(m=M(l.text),l.value=l.previousSelectedItem),i||t(function(){l.change({maValue:l.value,maOldValue:d}),F()})}},l.onChange=function(){var e;if(l.isMultiple){var a=l.selectedItem,n=[];if(l.hasAjax){if(n=u.data(),angular.equals(n,l.value))return;d=l.value}else{d=l.value;for(var s=0;s<a.length;s++)e=A(a[s]),e&&n.push(e)}l.isTouched=!0,l.value=n,t(function(){l.change({maValue:n,maOldValue:d})}),u.dropdown.mouseleave()}else{if(e=i.isJson(l.selectedItem)?JSON.parse(l.selectedItem):l.selectedItem,"number"==typeof e&&(e=l.selectedItem),l.hasAjax){if(e===l.previousSelectedItem)return;if(!angular.isObject(e))return}if(!l.hasAjax&&l.itemValueField&&!i.isNullOrWhiteSpace(e))for(var o=0;o<l._items.length;o++)if(l.getItemValue(l._items[o])===e.toString()){e=l._items[o];break}if(!e&&!l.value)return;if(l.itemValueField){var c=l.getItemValue(l.value);if(c&&c===l.getItemValue(e))return}else if(e===l.value)return;d=l.value,l.storeItemValueOnly?(l.value=l.getItemValue(e),l.previousSelectedItem=l.value,d=A(d)):(l.value=e,l.previousSelectedItem=e),t(function(){l.change({maValue:e,maOldValue:d})})}};var O=function(){l.hasAjax&&u&&(u.opts.placeholder=l.value?"":l.placeholder,l.runInitSelection=!0,u.initSelection())};l.$watch("items",function(e,i){angular.equals(e,i)||(l._items.splice(0,l._items.length),Array.prototype.push.apply(l._items,e),S(l.value),t(function(){var e,t;if(angular.isObject(l.value))if(l.isMultiple&&angular.isArray(l.value)){for(var i=[],a=0;a<l.value.length;a++)e=l.getItemValue(l.value[a]),t=angular.copy(A(e)||l.value[a]),t.text=l.formatItem(t),t.id=e,t&&i.push(t);u.data(i)}else e=l.getItemValue(l.value),t=angular.copy(A(e)||l.value),t.text=l.formatItem(t),t.id=e,u.data(t);else l.value?u.val(l.value):u.data(null)}))},!0),l.$watch("value",function(e,t){e!==t&&(O(),S(e))}),l.$watch("text",function(e,t){e!==t&&(l.isTouched=!0,T(e))}),l.$watch("isRequired",function(e,t){e!==t&&(b(),T(l.isAddMode?l.text:l.value))}),l.instance&&(l.instance.isInitialized=!0,l.instance.switchToSelectMode=function(){l.isAddMode&&l.toggleMode("select")},l.instance.switchToAddMode=function(){l.isAddMode||l.toggleMode("add")},l.instance.isValid=function(){return l.isValid},l.instance.validate=function(){l.isTouched=!0,T(l.isAddMode?l.text:l.value)},l.instance.clear=function(){l.reset(),t(function(){l.isTouched=!1})}),b(),t(function(){if(l.hasAjax){var t=angular.element(a[0].querySelector(l.isMultiple?".select2-search-field":".select2-search"));t.append('<div class="pace"><div class="pace-activity"></div></div>'),l.isMultiple||t.append('<i class="ma-select-box-input-search-icon fa fa-search"></i>')}S(l.value),o=angular.element(a[0].querySelector(".select2-container")),u=o.data().select2,c=$('label[for="'+l.id+'"]'),n=angular.element(a[0].querySelector(".ma-button-switch")),s=angular.element(a[0].querySelector(".ma-button-reset")),O(),c.length>0&&$(e).on("click",'label[for="'+l.id+'"]',function(){F()}),l.isMultiple?(u.search.on("focus",function(){a.addClass("ma-select-box-is-select-focused"),l.onFocus()}),u.search.on("focusout",function(e){y(e,"select")}),u.selection.on("mouseenter",function(){g=!0}),u.selection.on("mouseleave",function(){g=!1}),u.dropdown.on("mouseenter",function(){g=!0}),u.dropdown.on("mouseleave",function(){g=!1}),u.dropdown.on("click",function(){u.search.focus()})):(u.focusser.on("focus",function(){l.onFocus("select")}),u.focusser.on("focusout",function(e){y(e,"select")})),u.dropdown.on("focus",".select2-input",function(){p=!0,l.onFocus()}),u.dropdown.on("focusout",".select2-input",function(e){y(e,"select")}),n.focusout(function(e){y(e)}),s.focusout(function(e){y(e)}),u.dropdown.on("mouseenter",".select2-result",function(){p=!0}),u.dropdown.on("mouseleave",".select2-result",function(){p=!1}),$(e).on("mouseenter",".select2-drop-mask",function(){l.isMultiple||(p=!0)}),l.init({maInstance:l.instance})})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maSideMenu",["$sce",function(e){return{restrict:"E",scope:{items:"=",select:"&"},replace:!0,template:function(){var e='            <div class="ma-side-menu">                <div class="ma-side-menu-item" ng-repeat="item in items" ng-hide="item.isHidden" ng-class="{                        \'ma-side-menu-item-is-selected\': isItemSelected(item),                        \'ma-side-menu-item-is-disabled\': item.isDisabled                    }"                    ng-click="onSelect(item)">                    <i ng-if="item.icon" class="fa fa-{{item.icon}}"></i>                    <div class="ma-side-menu-text" ng-bind-html="getItemText(item)"></div>                    <div class="ma-side-menu-new" ng-if="item.new">{{item.new}}</div>                </div>            </div>';return e},link:function(i,t,n){i.isItemSelected=function(e){return e.selector?e.selector():e.isSelected},i.onSelect=function(e){e.isDisabled||(e.selector||(angular.forEach(i.items,function(e){e.isSelected=!1}),e.isSelected=!0),i.select({item:e}))},i.getItemText=function(i){return e.trustAsHtml(i.text)}}}}])}();
