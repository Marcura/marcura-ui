...
!function(){angular.module("marcuraUI.components").filter("maSelectBoxOrderBy",["orderByFilter",function(e){return function(t,i){return i?e(t,i):t}}]).directive("maSelectBox",["$document","$timeout","maHelper","maValidators",function(e,t,i,o){return{restrict:"E",scope:{id:"@",items:"=",selectedItem:"=",isLoading:"=",change:"&",blur:"&",focus:"&",itemTemplate:"=",itemTextField:"@",itemValueField:"@",isDisabled:"=",isRequired:"=",validators:"=",isSearchable:"=",canAddItem:"=",addItemTooltip:"@",showAddItemTooltip:"=",instance:"=",orderBy:"="},replace:!0,template:function(){var e='                <div class="ma-select-box"                    ng-class="{                        \'ma-select-box-can-add-item\': canAddItem,                        \'ma-select-box-is-input-focused\': isInputFocused,                        \'ma-select-box-is-disabled\': isDisabled,                        \'ma-select-box-is-invalid\': !isValid,                        \'ma-select-box-is-touched\': isTouched,                        \'ma-select-box-mode-add\': isAddMode,                        \'ma-select-box-mode-select\': !isAddMode                    }">                    <div class="ma-select-box-spinner" ng-if="isLoading && !isDisabled">                        <div class="pace">                            <div class="pace-activity"></div>                        </div>                    </div>                    <select ui-select2="options"                        ng-show="!isAddMode"                        ng-disabled="isDisabled"                        ng-model="value"                        ng-change="onChange()">                        <option ng-repeat="item in items | maSelectBoxOrderBy:orderBy" value="{{getItemValue(item)}}">                            {{formatItem(item)}}                        </option>                    </select>                    <input class="ma-select-box-input" type="text" ng-show="isAddMode"                        ng-model="text"                        ng-disabled="isDisabled"                        ng-focus="onFocus(\'input\')"/>                    <ma-button ng-if="canAddItem" size="xs" modifier="simple"                        tooltip="{{getAddItemTooltip()}}"                        right-icon="{{isAddMode ? \'bars\' : \'plus\'}}"                        click="toggleMode()"                        ng-focus="onFocus()"                        is-disabled="isDisabled">                    </ma-button>                </div>';return e},controller:["$scope",function(e){e.options={},e.isSearchable||(e.options.minimumResultsForSearch=-1)}],link:function(n,d){var l,s,c,u,a=angular.element(d[0].querySelector(".ma-select-box-input")),r=null,m=null,f=!0,g=!1,p=n.showAddItemTooltip!==!1,I=n.validators?angular.copy(n.validators):[],F=n.isRequired,x=!1;n.isAddMode=!1,n.formatItem=n.itemTemplate||function(e){return e?n.itemTextField?e[n.itemTextField]:e.toString():""},n.isInputFocused=!1,n.isValid=!0,n.isTouched=!1;var h=function(e){if(!angular.isArray(n.items))return!1;for(var t=n.itemValueField&&e[n.itemValueField],i=0;i<n.items.length;i++)if(t){if(n.items[i][n.itemValueField]===e[n.itemValueField])return!0}else if(n.items[i]===e)return!0;return!1},v=function(e){if(!e)return null;if(!n.itemTextField)return e;if(angular.isArray(n.items))for(var t=0;t<n.items.length;t++)if(n.items[t][n.itemValueField].toString()===e.toString())return n.items[t];return null},b=function(e){if(!n.itemTextField)return e;if(e){var t={};return t[n.itemTextField]=e,t}return null},A=function(e){e&&(n.isAddMode=!h(e)),M(e),n.isAddMode?(e?n.itemTextField&&e[n.itemTextField]?n.text=e[n.itemTextField].toString():n.text=e:n.text=null,m=e,n.toggleMode("add")):(e?n.itemValueField&&e[n.itemValueField]?n.value=e[n.itemValueField].toString():"string"==typeof e&&(n.value=e):n.value=null,r=e,n.toggleMode("select"))},T=function(e,i){var o=angular.element(e.relatedTarget),d=angular.element(c.dropdown[0].querySelector(".select2-input"));n.isInputFocused=!1,"input"===i?n.$apply(function(){if(n.isTouched=!0,n.itemTextField){if(n.selectedItem&&n.selectedItem[n.itemTextField]===n.text)return;n.selectedItem=b(n.text)}else{if(n.selectedItem===n.text)return;n.selectedItem=n.text}m=n.selectedItem,n.isValid&&t(function(){n.change({item:n.selectedItem})})}):"select"===i&&n.$apply(function(){n.isTouched=!0}),g||o[0]===l[0]||o[0]===a[0]||o[0]===c.focusser[0]||o[0]===d[0]||(n.blur({item:n.selectedItem}),f=!0),g=!1},M=function(e){if(n.isValid=!0,I&&I.length)for(var t=0;t<I.length;t++)if(!I[t].method(e)){n.isValid=!1;break}};n.onFocus=function(e){"input"===e&&(n.isInputFocused=!0),f&&n.focus({item:n.selectedItem}),f=!1},a.focusout(function(e){T(e,"input")}),n.getAddItemTooltip=function(){return p?n.isAddMode?"Back to the list":n.addItemTooltip?n.addItemTooltip:"Add new item":""},n.getItemValue=function(e){return n.itemValueField?e[n.itemValueField].toString():e},n.toggleMode=function(e){if(!(n.isAddMode&&"add"===e||!n.isAddMode&&"select"===e)){var i=!1;"select"===e?(n.isAddMode=!1,i=!0):"add"===e?(n.isAddMode=!0,i=!0):n.isAddMode=!n.isAddMode,n.isAddMode?(s&&s.select2("close"),r=v(n.value),n.selectedItem=m,n.selectedItem&&(n.text="string"==typeof n.selectedItem?n.selectedItem:n.selectedItem[n.itemTextField])):(m=b(n.text),n.selectedItem=r),i||t(function(){n.change({item:n.selectedItem}),n.isAddMode?(a.focus(),n.isInputFocused=!0):s.select2("focus")})}},n.onChange=function(){var e=i.isJson(n.value)?JSON.parse(n.value):n.value;if(n.itemValueField&&e)for(var o=0;o<n.items.length;o++)if(n.items[o][n.itemValueField].toString()===e.toString()){e=n.items[o];break}if(e||n.selectedItem){if(n.itemValueField){if(n.selectedItem&&n.selectedItem[n.itemValueField]&&n.selectedItem[n.itemValueField].toString()===e[n.itemValueField].toString())return}else if(e===n.selectedItem)return;n.selectedItem=e,r=e,t(function(){n.change({item:e})})}},n.$watch("selectedItem",function(e,t){e!==t&&A(e)}),n.$watch("text",function(e,t){e!==t&&(n.isTouched=!0,M(e))}),n.instance&&(n.instance.switchToSelectMode=function(){n.isAddMode&&n.toggleMode("select")},n.instance.switchToAddMode=function(){n.isAddMode||n.toggleMode("add")},n.instance.isValid=function(){return n.isValid});for(var V=0;V<I.length;V++)if("IsNotEmpty"===I[V].name){x=!0;break}!x&&F&&I.unshift(o.isNotEmpty()),x&&(F=!0),t(function(){A(n.selectedItem),s=angular.element(d[0].querySelector(".select2-container")),c=s.data().select2,u=$('label[for="'+n.id+'"]'),l=angular.element(d[0].querySelector(".ma-button")),u.length>0&&$(e).on("click",'label[for="'+n.id+'"]',function(){n.isAddMode?a.focus():s.select2("focus")}),c.focusser.on("focus",function(){n.onFocus("select")}),c.focusser.on("focusout",function(e){T(e,"select")}),c.dropdown.on("focus",".select2-input",function(){g=!0,n.onFocus()}),c.dropdown.on("focusout",".select2-input",function(e){T(e,"select")}),l.focusout(function(e){T(e)}),c.dropdown.on("mouseenter",".select2-result",function(){g=!0}),$(e).on("mouseenter",".select2-drop-mask",function(){g=!0})})}}}])}();
