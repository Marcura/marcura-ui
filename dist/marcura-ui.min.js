...
!function(){angular.module("marcuraUI.components").directive("maMessage",[function(){return{restrict:"E",scope:{text:"@",type:"@",state:"@"},replace:!0,template:function(){var e="                <div class=\"ma-message{{cssClass}}\">                    <div class=\"ma-message-icon\">                        <i class=\"fa\" ng-class=\"{                            'fa-info-circle': _state === 'info',                            'fa-check-circle': _state === 'success',                            'fa-exclamation-triangle': _state === 'danger' || _state === 'warning'                        }\"></i>                    </div>                    <div class=\"ma-message-text\">{{text}}</div>                </div>";return e},link:function(e){e._type=e.type||"message",e._state=e.state||"info",e.cssClass=" ma-message-"+e._type+" ma-message-"+e._state}}}])}();
