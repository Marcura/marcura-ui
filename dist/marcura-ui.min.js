...
!function(){angular.module("marcuraUI.components").provider("maTextBoxConfiguration",function(){this.$get=function(){return this}}).directive("maTextBox",["$timeout","MaHelper","MaValidators",function(e,a,i){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",changeWhenIsInvalid:"=",blur:"&",focus:"&",validate:"&",changeTimeout:"=",canReset:"=",placeholder:"@",hasShowPasswordButton:"=",trim:"=",max:"=",min:"=",decimals:"=",useFormat:"=",reset:"&",defaultValue:"="},replace:!0,template:function(e,a){var i="password"===a.type?"password":"text";"number"!==i&&"email"!==i||(i="text");var n="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isValueFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled(),                    'ma-text-box-can-toggle-password': canTogglePassword,                    'ma-text-box-is-toggle-password-disabled': canTogglePassword && !isDisabled && !isTogglePasswordEnabled(),                    'ma-text-box-has-value': hasValue()                }\">                <input class=\"ma-text-box-value\" type=\""+i+'" id="{{id}}"                    autocomplete="off"                    placeholder="{{placeholder}}"                    ng-focus="onFocus(\'value\')"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-toggle-password"                    ng-show="canTogglePassword" size="xs" modifier="simple"                    right-icon="{{isPasswordVisible ? \'eye-slash\' : \'eye\'}}"                    click="togglePassword()"                    ng-focus="onFocus()"                    is-disabled="!isTogglePasswordEnabled()">                </ma-button>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    ng-focus="onFocus()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return n},controller:["$scope","maTextBoxConfiguration",function(e,a){e.configuration={},e.decimals>=0?e.configuration.decimals=e.decimals:a.decimals>=0?e.configuration.decimals=a.decimals:e.configuration.decimals=2}],link:function(n,t,s){var o,l,u,r,d,c=angular.element(t[0].querySelector(".ma-text-box-value")),f=angular.element(t[0].querySelector(".ma-button-reset")),m=angular.element(t[0].querySelector(".ma-button-toggle-password")),v=[],p=Number(n.changeTimeout),b=!0,g=n.trim!==!1,h=!1,y=null,x=n.configuration.decimals,V=void 0!==s.defaultValue,w=a.isNullOrUndefined(n.defaultValue)?"":n.defaultValue,k="number"==typeof n.min,C="number"==typeof n.max,O=void 0===n.useFormat||n.useFormat;"number"===n.type&&(w="number"==typeof n.defaultValue?n.defaultValue:null);var T=function(e){e=a.isNullOrUndefined(e)?"":e,"number"!==n.type&&g&&(e=e.trim()),u=e},N=function(){var e=c.val();return"number"===n.type?I(e):e},E=function(e){n.isValid=!0,y=null,e=void 0===e||e;var a=c.val();if("number"===n.type&&(a=D(a)),v&&v.length)for(var i=0;i<v.length;i++)if(!v[i].validate(a)){n.isValid=!1,y=v[i];break}e!==!1&&P(a)},F=function(i){if(R(i)){h=!0;var t=u;"number"!==n.type&&g&&(t=t.trim(),i=i.trim()),V&&(a.isNullOrUndefined(i)&&(i=w),a.isNullOrUndefined(t)&&(t=w)),n.value=i,T(i),e(function(){n.change({maValue:i,maOldValue:t})})}},P=function(a){e(function(){n.validate({maValue:a})})},R=function(e){e=a.isNullOrUndefined(e)?"":e;var i=a.isNullOrUndefined(u)?"":u,t=!1;return t="number"!==n.type&&g?i.trim()!==e.trim():i!==e},q=function(){return n.isTouched=!0,R(N())?(E(),void((n.isValid||n.changeWhenIsInvalid)&&F(N()))):void E()},I=function(e,i){return a.isNullOrWhiteSpace(e)?null:(e=parseFloat(D(e)),i||(e=parseFloat(e.toFixed(x))),isNaN(e)?null:e)},S=function(e){if(a.isNullOrWhiteSpace(e))return"";var i=e.indexOf(".")==-1?"":e.replace(/^-?\d+(?=\.)/,""),n=e.replace(/(\.\d+)$/,""),t=n.replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");return""+t+i},D=function(e){return a.isNullOrWhiteSpace(e)?"":e.trim().replace(/,/g,"")},U=function(e){if(a.isNullOrWhiteSpace(e))return e;var i=e;return"number"===n.type&&(e="number"==typeof e?e:Number(e),i=O?S(e.toFixed(x)):e.toFixed(0)),i},L=function(){var e=!1;v=n.validators?angular.copy(n.validators):[];for(var a=0;a<v.length;a++)if("IsNotEmpty"===v[a].name){e=!0;break}!e&&n.isRequired&&v.unshift(i.isNotEmpty()),"number"===n.type&&v.push(i.isNumber(!0)),k&&("number"===n.type?v.push(i.isGreaterOrEqual(n.min,!0)):v.push(i.isLengthGreaterOrEqual(n.min,!0))),C&&("number"===n.type?v.push(i.isLessOrEqual(n.max,!0)):v.push(i.isLengthLessOrEqual(n.max,!0))),"email"===n.type&&v.push(i.isEmail(!0))};L(),n.isValueFocused=!1,n.isTouched=!1,n.canTogglePassword=!1,n.isPasswordVisible=!1,"password"===n.type&&(n.canTogglePassword=n.hasShowPasswordButton!==!1),n.hasValue=function(){if("number"===n.type){var e=c.val();return""!==e&&!a.isNumber(e)||I(e,!0)!==w&&""!==e}return c.val()!==w},n.isResetEnabled=function(){if(n.isDisabled)return!1;if("number"===n.type){var e=c.val();return""!==e&&!a.isNumber(e)||I(e,!0)!==w&&""!==e}return c.val()!==w},n.doReset=function(){T(N()),c.val(w)},n.onReset=function(){n.isDisabled||(n.doReset(),n.isTouched=!0,F(w),E(),c.focus(),e(function(){n.reset()}))},n.onFocus=function(e){if("value"===e&&(n.isValueFocused=!0,"number"===n.type&&!a.isNullOrUndefined(n.value)&&n.isValid)){var i=n.value.toFixed(O?x:0);c.val(i)}b&&(d=n.value,n.focus({maValue:n.value})),b=!1},c.focusout(function(e){W(e,"value")}),f.focusout(function(e){W(e)}),m.focusout(function(e){W(e)}),n.togglePassword=function(){n.isPasswordVisible=!n.isPasswordVisible,c[0].type=n.isPasswordVisible?"text":"password"},n.isTogglePasswordEnabled=function(){return!n.isDisabled&&""!==c.val()};var W=function(i,t){var s=angular.element(i.relatedTarget),o=c.val();b=n.canTogglePassword?s[0]!==c[0]&&s[0]!==m[0]&&s[0]!==f[0]:s[0]!==c[0]&&s[0]!==f[0],r&&e.cancel(r),"value"===t&&(V&&""===o.trim()&&(h=!0,o=w,n.value=o,c.val(U(o))),n.isResetEnabled()||s[0]!==f[0]||(b=!0),E(),n.isValid&&c.val(U(o))),a.safeApply(function(){n.isValueFocused=!1}),b&&(q(),a.safeApply(function(){n.blur({maValue:n.value,maOldValue:d,maHasValueChanged:d!==n.value})}))};n.onKeydown=function(e){if(e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(o=angular.element(e.target).val(),"number"===n.type)){if($.inArray(e.keyCode,[a.keyCode.backspace,a.keyCode["delete"],a.keyCode.home,a.keyCode.end,a.keyCode.period,a.keyCode.numLock.period,a.keyCode.dash,a.keyCode.dash2])!==-1||37===e.keyCode||39===e.keyCode)return;(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()}},c.on("input",function(i){if(i.keyCode!==a.keyCode.tab&&i.keyCode!==a.keyCode.shift){var n=!1;l=angular.element(i.target).val(),o!==l&&(n=!0),n&&(r&&e.cancel(r),r=e(function(){q()},p))}}),e(function(){t.removeAttr("id"),n.id?c.attr("id",n.id):c.removeAttr("id")}),n.$watch("value",function(e,a){if(h)return void(h=!1);if(e!==a){R(e)&&(n.isTouched=!0);var i=c.prop("selectionStart");T(e),c.val(U(e)),E(!1),n.isValueFocused&&c.prop({selectionStart:i,selectionEnd:i})}}),n.$watch("isRequired",function(e,a){e!==a&&(L(),E())});var A=function(e,a){if(e!==a){var i=N();L();for(var t=[],s=0;s<v.length;s++)"IsGreaterOrEqual"!==v[s].name&&"IsLessOrEqual"!==v[s].name||t.push(v[s]);if(t.length){for(!y||"IsGreaterOrEqual"!==y.name&&"IsLessOrEqual"!==y.name||(y=null,n.isValid=!0),s=0;s<t.length;s++)if(!t[s].validate(i)){n.isValid=!1,y=t[s];break}n.isValid||(n.isTouched=!0)}(n.isValid||n.changeWhenIsInvalid)&&F(i)}};n.$watch("max",function(e,a){A(e,a)}),n.$watch("min",function(e,a){A(e,a)}),V&&a.isNullOrUndefined(n.value)&&(n.value=w),c.val(U(n.value)),E(),T(n.value),n.instance&&(n.instance.isInitialized=!0,n.instance.validate=function(){n.isTouched=!0,E(!1)},n.instance.isValid=function(){return n.isValid},n.instance.focus=function(){n.isValueFocused||c.focus()},n.instance.failedValidator=function(){return y},n.instance.clear=function(){n.doReset(),e(function(){n.isTouched=!1})})}}}])}();
