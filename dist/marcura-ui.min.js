...
!function(){angular.module("marcuraUI.services").factory("MaDate",[function(){function e(t,r){if(this.date=t||null,this._offset=r||0,t instanceof e&&(this.date=t.date,this._offset=t.offset()),angular.isString(t)){var n=s(t);this.date=n.date,this._offset=n.offset()}}var t=[{language:"en",items:["January","February","March","April","May","June","July","August","September","October","November","December"]}],r=[31,28,31,30,31,30,31,31,30,31,30,31],n=function(e){return!!e&&("[object Date]"===Object.prototype.toString.call(e)&&e.getTime&&!isNaN(e.getTime()))},a=function(e,t){return e.match(new RegExp(t,"i"))},u=function(n,u,i,s,f,c,o){var l,d=new e;i=i.toString(),u=u.toString(),s=s||0,f=f||0,c=c||0,o=o||0,n<=99&&(n=n>=0&&n<30?"20"+n:"19"+n);var m=1===new Date(n,1,29).getMonth();if(m?r[1]=29:r[1]=28,null!==u.match(/([^\u0000-\u0080]|[a-zA-Z])$/)){for(var h=0;h<t.length;h++)for(var y=0;y<t[h].items.length;y++)if(a(u,t[h].items[y].slice(0,3))){l=y+1;break}if(!l)return d;u=l}return u>12?d:i>r[u-1]?d:(d.date=new Date(n,u-1,i,s,f,c),d.offset(o),d)},i=function(e,t,r){var n={day:e,month:t,isValid:!0};return"en-GB"===r&&t>12&&(n.isValid=!1),"en-US"===r&&(n.day=t,n.month=e,e>12&&(n.isValid=!1)),!r&&t>12&&(n.day=t,n.month=e),n},s=function(t,r){var n,a,s,f=new e;if(t instanceof Date||t instanceof e)return t;if(!angular.isString(t))return f;if(n=/^\d{1,2}$/,null!==t.match(n)){var c=new Date;return u(c.getFullYear(),c.getMonth()+1,t)}if(n=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),s=i(a[1],a[3],r),s.isValid?u((new Date).getFullYear(),s.month,s.day):f;if(n=/^(\d{1,2})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(n))return a=n.exec(t),u(a[5],a[3],a[1]);if(n=/([^\u0000-\u0080]|[a-zA-Z]{3})(\s|)(\d{1,2})(,)(\s|)(\d{2,4})$/,null!==t.match(n))return a=n.exec(t),u(a[6],a[1],a[3]);if(n=/^([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4}\b)/,null!==t.match(n))return a=n.exec(t),u(a[5],a[1],a[3]);if(n=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),u(a[1],a[3],a[5]);if(n=/^(\d{1,2})(\/|-|\.|\s|)(\d{1,2})(\/|-|\.|\s|)(\d{2,4})$/,null!==t.match(n))return a=n.exec(t),s=i(a[1],a[3],r),s.isValid?u(a[5],s.month,s.day):f;if(n=/^(\d{4})(\/|-|\.|\s|)([^\u0000-\u0080]|[a-zA-Z]{1,12})(\/|-|\.|\s|)(\d{1,2})$/,null!==t.match(n))return a=n.exec(t),u(a[1],a[3],a[5]);if(n=/^(\d{4})(\/|-|\.|\s)(\d{1,2})(\/|-|\.|\s)(\d{1,2})T(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)(?:Z|([+-])(2[0-3]|[01][0-9]):([0-5][0-9]))$/,null!==t.match(n)){a=n.exec(t);var o=0;return 12===a.length&&(o=60*(Number(a[10])||0)+(Number(a[11])||0),"-"===a[9]&&0!==o&&(o=-o)),u(a[1],a[3],a[5],a[6],a[7],a[8],o)}return f},f=function(e,r,a){var u=0,i=e&&e.isValid&&e.isValid();if(a=a||"",!n(e)&&!i)return null;if(!angular.isString(r))return null;var s={s:["ss"],m:["mm"],H:["HH"],d:["d","dd"],M:["M","MM","MMM","MMMM"],y:["yy","yyyy"],Z:["Z"]},f=function(e){var t="";try{t=r.match(new RegExp(e+"+",""))[0]}catch(n){}return s[e].indexOf(t)},c=function(e,t){for(var r="",n=0;n<t;n++)r+="0";return(r+e).slice(-t)},o=i?e.date():e.getDate(),l=i?e.month():e.getMonth(),d=i?e.year():e.getFullYear(),m=i?e.hours():e.getHours(),h=i?e.minutes():e.getMinutes(),y=i?e.seconds():e.getSeconds(),g=function(e){var r="";switch(e){case s.d[0]:r=o;break;case s.d[1]:r=c(o,2);break;case s.M[0]:r=l+1;break;case s.M[1]:r=c(l+1,2);break;case s.M[2]:r=t[u].items[l].substr(0,3);break;case s.M[3]:r=t[u].items[l];break;case s.y[0]:r=c(d,2);break;case s.y[1]:r=d;break;case s.H[0]:r=c(m,2);break;case s.m[0]:r=c(h,2);break;case s.s[0]:r=c(y,2);break;case s.Z[0]:r=a||"Z";break;default:return""}return r},b={days:g(s.d[f("d")]),months:g(s.M[f("M")]),years:g(s.y[f("y")]),hours:g(s.H[f("H")]),minutes:g(s.m[f("m")]),seconds:g(s.s[f("s")]),timeZone:g(s.Z[0]),separator:/^\w+([^\w])/.exec(r)};return r.replace(/d+/,b.days).replace(/y+/,b.years).replace(/M+/,b.months).replace(/H+/,b.hours).replace(/m+/,b.minutes).replace(/s+/,b.seconds).replace(/Z+/,b.timeZone)},c=function(e,t){if(!e)return null;if(t=t||0,n(e)||e.isValid&&e.isValid())return moment(e).add(t,"m");if("string"==typeof e){var r=moment(e).minute(moment(e).minute()+moment().utcOffset()*-1+t);return r.isValid()?r:null}},o=function(e){if(!e)return null;var t=s(e);if(!t)return null;var r=t.date.valueOf();return 0!==t.offset()&&(r-=6e4*t.offset()),r},l=function(e,t){var r=e?o(e):0,n=t?o(t):0;return r-n},d=function(e){if(!e)return 0;e=e.replace(/GMT/gi,"");var t=/^(?:Z|([+-]?)(2[0-3]|[01][0-9]):([0-5][0-9]))$/.exec(e);if(!t||4!==t.length)return 0;if("Z"===t[0])return 0;var r=60*Number(t[2])+Number(t[3]);return 0!==r&&"-"===t[1]&&(r*=-1),r};return e.prototype.offset=function(e){return 0===arguments.length?this._offset:void(this._offset=e)},e.prototype.isEmpty=function(){return!this.date},e.prototype.difference=function(e){return l(this,e)},e.prototype.format=function(e,t){return f(this.date,e,t)},e.parse=s,e.parseTimeZone=d,e.format=f,e.offsetUtc=c,e.isDate=n,e.valueOf=o,e.difference=l,e}])}();
