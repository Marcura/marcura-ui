...
!function(){angular.module("marcuraUI.components").directive("maPagerNew",["$timeout",function(t){return{restrict:"E",scope:{page:"=",totalPages:"=",visiblePages:"=",change:"&"},replace:!0,template:function(){var t='<div class="ma-pager"                ><ma-button                    class="ma-button-first"                    text="First"                    size="xs"                    modifier="default"                    click="firstClick()"                    is-disabled="internalPage <= 1"                ></ma-button><ma-button                    class="ma-button-previous"                    text="Previous"                    size="xs"                    modifier="default"                    click="previousClick()"                    is-disabled="internalPage <= 1"                ></ma-button><ma-button                    class="ma-button-previous-range"                    text="..."                    size="xs"                    modifier="default"                    click="npreviousRangeClick()"                    is-if="true"                ></ma-button><div class="ma-pager-pages"><ma-button                    ng-repeat="pageItem in pageItems"                    class="ma-button-page"                    text="{{pageItem}}"                    size="xs"                    modifier="{{internalPage === pageItem ? \'selected\' : \'default\'}}"                    click="pageClick(pageItem)"></div></ma-button                ><ma-button                    class="ma-button-next-range"                    text="..."                    size="xs"                    modifier="default"                    click="nextRangeClick()"                    is-if="true"                ></ma-button><ma-button                    class="ma-button-next"                    text="Next"                    size="xs"                    modifier="default"                    click="nextClick()"                    is-disabled="internalPage >= totalPages"                ></ma-button><ma-button                    class="ma-button-last"                    text="Last"                    size="xs"                    modifier="default"                    click="lastClick()"                    is-disabled="internalPage >= totalPages"                ></ma-button>                </div>';return t},link:function(e){var a=function(){var t=e.visiblePages>1?e.visiblePages:5;e.pageItems=[];for(var a=1;a<=t;a++)e.pageItems.push(a)};e.firstClick=function(){},e.previousClick=function(){},e.nextClick=function(){},e.lastClick=function(){},e.pageClick=function(t){e.page=t,e.internalPage=t},e.previousRangeClick=function(){},e.nextRangeClick=function(){},t(function(){e.internalPage=e.page}),e.$watch("visiblePages",function(t,e){t!==e&&a()}),a()}}}])}();
!function(){angular.module("marcuraUI.components").directive("maPager",["$timeout",function(e){return{restrict:"E",scope:{page:"=",totalPages:"=",change:"&"},replace:!0,template:function(){var e='<div class="ma-pager"                ><ma-button                    class="ma-button-previous"                    right-icon="chevron-left"                    size="xs"                    modifier="default"                    click="previousClick()"                    is-disabled="getPage(internalPage) <= 1"                ></ma-button                ><ma-text-box                    class="ma-pager-value"                    change="onChange(maValue, maOldValue)"                    value="internalPage">                </ma-text-box><div class="ma-pager-text">of {{getPage(totalPages)}} pages</div                ><ma-button                    class="ma-button-next"                    right-icon="chevron-right"                    size="xs"                    modifier="default"                    click="nextClick()"                    is-disabled="getPage(internalPage) >= getPage(totalPages)">                </ma-button></div>';return e},link:function(a){var t=!1,n=function(t){a.page=t,e(function(){a.change({maPage:t})})};a.previousClick=function(){var e=a.getPage(a.internalPage);a.internalPage=e<=1?1:e-1,n(a.internalPage)},a.nextClick=function(){var e=a.getPage(a.internalPage);a.internalPage=e>=a.totalPages?1:e+1,n(a.internalPage)},a.onChange=function(e,i){var g=a.getPage(e),r=a.getPage(i);if(g!==r){if(g<1||g>a.getPage(a.totalPages))return a.internalPage=r,void(t=!0);t||n(g),t=!1}},e(function(){a.internalPage=a.page}),a.getPage=function(e){return e=Number(e),"number"!=typeof e||isNaN(e)?0:e}}}}])}();
