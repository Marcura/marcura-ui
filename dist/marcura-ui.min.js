...
!function(){angular.module("marcuraUI.components").directive("maTextBox",["$timeout","maHelper","maValidators",function(e,t,a){return{restrict:"E",scope:{id:"@",type:"@",value:"=",isDisabled:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&",changeTimeout:"=",canReset:"="},replace:!0,template:function(e,t){var a="password"===t.type?"password":"text",i="            <div class=\"ma-text-box\"                ng-class=\"{                    'ma-text-box-is-disabled': isDisabled,                    'ma-text-box-is-focused': isFocused,                    'ma-text-box-is-invalid': !isValid,                    'ma-text-box-is-touched': isTouched,                    'ma-text-box-can-reset': canReset,                    'ma-text-box-is-reset-disabled': canReset && !isDisabled && !isResetEnabled()                }\">                <input class=\"ma-text-box-value\" type=\""+a+'" id="{{id}}"                    type="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-disabled="isDisabled"/>                <ma-button class="ma-button-reset"                    ng-show="canReset" size="xs" modifier="simple"                    right-icon="times-circle"                    click="onReset()"                    is-disabled="!isResetEnabled()">                </ma-button>            </div>';return i},link:function(i,n){var s,o,l,u,c=angular.element(n[0].querySelector(".ma-text-box-value")),d=i.validators?angular.copy(i.validators):[],r=i.isRequired,m=!1,f=Number(i.changeTimeout),v=function(){i.isValid=!0;var e=c.val();if(d&&d.length)for(var t=0;t<d.length;t++)if(!d[t].validate(e)){i.isValid=!1;break}},b=function(t){l!==t&&(i.value=t,l=t,e(function(){i.change({maValue:t})}))},x=function(){i.isTouched=!0,v(),i.isValid&&b(c.val())};i.isFocused=!1,i.isTouched=!1;for(var g=0;g<d.length;g++)if("IsNotEmpty"===d[g].name){m=!0;break}!m&&r&&d.unshift(a.isNotEmpty()),m&&(r=!0),i.isResetEnabled=function(){return!i.isDisabled&&""!==c.val()},i.onReset=function(){i.isDisabled||(l=c.val(),i.isTouched=!0,b(null),v(),c.focus())},i.onFocus=function(){i.isFocused=!0,i.focus({maValue:i.value})},i.onBlur=function(){u&&e.cancel(u),i.isFocused=!1,x(),i.blur({maValue:i.value})},i.onKeydown=function(e){e.keyCode!==t.keyCode.tab&&e.keyCode!==t.keyCode.shift&&(s=angular.element(e.target).val())},c.on("input",function(a){if(a.keyCode!==t.keyCode.tab&&a.keyCode!==t.keyCode.shift){var i=!1;o=angular.element(a.target).val(),s!==o&&(i=!0),i&&(u&&e.cancel(u),u=e(function(){x()},f))}}),e(function(){n.removeAttr("id"),c.attr("id",i.id)}),i.$watch("value",function(e,t){if(e!==t){var a=c.prop("selectionStart");c.val(e),v(),c.prop({selectionStart:a,selectionEnd:a})}}),c.val(i.value),v(),l=i.value,i.instance&&(i.instance.isInitialized=!0,i.instance.validate=function(){i.isTouched=!0,v()},i.instance.isValid=function(){return i.isValid})}}}])}();