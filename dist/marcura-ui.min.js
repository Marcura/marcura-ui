...
!function(){angular.module("marcuraUI.components").directive("maHtmlArea",["$timeout","$window","MaHelper","MaValidators",function(i,a,e,t){return{restrict:"E",scope:{id:"@",value:"=",isDisabled:"=",isRequired:"=",instance:"=",validators:"=",focus:"&",blur:"&",change:"&"},replace:!0,template:function(){var i="            <div class=\"ma-html-area\"                ng-class=\"{                    'ma-html-area-is-disabled': isDisabled,                    'ma-html-area-is-focused': isFocused,                    'ma-html-area-is-invalid': !isValid,                    'ma-html-area-is-touched': isTouched                }\">                <trix-editor ng-disabled=\"isDisabled\">                </trix-editor>            </div>";return i},link:function(a,e,n){var l,u,r=angular.element(e[0].querySelector(".ma-html-area trix-editor")),o=angular.element(e[0].querySelectorAll(".ma-html-area .trix-button")),s=a.validators?angular.copy(a.validators):[],c=a.isRequired,d=!1,f=!1;a._value=a.value||"",a.isTouched=!1;for(var m=function(i){l.loadHTML(i)},v=function(){return r.html()},h=function(){r[0].contentEditable=!a.isDisabled,a.isDisabled?o.attr("disabled",!0):o.removeAttr("disabled")},b=function(){var i=v();if(a.isValid=!0,s&&s.length)for(var e=0;e<s.length;e++)if(!s[e].validate(i)){a.isValid=!1;break}},p=0;p<s.length;p++)if("IsNotEmpty"===s[p].name){d=!0;break}!d&&c&&s.unshift(t.isNotEmpty()),d&&(c=!0),r.on("trix-initialize",function(){l=r[0].editor,h(),m(a.value)}),r.on("trix-change",function(){b(),a.isValid&&a.$apply(function(){f=!0,a.value=v(),i(function(){a.change({maValue:a.value})})})}),r.on("trix-focus",function(){a.$apply(function(){a.isFocused=!0,u=a.value,a.focus({maValue:a.value})})}),r.on("trix-blur",function(){a.$apply(function(){a.isFocused=!1,a.isTouched=!0,b(),a.blur({maValue:a.value,maOldValue:u,maHasValueChanged:u!==a.value})})}),a.$watch("value",function(i,e){if(i!==e){if(f)return void(f=!1);a.isValid=!0,m(a.value)}}),a.$watch("isDisabled",function(i,a){i!==a&&h()}),i(function(){$('[for="'+a.id+'"]').on("click",function(){r.focus()})}),a.instance&&(a.instance.isInitialized=!0,a.instance.isEditor=function(){return!0},a.instance.isValid=function(){return a.isValid},a.instance.validate=function(){a.isTouched=!0,b()})}}}])}();
...
!function(){angular.module("marcuraUI.components").directive("maTextArea",["$timeout","$window","MaHelper","MaValidators",function(e,t,a,i){return{restrict:"E",scope:{id:"@",value:"=",isDisabled:"=",fitContentHeight:"=",isResizable:"=",isRequired:"=",validators:"=",instance:"=",change:"&",blur:"&",focus:"&"},replace:!0,template:function(){var e='            <div class="ma-text-area"                ng-class="{                    \'ma-text-area-is-disabled\': isDisabled,                    \'ma-text-area-is-focused\': isFocused,                    \'ma-text-area-fit-content-height\': fitContentHeight,                    \'ma-text-area-is-invalid\': !isValid,                    \'ma-text-area-is-touched\': isTouched                }">                <textarea class="ma-text-area-value"                    type="text"                    ng-focus="onFocus()"                    ng-blur="onBlur()"                    ng-keydown="onKeydown($event)"                    ng-keyup="onKeyup($event)"                    ng-disabled="isDisabled">                </textarea>            </div>';return e},link:function(n,o){var r,l,u,s,d=angular.element(o[0].querySelector(".ma-text-area-value")),g=n.validators?angular.copy(n.validators):[],c=n.isRequired,p=!1;n.isFocused=!1,n.isTouched=!1,d[0].style.height="30px",n.isResizable===!1&&d.css("resize","none");for(var h=function(){var e=t.getComputedStyle(d[0],null),a={},i=parseInt(e.getPropertyValue("padding-top"))+parseInt(e.getPropertyValue("padding-bottom")),n=parseInt(e.getPropertyValue("padding-left"))+parseInt(e.getPropertyValue("padding-right")),o=parseInt(e.getPropertyValue("border-top-width"))+parseInt(e.getPropertyValue("border-bottom-width")),r=parseInt(e.getPropertyValue("border-left-width"))+parseInt(e.getPropertyValue("border-right-width"));return a.width=parseInt(t.getComputedStyle(d[0],null).getPropertyValue("width"))-n,a.height=parseInt(t.getComputedStyle(d[0],null).getPropertyValue("height"))-i,a.paddingHeight=i,a.paddingWidth=n,a.borderHeight=o,a.borderWidth=r,a.lineHeight=e.getPropertyValue("line-height"),a.font=e.getPropertyValue("font-style")+" "+e.getPropertyValue("font-variant")+" "+e.getPropertyValue("font-weight")+" "+e.getPropertyValue("font-size")+" "+e.getPropertyValue("font-height")+" "+e.getPropertyValue("font-family"),a},f=function(){if(n.fitContentHeight){var e=h(),t=a.getTextHeight(d.val(),e.font,e.width+"px",e.lineHeight),i=t+e.paddingHeight+e.borderHeight;i<40&&(i=30),d[0].style.height=i+"px",o[0].style.height=i+"px"}},v=function(){if(n.isValid=!0,g&&g.length)for(var e=0;e<g.length;e++)if(!g[e].validate(d.val())){n.isValid=!1;break}},y=function(){var t=d.val();u!==t&&(u=n.value,n.value=t,e(function(){n.change({maValue:n.value,maOldValue:u})}))},m=0;m<g.length;m++)if("IsNotEmpty"===g[m].name){p=!0;break}!p&&c&&g.unshift(i.isNotEmpty()),p&&(c=!0),n.onFocus=function(){n.isFocused=!0,s=n.value,n.focus({maValue:n.value})},n.onBlur=function(){n.isFocused=!1,n.isTouched=!0,v(),n.blur({maValue:n.value,maOldValue:s,maHasValueChanged:s!==n.value})},n.onKeydown=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(r=angular.element(e.target).val())},n.onKeyup=function(e){e.keyCode!==a.keyCode.tab&&e.keyCode!==a.keyCode.shift&&(l=angular.element(e.target).val(),r!==l&&(n.isTouched=!0))},d.on("input",function(e){var t=!1;l=angular.element(e.target).val(),r!==l&&(t=!0),t&&(v(),f(),n.isValid&&n.$apply(function(){y()}))}),angular.element(t).on("resize",function(){f()}),e(function(){if(f(),n.isResizable===!1&&d.css("resize","none"),o.removeAttr("id"),d.attr("id",n.id),n.fitContentHeight){var t=$(o[0]).closest(".ng-hide[ng-show]");if(1===t.length){var a=t.scope();a.$watch(t.attr("ng-show"),function(t){t&&e(function(){f()})})}}}),n.$watch("value",function(e,t){if(e!==t){n.isValid=!0,n.isTouched=!1;var a=d.prop("selectionStart");d.val(e);var i=$(o).is(":visible");i&&d.prop({selectionStart:a,selectionEnd:a}),f()}}),d.val(n.value),v(),u=n.value,n.instance&&(n.instance.isInitialized=!0,n.instance.isEditor=function(){return!0},n.instance.isValid=function(){return n.isValid},n.instance.validate=function(){n.isTouched=!0,v()},n.instance.focus=function(){n.isFocused||d.focus()})}}}])}();
